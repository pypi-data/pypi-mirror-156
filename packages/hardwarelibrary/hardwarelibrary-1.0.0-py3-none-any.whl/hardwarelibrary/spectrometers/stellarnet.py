...
class StellarNet(Spectrometer):
    ...
    def getCalibration(self):
        ...
        a1 = float(c1)
        a2 = float(self.doReadString(Address.c2))
        a0 = float(self.doReadString(Address.c3))
    ...
    def connectedUSBDevices(cls, idProduct=None, serialNumber=None) -> list:
        ...
        return super().connectedUSBDevices()

    @classmethod
    def readFirmwareDefinition(cls, firmwareFilePath="stellarnet.hex") -> IntelHexReader:
        try:
