...
setuptools.setup(
    ...
    version='v0.0.17',  # important for updates
    ...
    install_requires=['requests','pandas','pytz','holidays','openpyxl','matplotlib','xlsxwriter'],  # list all packages that your package uses
