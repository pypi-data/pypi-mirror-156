...
(function (Private) {
    ...
    async function completionHint(editor, panel, domain, apiKey, flag) {
        ...
        const dataToSend = { data, domain, apiKey, flag };
        // POST request
...
/* harmony import */ var _widgets_ContentHeaderToolbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./widgets/ContentHeaderToolbar */ "./lib/widgets/ContentHeaderToolbar.js");
...
class TransformPollingManager {
    ...
    startPolling(uid, filename, dirname) {
        ...
        const pollingRef = setInterval(() => {
            const reply = (0,_handler__WEBPACK_IMPORTED_MODULE_2__.requestAPI)('CHECK_STATUS', {
                body: JSON.stringify(dataToSend),
                method: 'POST'
            });
    ...
    acceptFile() {
        ...
        const reply = (0,_handler__WEBPACK_IMPORTED_MODULE_2__.requestAPI)('FILE_ACTION', {
            body: JSON.stringify(dataToSend),
            method: 'POST'
        });
        this.pollingCache = {
    ...
    openTransformedFile(transformedPath) {
        ...
        setTimeout(() => {
            ...
            if (this._newFile instanceof _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.MainAreaWidget) {
                // Create a widget
                const widgetC = new _widgets_ContentHeaderToolbar__WEBPACK_IMPORTED_MODULE_3__.ContentHeaderWidget({
...
//# sourceMappingURL=lib_index_js.1886a5f5ab9ea16a8ab7.js.map