...
class UMnetequip(UMnetdb):
    ...
    def get_device_by_building_no(self, building_no:Union[int, list], active_only:bool=False, category:str=''):
        """
        ...
        (based on the 'status' field, defalut false) or you can limit to a certain category (default all).
        ...
        if category:
            where.append(f"eq.category = '{category}'")
