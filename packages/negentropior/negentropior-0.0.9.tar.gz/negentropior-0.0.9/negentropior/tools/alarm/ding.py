...
class DingTalkMessage(object):
    ...
    def send_text(self, content, mobiles=None, at_all=False) -> any:
        """
        发送文本消息
        :param content: 文本内容
    ...
    def send_link(self, title, text, message_url, pic_url='') -> any:
        """
        link类型
        :param title: 消息标题
    ...
    def send_markdown(self, title, text, mobiles=None, at_all=False) -> any:
        """
        markdown
        :param title: 消息标题
    ...
    def _msg_open_type(self, url) -> any:
        """
        消息链接的打开方式
