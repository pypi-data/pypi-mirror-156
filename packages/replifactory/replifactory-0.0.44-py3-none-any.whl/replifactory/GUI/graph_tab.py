...
class CulturePlotWidget:
    def __init__(self, main_gui, vial_number):
        ...
        self.plot_growth_rate = widgets.Checkbox(description="plot doubling time", description_tooltip = "takes a longer time than just plotting the OD", value=False, indent=False,
        ...
        config = HBox([self.title, self.button, self.last_hours, self.plot_growth_rate], layout=Layout(width="600px"))
