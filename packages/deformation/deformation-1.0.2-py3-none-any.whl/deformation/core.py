...
from deformation.padding import median_contour
...
class InverseTransform(Transform):
    ...
    ** Reverses the starting and destination space. **
    ...
    Examples
    --------
    >>> from deformation.core import IdentityTransform, InverseTransform
...
class ChainTransform(Transform):
    ...
    ** Allows you to accumulate transformations. **
    ...
    Examples
    --------
    >>> from deformation.core import IdentityTransform, ChainTransform
    >>> identity = IdentityTransform()
    >>> ChainTransform()
    IdentityTransform()
