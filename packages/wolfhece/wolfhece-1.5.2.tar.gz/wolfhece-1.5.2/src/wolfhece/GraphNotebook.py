...
from wolfhece.PyCrosssections import profile
...
class PlotCS(Plot):
    ...
    def plot_up(self,event):
        self.mycs.plot_up(self.figure,self.myax)
    ...
    def plot_down(self,event):
        self.mycs.plot_down(self.figure,self.myax)
        self.mycs.myprop.width=1
        self.mycs.myprop.color=0
...
class PlotNotebook(wx.Panel):
    ...
    def add(self, name="plot",which=""):
        ...
        return page                  #retourne la figure Matplotlib
