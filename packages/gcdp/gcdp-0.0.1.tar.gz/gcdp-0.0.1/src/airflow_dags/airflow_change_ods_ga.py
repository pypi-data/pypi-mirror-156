...
start_day = Variable.get("ga_start_day")
end_day = Variable.get("ga_end_day")
...
check_ga_daily_forth = PythonOperator(task_id="check_ga_daily_forth", python_callable=check, op_kwargs={'system_name':'ga'})

check_ga_daily_back = PythonOperator(task_id="check_ga_daily_back", python_callable=check, op_kwargs={'system_name':'ga'})

check_ga_daily_forth >> del_DPN_AFFINITY >> DPN_AFFINITY >> \
del_DPN_AGE >> DPN_AGE >> \
...
del_PNT_SOCIAL_MEDIUM >> PNT_SOCIAL_MEDIUM >> check_ga_daily_back