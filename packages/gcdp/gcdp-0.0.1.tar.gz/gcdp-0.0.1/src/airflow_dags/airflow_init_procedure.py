...
q_MOBD_SCK = f"CALL GCWB_WDB.DM.P_MOBD_SCK_I();",
q_MOBD_SRCH_CTGR = f"CALL GCWB_WDB.DM.P_MOBD_SRCH_CTGR_I();",

q_MOBD_CNC_AREA = f"CALL GCWB_WDB.DM.P_MOBD_CNC_AREA_I();",
q_MOBD_CNC_CITY = f"CALL GCWB_WDB.DM.P_MOBD_CNC_CITY_I();"
q_MOBD_CNC_NAT = f"CALL GCWB_WDB.DM.P_MOBD_CNC_NAT_I();"

q_MMKD_CPN = f"CALL GCWB_WDB.DM.P_MMKD_CPN_I({yesterday.strftime('%Y%m%d')});",

q_MMKD_EXH = f"CALL GCWB_WDB.DM.P_MMKD_EXH_I();",

q_MSTD_BASE_DD = f"CALL GCWB_WDB.DM.P_MSTD_BASE_DD_I({yesterday.strftime('%Y%d%m')});",
q_MSTD_BASE_MM = f"CALL GCWB_WDB.DM.P_MSTD_BASE_MM_I({yesterday.strftime('%Y%d%m')});",
q_MSTD_BASE_WK = f"CALL GCWB_WDB.DM.P_MSTD_BASE_WK_I({yesterday.strftime('%Y%d%m')});",
q_MSTD_BASE_YY = f"CALL GCWB_WDB.DM.P_MSTD_BASE_YY_I({yesterday.strftime('%Y%d%m')});",

q_MCSD_CNSL_HDQT_CLS = f"CALL GCWB_WDB.DM.P_MCSD_CNSL_HDQT_CLS_I();",
q_MCSD_CNSL_INQ_LCLS = f"CALL GCWB_WDB.DM.P_MCSD_CNSL_INQ_LCLS_I();",
q_MSTD_SIDO = f"CALL GCWB_WDB.DM.P_MSTD_SIDO_I();",
q_MSTD_SIGUNGU = f"CALL GCWB_WDB.DM.P_MSTD_SIGUNGU_I();",
q_MTDD_MALL_CLS = f"CALL GCWB_WDB.DM.P_MTDD_MALL_CLS_I();",
q_MTDD_MALL_CLSF = f"CALL GCWB_WDB.DM.P_MTDD_MALL_CLSF_I();",

q_MMBD_INTRST_SUBJ = "CALL GCWB_WDB.DM.P_MMBD_INTRST_SUBJ_I();",

q_MOBD_PAGE = f"CALL GCWB_WDB.DM.P_MOBD_PAGE_I();",
q_MOBD_PGR_FO_STEP = f"CALL GCWB_WDB.DM.P_MOBD_PGR_FO_STEP_I();",
q_MOBD_PGR_FT_STEP = f"CALL GCWB_WDB.DM.P_MOBD_PGR_FT_STEP_I();",
q_MOBD_PGR_SE_STEP = f"CALL GCWB_WDB.DM.P_MOBD_PGR_SE_STEP_I();",
q_MOBD_PGR_TH_STEP = f"CALL GCWB_WDB.DM.P_MOBD_PGR_TH_STEP_I();",

q_MMKD_PNT_PAY_DED_RSN = f"CALL GCWB_WDB.DM.P_MMKD_PNT_PAY_DED_RSN_I();",

q_MOBD_EXH_CTGR_LCLS = f"CALL GCWB_WDB.DM.P_MOBD_EXH_CTGR_LCLS_I();",
q_MOBD_EXH_CTGR_MCLS = f"CALL GCWB_WDB.DM.P_MOBD_EXH_CTGR_MCLS_I();"

q_MMBD_AGE = f"CALL GCWB_WDB.DM.P_MMBD_AGE_I();",
q_MMBD_EEMC = f"CALL GCWB_WDB.DM.P_MMBD_EEMC_I();",
q_MMBD_PUR_CY = f"CALL GCWB_WDB.DM.P_MMBD_PUR_CY_I();",
q_MMBD_VST_CY = f"CALL GCWB_WDB.DM.P_MMBD_VST_CY_I();"

q_MOBD_IFL_CHNL = f"CALL GCWB_WDB.DM.P_MOBD_IFL_CHNL_I();",
q_MOBD_IFL_MED = f"CALL GCWB_WDB.DM.P_MOBD_IFL_MED_I();",
q_MOBD_IFL_SRC = f"CALL GCWB_WDB.DM.P_MOBD_IFL_SRC_I();",
q_MOBD_SCN = f"CALL GCWB_WDB.DM.P_MOBD_SCN_I();",
