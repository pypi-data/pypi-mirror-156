...
rel_path_min_val = "important_variables/min_val.npy"
rel_path_max_val = "important_variables/max_val.npy"
rel_path_latent_dim = "important_variables/latent_dim.txt"

abs_path_min_val = os.path.join(script_dir, rel_path_min_val)
abs_path_max_val = os.path.join(script_dir, rel_path_max_val)
abs_path_latent_val = os.path.join(script_dir, rel_path_latent_dim)

min_val = np.load(abs_path_min_val)
max_val = np.load(abs_path_max_val)
LATENT_DIM = int(open(abs_path_latent_val, "r").read())
