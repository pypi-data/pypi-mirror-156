...
class AwsUiReactTsWebsiteProject(
    projen.web.ReactTypeScriptProject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-prototyping-sdk/awsui-react-ts-website.AwsUiReactTsWebsiteProject",
):
    '''(experimental) Synthesizes a AWS UI React Typescript Website Project.
    ...
    def __init__(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = AwsUiReactTsWebsiteProjectOptions(
...
@jsii.data_type(
    jsii_type="@aws-prototyping-sdk/awsui-react-ts-website.AwsUiReactTsWebsiteProjectOptions",
    jsii_struct_bases=[projen.web.ReactTypeScriptProjectOptions],
    name_mapping={
        "name": "name",
        "logging": "logging",
        "outdir": "outdir",
...
class AwsUiReactTsWebsiteProjectOptions(projen.web.ReactTypeScriptProjectOptions):
    def __init__(
        self,
        *,
        name: builtins.str,
        ...
        '''(experimental) Configuration options for the AwsUiReactTsWebsiteProject.
    ...
    def __repr__(self) -> str:
        return "AwsUiReactTsWebsiteProjectOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


__all__ = [
    "AwsUiReactTsWebsiteProject",
    "AwsUiReactTsWebsiteProjectOptions",
]
