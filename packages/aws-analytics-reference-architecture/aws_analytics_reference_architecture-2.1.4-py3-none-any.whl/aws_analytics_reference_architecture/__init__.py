...
import aws_cdk.aws_redshift_alpha
...
class CentralGovernance(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        lf_admin_role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
    ) -> None:
        '''(experimental) Construct a new instance of CentralGovernance.

        :param scope: the Scope of the CDK Construct.
        :param id: the ID of the CDK Construct.
        :param lf_admin_role: (experimental) Lake Formation admin role.

        :stability: experimental
        :access: public
        '''
        props = CentralGovernanceProps(lf_admin_role=lf_admin_role)

        jsii.create(self.__class__, self, [scope, id, props])

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="workflowRole")
    def workflow_role(self) -> aws_cdk.aws_iam.IRole:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_iam.IRole, jsii.get(self, "workflowRole"))


@jsii.data_type(
    jsii_type="aws-analytics-reference-architecture.CentralGovernanceProps",
    jsii_struct_bases=[],
    name_mapping={"lf_admin_role": "lfAdminRole"},
)
class CentralGovernanceProps:
    def __init__(
        ...
        *,
        ...
        '''
        self._values: typing.Dict[str, typing.Any] = {}
        if lf_admin_role is not None:
            self._values["lf_admin_role"] = lf_admin_role

    @builtins.property
    def lf_admin_role(self) -> typing.Optional[aws_cdk.aws_iam.IRole]:
        '''(experimental) Lake Formation admin role.

        :stability: experimental
        '''
        result = self._values.get("lf_admin_role")
        return typing.cast(typing.Optional[aws_cdk.aws_iam.IRole], result)
...
class DataDomain(
    ...
    def __init__(
        ...
        *,
        ...
        :access: public
        '''
        props = DataDomainPros(
            central_account_id=central_account_id,
            crawler_workflow=crawler_workflow,
            lf_admin_role=lf_admin_role,
        )

        jsii.create(self.__class__, self, [scope, id, props])

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="dataDomainWorkflow")
    def data_domain_workflow(self) -> "DataDomainWorkflow":
        '''
        :stability: experimental
        '''
        return typing.cast("DataDomainWorkflow", jsii.get(self, "dataDomainWorkflow"))
    ...
    def event_bus(self) -> aws_cdk.aws_events.EventBus:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_events.EventBus, jsii.get(self, "eventBus"))
...
@jsii.data_type(
    jsii_type="aws-analytics-reference-architecture.DataDomainPros",
    jsii_struct_bases=[],
    name_mapping={
        "central_account_id": "centralAccountId",
        "crawler_workflow": "crawlerWorkflow",
        "lf_admin_role": "lfAdminRole",
    },
)
class DataDomainPros:
    def __init__(
        self,
        *,
        central_account_id: builtins.str,
    ...
    def __repr__(self) -> str:
        return "DataDomainPros(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class DataDomainRegistration(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-analytics-reference-architecture.DataDomainRegistration",
):
    '''(experimental) This CDK Construct registers a new Data Domain account in Central Governance account.
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        data_domain_account_id: builtins.str,
    ) -> None:
        '''(experimental) Construct a new instance of DataDomainRegistration.

        :param scope: the Scope of the CDK Construct.
        :param id: the ID of the CDK Construct.
        :param data_domain_account_id: (experimental) Data Domain Account Id.

        :stability: experimental
        :access: public
        '''
        props = DataDomainRegistrationProps(
            data_domain_account_id=data_domain_account_id
        )
...
@jsii.data_type(
    jsii_type="aws-analytics-reference-architecture.DataDomainRegistrationProps",
    jsii_struct_bases=[],
    name_mapping={"data_domain_account_id": "dataDomainAccountId"},
)
class DataDomainRegistrationProps:
    def __init__(self, *, data_domain_account_id: builtins.str) -> None:
        '''(experimental) Properties for the DataDomainRegistration Construct.
    ...
    @builtins.property
    def data_domain_account_id(self) -> builtins.str:
        '''(experimental) Data Domain Account Id.

        :stability: experimental
        '''
        result = self._values.get("data_domain_account_id")
        assert result is not None, "Required property 'data_domain_account_id' is missing"
        return typing.cast(builtins.str, result)
    ...
    def __repr__(self) -> str:
        return "DataDomainRegistrationProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class DataDomainWorkflow(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-analytics-reference-architecture.DataDomainWorkflow",
):
    '''(experimental) This CDK Construct creates a workflow for Producer/Consumer account.
    ...
    def __init__(
        ...
        *,
        ...
        workflow_role: aws_cdk.aws_iam.IRole,
    ) -> None:
        '''(experimental) Construct a new instance of DataDomainWorkflow.

        :param scope: the Scope of the CDK Construct.
        :param id: the ID of the CDK Construct.
        :param central_account_id: (experimental) Central Governance account Id.
        :param event_bus: (experimental) Event Bus in Data Domain.
        :param workflow_role: (experimental) Lake Formation admin role.

        :stability: experimental
        :access: public
        '''
        props = DataDomainWorkflowProps(
            central_account_id=central_account_id,
            event_bus=event_bus,
...
@jsii.data_type(
    jsii_type="aws-analytics-reference-architecture.DataDomainWorkflowProps",
    jsii_struct_bases=[],
    name_mapping={
        "central_account_id": "centralAccountId",
        "event_bus": "eventBus",
...
class DataDomainWorkflowProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties for the DataDomainWorkflow Construct.
    ...
    def event_bus(self) -> aws_cdk.aws_events.IEventBus:
        '''(experimental) Event Bus in Data Domain.
    ...
    def workflow_role(self) -> aws_cdk.aws_iam.IRole:
        ...
        :stability: experimental
        '''
        result = self._values.get("workflow_role")
        assert result is not None, "Required property 'workflow_role' is missing"
    ...
    def __repr__(self) -> str:
        return "DataDomainWorkflowProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class DataLakeExporterProps:
    def __init__(
        ...
        *,
        sink_bucket: aws_cdk.aws_s3.Bucket,
        source_glue_database: aws_cdk.aws_glue_alpha.Database,
        source_glue_table: aws_cdk.aws_glue_alpha.Table,
    ...
    @builtins.property
    def source_glue_database(self) -> aws_cdk.aws_glue_alpha.Database:
        ...
        return typing.cast(aws_cdk.aws_glue_alpha.Database, result)

    @builtins.property
    def source_glue_table(self) -> aws_cdk.aws_glue_alpha.Table:
        ...
        return typing.cast(aws_cdk.aws_glue_alpha.Table, result)
...
class DataProduct(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-analytics-reference-architecture.DataProduct",
):
    '''(experimental) This CDK Construct enables creation of a new Data Product in Data Domain account by granting cross-account access to Central Gov.
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        cross_account_access_props: "S3CrossAccountProps",
    ) -> None:
        '''(experimental) Construct a new instance of DataProduct.

        :param scope: the Scope of the CDK Construct.
        :param id: the ID of the CDK Construct.
        :param cross_account_access_props: (experimental) S3CrossAccountProps for S3CrossAccount construct.

        :stability: experimental
        :access: public
        '''
        props = DataProductProps(cross_account_access_props=cross_account_access_props)

        jsii.create(self.__class__, self, [scope, id, props])


@jsii.data_type(
    jsii_type="aws-analytics-reference-architecture.DataProductProps",
    jsii_struct_bases=[],
    name_mapping={"cross_account_access_props": "crossAccountAccessProps"},
)
class DataProductProps:
    def __init__(self, *, cross_account_access_props: "S3CrossAccountProps") -> None:
        '''(experimental) Properties for the DataProduct Construct.

        :param cross_account_access_props: (experimental) S3CrossAccountProps for S3CrossAccount construct.

        :stability: experimental
        '''
        if isinstance(cross_account_access_props, dict):
            cross_account_access_props = S3CrossAccountProps(**cross_account_access_props)
        self._values: typing.Dict[str, typing.Any] = {
            "cross_account_access_props": cross_account_access_props,
        }

    @builtins.property
    def cross_account_access_props(self) -> "S3CrossAccountProps":
        '''(experimental) S3CrossAccountProps for S3CrossAccount construct.

        :stability: experimental
        '''
        result = self._values.get("cross_account_access_props")
        assert result is not None, "Required property 'cross_account_access_props' is missing"
        return typing.cast("S3CrossAccountProps", result)
    ...
    def __repr__(self) -> str:
        return "DataProductProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class Ec2SsmRole(
    ...
    def __init__(
        ...
        *,
        ...
        max_session_duration: typing.Optional[aws_cdk.Duration] = None,
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "autoscaler_version": "autoscalerVersion",
...
class EmrEksClusterProps:
    def __init__(
        ...
        *,
        ...
        autoscaler_version: typing.Optional[jsii.Number] = None,
        ...
        :param autoscaler_version: (experimental) The version of autoscaler to pass to Helm. Default: - version matching the default Kubernete version
        ...
        if autoscaler_version is not None:
            self._values["autoscaler_version"] = autoscaler_version
    ...
    @builtins.property
    def autoscaler_version(self) -> typing.Optional[jsii.Number]:
        '''(experimental) The version of autoscaler to pass to Helm.

        :default: - version matching the default Kubernete version

        :stability: experimental
        '''
        result = self._values.get("autoscaler_version")
        return typing.cast(typing.Optional[jsii.Number], result)
...
class FlywayRunner(
    ...
    *This example assume that migration SQL files are located in ``resources/sql`` of the cdk project.::
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        cluster: aws_cdk.aws_redshift_alpha.Cluster,
    ...
    def runner(self) -> aws_cdk.CustomResource:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.CustomResource, jsii.get(self, "runner"))
...
class FlywayRunnerProps:
    ...
    @builtins.property
    def cluster(self) -> aws_cdk.aws_redshift_alpha.Cluster:
        ...
        return typing.cast(aws_cdk.aws_redshift_alpha.Cluster, result)
...
class GlueDemoRole(
    ...
    @jsii.member(jsii_name="getOrCreate") # type: ignore[misc]
    @builtins.classmethod
    def get_or_create(cls, scope: constructs.Construct) -> "GlueDemoRole":
        '''
        :param scope: -
...
class LakeFormationS3LocationProps:
    def __init__(
        ...
        *,
        ...
        :param kms_key: (experimental) KMS key used to encrypt the S3 Location. Default: - No encryption is used
    ...
    def __init__(
        ...
        *,
        ...
        props = LakeFormationS3LocationProps(
            s3_bucket=s3_bucket, kms_key=kms_key, s3_object_key=s3_object_key
        )
...
class PreparedDataset(
    ...
    '''(experimental) If the stack is deployed in another region than eu-west-1, data transfer costs will apply.
...
class SingletonCfnLaunchTemplate(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        launch_template_data: typing.Optional[typing.Union[aws_cdk.aws_ec2.CfnLaunchTemplate.LaunchTemplateDataProperty, aws_cdk.IResolvable]] = None,
        launch_template_name: typing.Optional[builtins.str] = None,
        tag_specifications: typing.Optional[typing.Union[aws_cdk.IResolvable, typing.Sequence[typing.Union[aws_cdk.aws_ec2.CfnLaunchTemplate.LaunchTemplateTagSpecificationProperty, aws_cdk.IResolvable]]]] = None,
    ) -> None:
...
class SingletonGlueDatabase(
    ...
    def __init__(
        ...
        *,
        ...
        :stability: experimental
        '''
        props = aws_cdk.aws_glue_alpha.DatabaseProps(
    ...
    def get_or_create(
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_glue_alpha.Database, jsii.sinvoke(cls, "getOrCreate", [scope, name]))
...
class SingletonKey(
    ...
    def __init__(
        ...
        *,
        ...
        pending_window: typing.Optional[aws_cdk.Duration] = None,
...
class DataLakeCatalog(
    ...
    def clean_database(self) -> aws_cdk.aws_glue_alpha.Database:
        '''(experimental) AWS Glue Database for Clean data.

        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_glue_alpha.Database, jsii.get(self, "cleanDatabase"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="rawDatabase")
    def raw_database(self) -> aws_cdk.aws_glue_alpha.Database:
        '''(experimental) AWS Glue Database for Raw data.

        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_glue_alpha.Database, jsii.get(self, "rawDatabase"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="transformDatabase")
    def transform_database(self) -> aws_cdk.aws_glue_alpha.Database:
        '''(experimental) AWS Glue Database for Transform data.

        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_glue_alpha.Database, jsii.get(self, "transformDatabase"))
...
class EmrEksCluster(
    ...
    def add_managed_endpoint(
        ...
        *,
        ...
        return typing.cast(aws_cdk.CustomResource, jsii.invoke(self, "addManagedEndpoint", [scope, id, options]))
    ...
    def create_execution_role(
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_iam.Role, jsii.invoke(self, "createExecutionRole", [scope, id, policy, namespace, name]))
...
__all__ = [
    ...
    "DataDomain",
    "DataDomainPros",
    "DataDomainRegistration",
    "DataDomainRegistrationProps",
    "DataDomainWorkflow",
    "DataDomainWorkflowProps",
    "DataLakeCatalog",
    "DataLakeExporter",
