...
from OTLMOW.OTLModel.Classes.Abstracten.PTModuleMetFirmware import PTModuleMetFirmware
from OTLMOW.OTLModel.Datatypes.KlPtKARModemProtocol import KlPtKARModemProtocol
