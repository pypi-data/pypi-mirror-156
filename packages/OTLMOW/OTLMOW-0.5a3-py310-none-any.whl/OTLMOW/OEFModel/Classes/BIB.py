...
class BIB(EMObject):
    ...
    typeURI = 'https://lgc.data.wegenenverkeer.be/ns/installatie#BIB'
    label = 'brand- en inbraakbeveiliging'
    ...
    def __init__(self):
        ...
        self._centraleServerTypeOperatingSoftware = EMAttribuut(field=BooleanField,
                                                                ...
                                                                objectUri='https://lgc.data.wegenenverkeer.be/ns/attribuut#BIB.centraleServerTypeOperatingSoftware',
        ...
        self._centraleServerTypeToepassingssoftware = EMAttribuut(field=BooleanField,
                                                                  ...
                                                                  objectUri='https://lgc.data.wegenenverkeer.be/ns/attribuut#BIB.centraleServerTypeToepassingssoftware',
