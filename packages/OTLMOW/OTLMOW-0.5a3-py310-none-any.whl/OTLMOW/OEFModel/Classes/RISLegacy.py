...
class RISLegacy(EMObject):
    """BIB-,BRAND-,INBRAAK- TOEGANGS-,INSTALLATIEBEVEILIGING (deel waarvoor het RIS dient tussen te komen)"""

    typeURI = 'https://lgc.data.wegenenverkeer.be/ns/installatie#RIS'
    label = 'Beveiligingsinstallatie RIS'
