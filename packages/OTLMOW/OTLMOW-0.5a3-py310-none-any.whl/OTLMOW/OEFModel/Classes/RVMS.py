...
class RVMS(EMObject):
    ...
    def __init__(self):
        ...
        self._toestandRvmsBord = EMAttribuut(field=StringField,
                                             naam='toestand RVMS bord',
                                             label='toestand RVMS bord',
                                             objectUri='https://ins.data.wegenenverkeer.be/ns/attribuut#RVMS.toestandRvmsBord',
                                             definitie='Definitie nog toe te voegen voor eigenschap toestand RVMS bord',
                                             owner=self)
    ...
    @property
    def toestandRvmsBord(self):
        """Definitie nog toe te voegen voor eigenschap toestand RVMS bord"""
        return self._toestandRvmsBord.waarde

    @toestandRvmsBord.setter
    def toestandRvmsBord(self, value):
        self._toestandRvmsBord.set_waarde(value, owner=self)
