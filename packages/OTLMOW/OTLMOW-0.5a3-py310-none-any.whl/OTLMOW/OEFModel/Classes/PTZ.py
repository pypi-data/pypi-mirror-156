...
class PTZ(EMObject):
    ...
    def __init__(self):
        ...
        self._ptzSmerenBewegendeDelen = EMAttribuut(field=StringField,
                                                    naam='PTZ smeren bewegende delen',
                                                    label='PTZ smeren bewegende delen',
                                                    objectUri='https://ond.data.wegenenverkeer.be/ns/attribuut#PTZ.ptzSmerenBewegendeDelen',
                                                    definitie='Definitie nog toe te voegen voor eigenschap PTZ smeren bewegende delen',
                                                    owner=self)
        ...
        self._mediaomvRedenDatumIngevenInv = EMAttribuut(field=StringField,
                                                         ...
                                                         objectUri='https://ond.data.wegenenverkeer.be/ns/attribuut#PTZ.mediaomvRedenDatumIngevenInv',
        ...
        self._opmerkingSmerenPtz = EMAttribuut(field=StringField,
                                               naam='opmerking smeren PTZ',
                                               label='opmerking smeren PTZ',
                                               objectUri='https://ond.data.wegenenverkeer.be/ns/attribuut#PTZ.opmerkingSmerenPtz',
                                               definitie='Definitie nog toe te voegen voor eigenschap opmerking smeren PTZ',
                                               owner=self)
    ...
    @property
    def ptzSmerenBewegendeDelen(self):
        """Definitie nog toe te voegen voor eigenschap PTZ smeren bewegende delen"""
        return self._ptzSmerenBewegendeDelen.waarde

    @ptzSmerenBewegendeDelen.setter
    def ptzSmerenBewegendeDelen(self, value):
        self._ptzSmerenBewegendeDelen.set_waarde(value, owner=self)
    ...
    @property
    def opmerkingSmerenPtz(self):
        """Definitie nog toe te voegen voor eigenschap opmerking smeren PTZ"""
        return self._opmerkingSmerenPtz.waarde

    @opmerkingSmerenPtz.setter
    def opmerkingSmerenPtz(self, value):
        self._opmerkingSmerenPtz.set_waarde(value, owner=self)
