...
class VMS(EMObject):
    ...
    def __init__(self):
        ...
        self._toestandVmsBord = EMAttribuut(field=StringField,
                                            naam='toestand VMS bord',
                                            label='toestand VMS bord',
                                            objectUri='https://ins.data.wegenenverkeer.be/ns/attribuut#VMS.toestandVmsBord',
                                            definitie='Definitie nog toe te voegen voor eigenschap toestand VMS bord',
                                            owner=self)
    ...
    @property
    def toestandVmsBord(self):
        """Definitie nog toe te voegen voor eigenschap toestand VMS bord"""
        return self._toestandVmsBord.waarde

    @toestandVmsBord.setter
    def toestandVmsBord(self, value):
        self._toestandVmsBord.set_waarde(value, owner=self)
