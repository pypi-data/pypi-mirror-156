...
class AID(EMObject):
    ...
    def __init__(self):
        ...
        self._encoderRedenDatumIngevenInventaris = EMAttribuut(field=StringField,
                                                               naam='encoder > reden?datum ingeven inventaris',
                                                               label='encoder > reden?datum ingeven inventaris',
                                                               objectUri='https://ond.data.wegenenverkeer.be/ns/attribuut#AID.encoderRedenDatumIngevenInventaris',
                                                               definitie='Definitie nog toe te voegen voor eigenschap encoder > reden?datum ingeven inventaris',
                                                               owner=self)
        ...
        self._mediaomvRedenDatumIngevenInventaris = EMAttribuut(field=StringField,
                                                                naam='mediaomv >reden?datum ingeven inventaris',
                                                                label='mediaomv >reden?datum ingeven inventaris',
                                                                objectUri='https://ond.data.wegenenverkeer.be/ns/attribuut#AID.mediaomvRedenDatumIngevenInventaris',
                                                                definitie='Definitie nog toe te voegen voor eigenschap mediaomv >reden?datum ingeven inventaris',
                                                                owner=self)
        ...
        self._vertrekRedenDatumIngevenInventaris = EMAttribuut(field=StringField,
                                                               naam='vertrek > reden?datum ingeven inventaris',
                                                               label='vertrek > reden?datum ingeven inventaris',
                                                               objectUri='https://ond.data.wegenenverkeer.be/ns/attribuut#AID.vertrekRedenDatumIngevenInventaris',
                                                               definitie='Definitie nog toe te voegen voor eigenschap vertrek > reden?datum ingeven inventaris',
                                                               owner=self)
    ...
    @property
    def encoderRedenDatumIngevenInventaris(self):
        """Definitie nog toe te voegen voor eigenschap encoder > reden?datum ingeven inventaris"""
        return self._encoderRedenDatumIngevenInventaris.waarde

    @encoderRedenDatumIngevenInventaris.setter
    def encoderRedenDatumIngevenInventaris(self, value):
        self._encoderRedenDatumIngevenInventaris.set_waarde(value, owner=self)
    ...
    @property
    def mediaomvRedenDatumIngevenInventaris(self):
        """Definitie nog toe te voegen voor eigenschap mediaomv >reden?datum ingeven inventaris"""
        return self._mediaomvRedenDatumIngevenInventaris.waarde

    @mediaomvRedenDatumIngevenInventaris.setter
    def mediaomvRedenDatumIngevenInventaris(self, value):
        self._mediaomvRedenDatumIngevenInventaris.set_waarde(value, owner=self)
    ...
    @property
    def vertrekRedenDatumIngevenInventaris(self):
        """Definitie nog toe te voegen voor eigenschap vertrek > reden?datum ingeven inventaris"""
        return self._vertrekRedenDatumIngevenInventaris.waarde

    @vertrekRedenDatumIngevenInventaris.setter
    def vertrekRedenDatumIngevenInventaris(self, value):
        self._vertrekRedenDatumIngevenInventaris.set_waarde(value, owner=self)
