...
class Post060332218(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.32218',
            beschrijving='Getrommelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 220 x 110, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.32218')
