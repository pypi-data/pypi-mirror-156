...
class Post060161017(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.61017',
            beschrijving='Verharding in staalvezelbeton, bouwklassegroep B1-B5 volgens 6-1, dikte E = 17 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.61017')
