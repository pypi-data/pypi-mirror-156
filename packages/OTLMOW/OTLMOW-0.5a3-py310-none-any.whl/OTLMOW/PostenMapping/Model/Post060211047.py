...
class Post060211047(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.11047',
            beschrijving='Profileerlaag, bouwklassegroep B4-B5 volgens 6-2, type APO-A, dikte E = 6 à 8 cm',
            ...
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.11047')
