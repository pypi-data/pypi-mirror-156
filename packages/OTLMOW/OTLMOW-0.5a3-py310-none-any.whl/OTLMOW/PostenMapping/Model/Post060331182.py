...
class Post060331182(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31182',
            beschrijving='Onbehandelde betonstraatstenen, grijs volgens 6-3.4, voegstenen 200 x 200, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31182')
