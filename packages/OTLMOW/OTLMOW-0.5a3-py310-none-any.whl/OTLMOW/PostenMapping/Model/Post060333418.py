...
class Post060333418(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33418',
            beschrijving='Gewassen betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, 220 x 110, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33418')
