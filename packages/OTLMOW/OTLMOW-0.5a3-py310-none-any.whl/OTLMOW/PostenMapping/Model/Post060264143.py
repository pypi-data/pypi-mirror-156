...
class Post060264143(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.64143',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type ZOA-C1 met gewoon wegenbitumen, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.64143')
