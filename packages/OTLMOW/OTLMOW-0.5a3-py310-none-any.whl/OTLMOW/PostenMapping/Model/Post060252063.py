...
class Post060252063(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.52063',
            beschrijving='Toplaag van asfaltbeton, bouwklassegroep B6-B8 volgens 6-2, type APT-D, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.52063')
