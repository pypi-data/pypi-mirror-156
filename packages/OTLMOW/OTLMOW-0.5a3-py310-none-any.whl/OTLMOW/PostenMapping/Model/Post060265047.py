...
class Post060265047(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.65047',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type AGT klasse I op onderlaag APO-B, totale dikte E = 7 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.65047')
                ...
                defaultWaarde='onderlaag-APO-B-en-toplaag-AGT-klasse-I',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                isAltijdInTeVullen=0,
