...
class Post060311117(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.11117',
            beschrijving='Bestrating van in rijen te leggen kasseien volgens 6-3.2, langwerpige kasseien 11 x 17 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.11117')
