...
class Post060341280(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41280',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.5, met verbrede voeg, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41280')
