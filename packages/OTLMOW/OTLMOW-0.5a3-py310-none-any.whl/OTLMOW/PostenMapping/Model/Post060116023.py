...
class Post060116023(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.16023',
            beschrijving='Ongewapende cementbetonverharding, bouwklassegroep B6-B10 volgens 6-1, dikte E = 23 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.16023')
