...
class Post060251044(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.51044',
            beschrijving='Toplaag van asfaltbeton, bouwklassegroep B4-B5 volgens 6-2, type APT-C, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.51044')
