...
class Post060254193(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.54193',
            beschrijving='Toplaag van asfaltbeton, bouwklassegroep B9-B10 en BF volgens 6-2, type AB-4D, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.54193')
