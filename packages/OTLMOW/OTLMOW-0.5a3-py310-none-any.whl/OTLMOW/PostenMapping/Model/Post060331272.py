...
class Post060331272(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31272',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, voegstenen 220 x 220, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31272')
