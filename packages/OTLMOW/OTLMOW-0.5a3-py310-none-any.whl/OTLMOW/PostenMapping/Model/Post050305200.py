...
class Post050305200(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.05200',
            beschrijving='Onderfundering van bomengranulaat volgens volgens 5-3.5.2, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0503.05200')
