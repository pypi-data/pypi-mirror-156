...
class Post060331250(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31250',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 300 x 300, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31250')
