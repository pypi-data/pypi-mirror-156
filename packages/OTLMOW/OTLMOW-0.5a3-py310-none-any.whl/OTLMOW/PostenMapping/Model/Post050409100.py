...
class Post050409100(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.09100',
            beschrijving='Fundering en stut van schraal beton voor lijnvormige elementen volgens 5-4.9, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.09100')
