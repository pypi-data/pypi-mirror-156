...
class Post060244063(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.44063',
            beschrijving='Beschermingslaag, bouwklassegroep B6-B10 en BF volgens 6-2, type APO-D, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.44063')
