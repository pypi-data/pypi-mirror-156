...
class Post060333388(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33388',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, voegstenen 200 x 200, 80 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33388')
