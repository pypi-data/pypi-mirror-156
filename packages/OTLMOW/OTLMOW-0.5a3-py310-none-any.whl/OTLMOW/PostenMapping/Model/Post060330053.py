...
class Post060330053(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.30053',
            beschrijving='Bed van zandcement voor bestratingen van betonstraatstenen, Enom = 3 cm volgens 6-3.4.4.2',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.30053')
