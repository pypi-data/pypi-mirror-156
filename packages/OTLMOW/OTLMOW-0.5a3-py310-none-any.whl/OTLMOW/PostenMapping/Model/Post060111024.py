...
class Post060111024(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.11024',
            beschrijving='Ongewapende cementbetonverharding, bouwklassegroep B1-B5 volgens 6-1, dikte E = 24 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.11024')
