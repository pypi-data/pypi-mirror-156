...
class Post060351480(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.51480',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse A volgens 6-3.6, rijnformaat, hoogte ca. 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.51480')
