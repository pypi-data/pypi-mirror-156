...
class Post060360053(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.60053',
            beschrijving='Bed van zandcement voor bestratingen van betontegels, Enom = 3 cm volgens 6-3.7.4.2',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.60053')
