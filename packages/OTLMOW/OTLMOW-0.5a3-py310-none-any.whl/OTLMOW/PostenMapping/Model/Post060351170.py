...
class Post060351170(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.51170',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse A volgens 6-3.6, waalformaat, hoogte ca. 70 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.51170')
