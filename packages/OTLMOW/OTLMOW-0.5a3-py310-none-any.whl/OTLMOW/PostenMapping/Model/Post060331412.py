...
class Post060331412(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31412',
            beschrijving='Onbehandelde betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, 220 x 110, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31412')
