...
class Post060331230(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31230',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 220 x 220, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31230')
