...
class Post060331432(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31432',
            beschrijving='Onbehandelde betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, 220 x 220, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31432')
