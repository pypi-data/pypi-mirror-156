...
class Post060371510(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.71510',
            beschrijving='Gezaagde natuursteentegels, gebruiksklasse 5 volgens 6-3.8, 150 x 150, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.71510')
