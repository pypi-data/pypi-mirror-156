...
class Post060340242(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40242',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.5, 200 x 200, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40242')
