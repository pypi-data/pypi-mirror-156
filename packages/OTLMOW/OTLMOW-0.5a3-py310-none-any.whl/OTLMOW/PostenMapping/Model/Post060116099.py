...
class Post060116099(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.16099',
            beschrijving='Ongewapende cementbetonverharding, bouwklassegroep B6-B10 volgens 6-1, uitvoering op veranderlijke dikte',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.16099')
