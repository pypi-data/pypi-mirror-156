...
class Post050305100(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.05100',
            beschrijving='Onderfundering van bomenzand volgens volgens 5-3.5.1, plaatselijke uitvoering',
            meetstaateenheid='M3',
