...
class Post060340448(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40448',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.5, 200 x 200, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40448')
