...
class Post060341288(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41288',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.5, met verbrede voeg, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41288')
