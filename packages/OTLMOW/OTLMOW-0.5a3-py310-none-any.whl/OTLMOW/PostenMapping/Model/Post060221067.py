...
class Post060221067(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.21067',
            beschrijving='Onderlaag, bouwklassegroep B6-B10 en BF volgens 6-2, type APO-A, dikte E = 7 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.21067')
