...
class Post050413000(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.13000',
            beschrijving='Waterdoorlatende steenslagfundering volgens 5-4.13, plaatselijke uitvoering',
            meetstaateenheid='M3',
