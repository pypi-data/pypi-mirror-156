...
class Post060341180(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41180',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, grijs volgens 6-3.5, met verbrede voeg, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41180')
