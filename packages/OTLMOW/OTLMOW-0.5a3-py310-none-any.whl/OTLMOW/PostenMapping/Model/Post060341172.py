...
class Post060341172(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41172',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, grijs volgens 6-3.5, met drainageopeningen, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41172')
