...
class Post060361416(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.61416',
            beschrijving='Onbehandelde betontegels, wit met kleurondersteunende granulaten volgens 6-3.7, 300 x 300, 60 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.61416')
