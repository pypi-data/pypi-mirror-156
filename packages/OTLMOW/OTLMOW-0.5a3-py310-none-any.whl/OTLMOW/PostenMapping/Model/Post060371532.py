...
class Post060371532(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.71532',
            beschrijving='Gezaagde natuursteentegels, gebruiksklasse 5 volgens 6-3.8, 300 x 300, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.71532')
