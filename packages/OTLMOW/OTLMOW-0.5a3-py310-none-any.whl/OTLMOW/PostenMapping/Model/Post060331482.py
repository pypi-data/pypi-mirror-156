...
class Post060331482(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31482',
            beschrijving='Onbehandelde betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, voegstenen 200 x 200, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31482')
