...
class Post060351580(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.51580',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse A volgens 6-3.6, langformaat, hoogte ca. 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.51580')
