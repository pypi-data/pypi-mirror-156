...
class Post060340230(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40230',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.5, 220 x 220, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40230')
