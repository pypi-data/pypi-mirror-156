...
class Post050407101(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.07101',
            beschrijving='Fundering en stut van zandcement voor lijnvormige elementen volgens 5-4.7, volume ≤ 0,025 m³/m',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0504.07101')
