...
class Post060340318(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40318',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met kleurondersteunende granulaten volgens 6-3.5, 220 x 110, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40318')
