...
class Post060271064(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.71064',
            beschrijving='Toplaag van gietasfalt, bouwklassegroep B6-B10 en BF volgens 6-2, type GA-C, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.71064')
