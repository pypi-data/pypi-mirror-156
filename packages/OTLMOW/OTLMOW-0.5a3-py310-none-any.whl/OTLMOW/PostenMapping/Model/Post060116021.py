...
class Post060116021(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.16021',
            beschrijving='Ongewapende cementbetonverharding, bouwklassegroep B6-B10 volgens 6-1, dikte E = 21 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.16021')
