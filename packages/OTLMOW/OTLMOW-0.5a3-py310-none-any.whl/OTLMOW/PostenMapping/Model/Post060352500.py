...
class Post060352500(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.52500',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse B volgens 6-3.6, langformaat, hoogte ca. 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.52500')
