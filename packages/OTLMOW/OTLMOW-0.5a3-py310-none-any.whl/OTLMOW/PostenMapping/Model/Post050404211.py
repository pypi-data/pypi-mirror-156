...
class Post050404211(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.04211',
            beschrijving='Steenslagfundering met continue korrelverdeling met toevoegsel, type IIA volgens 5-4.4, dikte 11 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.04211')
