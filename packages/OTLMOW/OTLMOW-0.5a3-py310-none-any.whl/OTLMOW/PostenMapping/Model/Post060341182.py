...
class Post060341182(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41182',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, grijs volgens 6-3.5, met verbrede voeg, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41182')
