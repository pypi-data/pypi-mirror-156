...
class Post060261244(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.61244',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type SMA-C2 met polymeerbitumen, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.61244')
