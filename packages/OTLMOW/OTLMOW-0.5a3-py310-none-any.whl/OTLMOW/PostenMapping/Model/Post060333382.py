...
class Post060333382(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33382',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, voegstenen 200 x 200, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33382')
