...
class Post060190302(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.90302',
            beschrijving='Meerprijs voor figureren van het betonoppervlak volgens 6-1.4.10.5, in de massa gekleurd',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.90302')
