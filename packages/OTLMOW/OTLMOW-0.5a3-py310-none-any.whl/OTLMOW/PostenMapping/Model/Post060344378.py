...
class Post060344378(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.44378',
            beschrijving='Gestaalstraalde waterdoorlatende betonstraatstenen, gekleurd met kleurondersteunende granulaten volgens 6-3.5, met drainageopeningen, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.44378')
