...
class Post050303100(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.03100',
            beschrijving='Opbreken en afvoeren van een tijdelijke onderfundering type II volgens 5-3.3',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='Activiteit [opbreken en afvoeren] komt niet voor in de OTL',
                standaardpostnummer='0503.03100')
