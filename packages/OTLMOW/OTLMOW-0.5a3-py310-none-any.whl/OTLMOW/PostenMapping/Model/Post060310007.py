...
class Post060310007(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.10007',
            beschrijving='Bed van zand voor bestratingen van in rijen te leggen kasseien, Enom = 7,5 cm volgens 6-3.2.4.1',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.10007')
