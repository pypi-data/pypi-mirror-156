...
class Post060331458(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31458',
            beschrijving='Onbehandelde betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, 300 x 300, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31458')
