...
class Post060116018(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.16018',
            beschrijving='Ongewapende cementbetonverharding, bouwklassegroep B6-B10 volgens 6-1, dikte E = 18 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.16018')
