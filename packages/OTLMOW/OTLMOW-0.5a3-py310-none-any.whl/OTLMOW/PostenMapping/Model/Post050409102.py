...
class Post050409102(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.09102',
            beschrijving='Fundering en stut van schraal beton voor lijnvormige elementen volgens 5-4.9, volume ≤ 0,050 m³/m',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='Eigenschap [volumePerMeter] is niet aanwezig in de OTL [Onderbouw]',
                standaardpostnummer='0504.09102')
