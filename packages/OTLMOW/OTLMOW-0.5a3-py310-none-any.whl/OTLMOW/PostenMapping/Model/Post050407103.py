...
class Post050407103(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.07103',
            beschrijving='Fundering en stut van zandcement voor lijnvormige elementen volgens 5-4.7, volume ≤ 0,075 m³/m',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0504.07103')
