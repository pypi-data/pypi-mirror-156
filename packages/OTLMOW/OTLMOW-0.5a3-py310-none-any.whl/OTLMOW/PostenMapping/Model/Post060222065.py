...
class Post060222065(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.22065',
            beschrijving='Onderlaag, bouwklassegroep B6-B10 en BF volgens 6-2, type APO-B, dikte E = 5 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.22065')
