...
class Post060216045(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.16045',
            beschrijving='Profileerlaag, bouwklassegroep B4-B5 volgens 6-2, type ABT-B, dikte E = 4 à 6 cm',
            ...
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.16045')
