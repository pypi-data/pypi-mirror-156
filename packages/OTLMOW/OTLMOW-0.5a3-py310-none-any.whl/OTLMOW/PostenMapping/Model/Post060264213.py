...
class Post060264213(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.64213',
            beschrijving='Toplaag, bouwklassegroep B1-B3 volgens 6-2, type ZOA-C2 met polymeerbitumen, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.64213')
