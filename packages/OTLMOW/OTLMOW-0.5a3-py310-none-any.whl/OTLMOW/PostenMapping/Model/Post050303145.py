...
class Post050303145(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.03145',
            beschrijving='Tijdelijke onderfundering type II (minder-hindersteenslag), inclusief instandhouden volgens 5-3.3, dikte 45 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0503.03145')
