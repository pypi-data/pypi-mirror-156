...
class Post060341482(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41482',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.5, met verbrede voeg, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41482')
