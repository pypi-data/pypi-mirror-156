...
class Post050409103(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.09103',
            beschrijving='Fundering en stut van schraal beton voor lijnvormige elementen volgens 5-4.9, volume ≤ 0,075 m³/m',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0504.09103')
