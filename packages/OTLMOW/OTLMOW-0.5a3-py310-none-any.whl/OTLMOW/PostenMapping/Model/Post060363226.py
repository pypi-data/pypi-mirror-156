...
class Post060363226(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.63226',
            beschrijving='Gewassen betontegels, gekleurd met anorganische pigmenten volgens 6-3.7, 400 x 400, 60 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.63226')
