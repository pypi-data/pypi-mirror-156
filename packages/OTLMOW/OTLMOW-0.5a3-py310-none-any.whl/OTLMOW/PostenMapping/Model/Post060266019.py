...
class Post060266019(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.66019',
            beschrijving='Toplaag, bouwklassegroep B1-B3 volgens 6-2, type AGT klasse II op onderlaag APO-A, totale dikte E = 9 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.66019')
