...
class Post050404125(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.04125',
            beschrijving='Steenslagfundering met continue korrelverdeling met toevoegsel, type IA volgens 5-4.4, dikte 25 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.04125')
