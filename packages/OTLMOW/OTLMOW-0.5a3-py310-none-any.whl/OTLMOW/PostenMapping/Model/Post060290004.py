...
class Post060290004(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.90004',
            beschrijving='Aanbrengen van een voeg tussen een betonnen kantstrook en de bitumineuze verharding volgens 6-2.4.2.5.A',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.90004')
