...
class Post050305300(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.05300',
            beschrijving='Aanleg van groeiplaatsconstructie voor bomen',
            meetstaateenheid='M3',
