...
class Post060310057(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.10057',
            beschrijving='Bed van zandcement voor bestratingen van in rijen te leggen kasseien, Enom = 7,5 cm volgens 6-3.2.4.2',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.10057')
