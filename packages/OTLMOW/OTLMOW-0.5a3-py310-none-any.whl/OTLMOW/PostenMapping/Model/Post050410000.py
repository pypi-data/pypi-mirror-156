...
class Post050410000(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.10000',
            beschrijving='Fundering van drainerend schraal beton volgens 5-4.10, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.10000')
