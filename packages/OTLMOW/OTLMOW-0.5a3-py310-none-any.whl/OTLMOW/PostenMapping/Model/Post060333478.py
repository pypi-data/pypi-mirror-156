...
class Post060333478(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33478',
            beschrijving='Gewassen betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, voegstenen 220 x 220, 80 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33478')
