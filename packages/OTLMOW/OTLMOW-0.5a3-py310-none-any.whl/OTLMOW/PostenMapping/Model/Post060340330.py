...
class Post060340330(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40330',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met kleurondersteunende granulaten volgens 6-3.5, 220 x 220, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40330')
