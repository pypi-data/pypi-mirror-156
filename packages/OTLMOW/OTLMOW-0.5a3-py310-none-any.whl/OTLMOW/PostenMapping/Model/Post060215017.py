...
class Post060215017(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.15017',
            beschrijving='Profileerlaag, bouwklassegroep B1-B3 volgens 6-2, type AVS-B, dikte E = 6 à 8 cm',
            ...
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.15017')
