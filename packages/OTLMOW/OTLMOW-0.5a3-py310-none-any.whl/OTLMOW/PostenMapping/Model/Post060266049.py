...
class Post060266049(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.66049',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type AGT klasse II op onderlaag APO-A, totale dikte E = 9 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.66049')
                ...
                defaultWaarde='onderlaag-APO-A-en-toplaag-AGT-klasse-II',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                isAltijdInTeVullen=0,
