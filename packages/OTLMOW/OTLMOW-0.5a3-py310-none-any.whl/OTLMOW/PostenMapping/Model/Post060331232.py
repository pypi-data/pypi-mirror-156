...
class Post060331232(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31232',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 220 x 220, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31232')
