...
class Post060151023(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.51023',
            beschrijving='Doorgaand gewapende cementbetonverharding voor rotondes, bouwklassegroep B1-B5 volgens 6-1, dikte E = 23 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0601.51023')
