...
class Post060332210(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.32210',
            beschrijving='Getrommelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 220 x 110, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.32210')
