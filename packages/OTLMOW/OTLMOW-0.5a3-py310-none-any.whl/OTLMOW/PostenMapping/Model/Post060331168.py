...
class Post060331168(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31168',
            beschrijving='Onbehandelde betonstraatstenen, grijs volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 80 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31168')
