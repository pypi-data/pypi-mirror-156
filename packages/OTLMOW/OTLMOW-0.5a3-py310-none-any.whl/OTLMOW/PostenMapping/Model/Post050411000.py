...
class Post050411000(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.11000',
            beschrijving='Fundering in walsbeton volgens 5-4.11, plaatselijk uitvoering',
            meetstaateenheid='M3',
