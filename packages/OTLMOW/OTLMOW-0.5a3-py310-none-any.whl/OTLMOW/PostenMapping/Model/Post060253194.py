...
class Post060253194(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.53194',
            beschrijving='Toplaag van asfaltbeton, bouwklassegroep B9-B10 en BF volgens 6-2, type AB-4C, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.53194')
