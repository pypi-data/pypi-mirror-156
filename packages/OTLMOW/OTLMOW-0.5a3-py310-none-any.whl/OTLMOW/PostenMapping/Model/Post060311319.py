...
class Post060311319(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.11319',
            beschrijving='Bestrating van in rijen te leggen kasseien volgens 6-3.2, langwerpige kasseien 13 x 19 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.11319')
