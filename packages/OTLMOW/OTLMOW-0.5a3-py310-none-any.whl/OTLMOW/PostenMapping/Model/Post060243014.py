...
class Post060243014(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.43014',
            beschrijving='Beschermingslaag, bouwklassegroep B1-B3 volgens 6-2, type APO-C, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.43014')
