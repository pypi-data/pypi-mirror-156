...
class Post060370053(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.70053',
            beschrijving='Bed van zandcement voor bestratingen van natuursteentegels, Enom = 3 cm volgens 6-3.8.4.1',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.70053')
