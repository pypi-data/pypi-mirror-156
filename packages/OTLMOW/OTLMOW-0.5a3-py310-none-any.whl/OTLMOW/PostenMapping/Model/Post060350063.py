...
class Post060350063(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.50063',
            beschrijving='Mortelbed voor bestratingen van gebakken straatstenen, Enom = 3 cm volgens 6-3.4.4.3',
            meetstaateenheid='M2',
