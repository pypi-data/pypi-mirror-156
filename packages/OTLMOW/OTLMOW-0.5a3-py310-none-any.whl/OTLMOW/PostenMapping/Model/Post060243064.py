...
class Post060243064(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.43064',
            beschrijving='Beschermingslaag, bouwklassegroep B6-B10 en BF volgens 6-2, type APO-C, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.43064')
