...
class Post060352400(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.52400',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse B volgens 6-3.6, rijnformaat, hoogte ca. 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                defaultWaarde='rijnformaat-(ca.-180-x-ca.-45-mm)',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.52400')
