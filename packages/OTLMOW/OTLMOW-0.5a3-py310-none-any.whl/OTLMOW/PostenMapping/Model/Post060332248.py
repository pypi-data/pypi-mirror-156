...
class Post060332248(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.32248',
            beschrijving='Getrommelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 200 x 200, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.32248')
