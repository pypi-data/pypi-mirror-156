...
class Post060333352(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33352',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, 300 x 300, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33352')
