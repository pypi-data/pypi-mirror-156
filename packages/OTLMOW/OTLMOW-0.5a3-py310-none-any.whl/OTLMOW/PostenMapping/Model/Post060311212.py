...
class Post060311212(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.11212',
            beschrijving='Bestrating van in rijen te leggen kasseien volgens 6-3.2, vierkante kasseien 12 x 12 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.11212')
