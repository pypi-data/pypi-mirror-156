...
class Post060341472(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41472',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.5, met drainageopeningen, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41472')
