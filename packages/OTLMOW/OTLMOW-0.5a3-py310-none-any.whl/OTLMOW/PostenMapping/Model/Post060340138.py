...
class Post060340138(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40138',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, grijs volgens 6-3.5, 220 x 220, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40138')
