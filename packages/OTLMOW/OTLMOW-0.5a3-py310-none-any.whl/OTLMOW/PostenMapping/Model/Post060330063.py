...
class Post060330063(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.30063',
            beschrijving='Mortelbed voor bestratingen van betonstraatstenen, Enom = 3 cm volgens 6-3.4.4.3',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.30063')
