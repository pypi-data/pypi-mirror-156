...
class Post060380085(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.80085',
            beschrijving='Bed van bodemsubstraat met zand, Enom = 5 cm volgens 6-3.9.4.1',
            meetstaateenheid='M2',
