...
class Post060333472(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33472',
            beschrijving='Gewassen betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, voegstenen 220 x 220, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33472')
