...
class Post060371620(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.71620',
            beschrijving='Gezaagde natuursteentegels, gebruiksklasse 6 volgens 6-3.8, 200 x 200, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.71620')
