...
class Post060190102(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.90102',
            beschrijving='Meerprijs voor in de massa gekleurde betonverharding volgens 6-1.3.4, kleur oker/beige',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.90102')
