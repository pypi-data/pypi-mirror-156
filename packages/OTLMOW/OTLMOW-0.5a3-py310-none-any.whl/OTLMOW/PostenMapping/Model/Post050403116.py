...
class Post050403116(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.03116',
            beschrijving='Steenslagfundering met continue korrelverdeling zonder toevoegsels, type I volgens 5-4.3, dikte 16 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.03116')
