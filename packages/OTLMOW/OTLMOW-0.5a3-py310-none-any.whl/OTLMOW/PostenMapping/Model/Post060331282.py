...
class Post060331282(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31282',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, voegstenen 200 x 200, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31282')
