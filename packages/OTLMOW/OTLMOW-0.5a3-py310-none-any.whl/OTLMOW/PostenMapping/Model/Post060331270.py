...
class Post060331270(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31270',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, voegstenen 220 x 220, 100 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31270')
