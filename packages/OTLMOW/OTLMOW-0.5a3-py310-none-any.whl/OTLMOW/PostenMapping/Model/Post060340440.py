...
class Post060340440(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40440',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.5, 200 x 200, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40440')
