...
class Post050404100(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.04100',
            beschrijving='Steenslagfundering met continue korrelverdeling met toevoegsel, type IA volgens 5-4.4, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.04100')
