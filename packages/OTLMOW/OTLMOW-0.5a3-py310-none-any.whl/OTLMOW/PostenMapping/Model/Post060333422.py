...
class Post060333422(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33422',
            beschrijving='Gewassen betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, 220 x 110 in visgraat- of keperverband, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33422')
