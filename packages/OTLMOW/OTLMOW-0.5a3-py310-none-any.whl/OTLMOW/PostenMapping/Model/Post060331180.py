...
class Post060331180(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31180',
            beschrijving='Onbehandelde betonstraatstenen, grijs volgens 6-3.4, voegstenen 200 x 200, 100 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31180')
