...
class Post060263144(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.63144',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type ZOA-B1 met gewoon wegenbitumen, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.63144')
                ...
                defaultWaarde='gewoon-wegenbitumen',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                isAltijdInTeVullen=0,
