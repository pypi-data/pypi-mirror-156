...
class Post060272063(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.72063',
            beschrijving='Toplaag van gietasfalt, bouwklassegroep B6-B10 en BF volgens 6-2, type GA-D, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.72063')
