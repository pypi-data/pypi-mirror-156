...
class Post060371632(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.71632',
            beschrijving='Gezaagde natuursteentegels, gebruiksklasse 6 volgens 6-3.8, 300 x 300, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.71632')
