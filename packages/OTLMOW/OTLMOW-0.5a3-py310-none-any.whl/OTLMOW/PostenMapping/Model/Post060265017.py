...
class Post060265017(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.65017',
            beschrijving='Toplaag, bouwklassegroep B1-B3 volgens 6-2, type AGT klasse I op onderlaag APO-B, totale dikte E = 7 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.65017')
