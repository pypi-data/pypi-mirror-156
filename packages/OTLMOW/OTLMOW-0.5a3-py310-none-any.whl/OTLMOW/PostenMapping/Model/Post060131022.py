...
class Post060131022(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.31022',
            beschrijving='Ongewapende tweelaagse cementbetonverharding, bouwklassegroep B1-B5 volgens 6-1, dikte E = 22 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.31022')
