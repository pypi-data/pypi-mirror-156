...
class Post060360003(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.60003',
            beschrijving='Bed van zand voor bestratingen van betontegels, Enom = 3 cm volgens 6-3.7.4.1',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.60003')
