...
class Post060333350(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33350',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, 300 x 300, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33350')
