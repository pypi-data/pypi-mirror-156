...
class Post060333448(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33448',
            beschrijving='Gewassen betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, 200 x 200, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33448')
