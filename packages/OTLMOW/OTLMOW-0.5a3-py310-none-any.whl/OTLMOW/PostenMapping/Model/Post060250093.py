...
class Post060250093(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.50093',
            beschrijving='Meerprijs voor gekleurde AB-toplaag volgens 6-2.3.2.2, kleur bordeaux/bruin',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.50093')
