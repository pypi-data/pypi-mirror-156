...
class Post060215047(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.15047',
            beschrijving='Profileerlaag, bouwklassegroep B4-B5 volgens 6-2, type AVS-B, dikte E = 6 à 8 cm',
            ...
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.15047')
