...
class Post060265019(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.65019',
            beschrijving='Toplaag, bouwklassegroep B1-B3 volgens 6-2, type AGT klasse I op onderlaag APO-A, totale dikte E = 9 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.65019')
                ...
                defaultWaarde='onderlaag-APO-A-en-toplaag-AGT-klasse-I',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                isAltijdInTeVullen=0,
