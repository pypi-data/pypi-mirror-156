...
class Post060340238(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40238',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.5, 220 x 220, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40238')
