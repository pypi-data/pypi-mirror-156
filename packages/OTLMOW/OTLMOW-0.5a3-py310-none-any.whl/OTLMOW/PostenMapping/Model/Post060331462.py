...
class Post060331462(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31462',
            beschrijving='Onbehandelde betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31462')
