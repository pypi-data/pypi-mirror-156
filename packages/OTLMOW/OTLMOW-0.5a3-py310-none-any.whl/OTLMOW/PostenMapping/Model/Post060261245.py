...
class Post060261245(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.61245',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type SMA-C2 met polymeerbitumen, dikte E = 5 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.61245')
