...
class Post050409108(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.09108',
            beschrijving='Fundering en stut van schraal beton voor lijnvormige elementen volgens 5-4.9, volume ≤ 0,200 m³/m',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0504.09108')
