...
class Post060255192(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.55192',
            beschrijving='Toplaag van asfaltbeton, bouwklassegroep B9-B10 en BF volgens 6-2, type AB-5D, dikte E = 2,5 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.55192')
