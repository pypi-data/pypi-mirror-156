...
class Post060370062(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.70062',
            beschrijving='Mortelbed voor bestratingen van natuursteentegels, Enom = 2,5 cm volgens 6-3.8.4.2',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.70062')
