...
class Post060311313(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.11313',
            beschrijving='Bestrating van in rijen te leggen kasseien volgens 6-3.2, vierkante kasseien 13 x 13 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.11313')
