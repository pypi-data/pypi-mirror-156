...
class Post050402000(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.02000',
            beschrijving='Steenslagfundering met niet-continue korrelverdeling volgens 5-4.2, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.02000')
                , StandaardPostMapping(
                typeURI='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Onderbouw',
                attribuutURI='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#Onderbouw.type',
                dotnotation='type',
                defaultWaarde='steenslag-met-niet-continue-korrelverdeling',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                isAltijdInTeVullen=0,
