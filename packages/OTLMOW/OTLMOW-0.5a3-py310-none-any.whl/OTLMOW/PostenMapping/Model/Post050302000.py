...
class Post050302000(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.02000',
            beschrijving='Onderfundering type I volgens 5-3.2, plaatselijke uitvoering',
            meetstaateenheid='M3',
