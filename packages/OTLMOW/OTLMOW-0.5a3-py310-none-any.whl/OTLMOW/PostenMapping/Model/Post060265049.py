...
class Post060265049(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.65049',
            beschrijving='Toplaag, bouwklassegroep B4-B5 volgens 6-2, type AGT klasse I op onderlaag APO-A, totale dikte E = 9 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.65049')
