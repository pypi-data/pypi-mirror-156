...
class Post060212065(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.12065',
            beschrijving='Profileerlaag, bouwklassegroep B6-B10 en BF volgens 6-2, type APO-B, dikte E = 4 à 6 cm',
            ...
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.12065')
