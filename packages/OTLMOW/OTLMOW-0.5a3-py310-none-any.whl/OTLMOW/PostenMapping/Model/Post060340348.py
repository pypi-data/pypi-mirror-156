...
class Post060340348(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40348',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met kleurondersteunende granulaten volgens 6-3.5, 200 x 200, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40348')
