...
class Post050304020(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0503.04020',
            beschrijving='Onderfundering type III volgens 5-3.4, dikte 20 cm',
            meetstaateenheid='M2',
