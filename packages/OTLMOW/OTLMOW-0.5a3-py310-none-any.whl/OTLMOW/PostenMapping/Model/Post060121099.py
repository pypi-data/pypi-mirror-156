...
class Post060121099(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.21099',
            beschrijving='Doorgaand gewapende cementbetonverharding, bouwklassegroep B1-B5 volgens 6-1, uitvoering op veranderlijke dikte',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.21099')
