...
class Post060263214(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.63214',
            beschrijving='Toplaag, bouwklassegroep B1-B3 volgens 6-2, type ZOA-B2 met polymeerbitumen, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.63214')
