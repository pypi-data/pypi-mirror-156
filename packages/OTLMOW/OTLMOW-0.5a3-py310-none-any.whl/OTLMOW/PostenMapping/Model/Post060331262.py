...
class Post060331262(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31262',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31262')
