...
class Post060331472(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31472',
            beschrijving='Onbehandelde betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.4, voegstenen 220 x 220, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31472')
