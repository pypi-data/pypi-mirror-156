...
class Post060333342(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33342',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, 200 x 200, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33342')
