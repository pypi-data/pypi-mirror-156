...
class Post060343470(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.43470',
            beschrijving='Gewassen waterdoorlatende betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.5, met drainageopeningen, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.43470')
