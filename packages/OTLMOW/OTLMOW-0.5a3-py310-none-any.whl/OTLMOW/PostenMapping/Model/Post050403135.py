...
class Post050403135(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.03135',
            beschrijving='Steenslagfundering met continue korrelverdeling zonder toevoegsels, type I volgens 5-4.3, dikte 35 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.03135')
