...
class Post060216015(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.16015',
            beschrijving='Profileerlaag, bouwklassegroep B1-B3 volgens 6-2, type ABT-B, dikte E = 4 à 6 cm',
            ...
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.16015')
