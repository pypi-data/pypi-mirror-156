...
class Post060331288(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31288',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, voegstenen 200 x 200, 80 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31288')
