...
class Post060331260(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31260',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 100 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31260')
