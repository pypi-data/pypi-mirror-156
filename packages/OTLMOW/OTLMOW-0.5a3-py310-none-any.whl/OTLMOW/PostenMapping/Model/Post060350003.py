...
class Post060350003(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.50003',
            beschrijving='Bed van zand voor bestratingen van gebakken straatstenen, Enom = 3 cm volgens 6-3.4.4.1',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.50003')
