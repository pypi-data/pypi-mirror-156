...
class Post060381012(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.81012',
            beschrijving='Bestrating van grasbetontegels opgevuld met bodemsubstraat volgens 6-3.9, nominale dikte 12 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.81012')
