...
class Post060261214(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.61214',
            beschrijving='Toplaag, bouwklassegroep B1-B3 volgens 6-2, type SMA-C2 met polymeerbitumen, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.61214')
