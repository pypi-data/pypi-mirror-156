...
class Post060352100(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.52100',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse B volgens 6-3.6, waalformaat, hoogte ca. 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.52100')
