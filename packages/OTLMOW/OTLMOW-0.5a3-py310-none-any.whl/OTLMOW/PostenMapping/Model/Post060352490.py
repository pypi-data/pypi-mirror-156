...
class Post060352490(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.52490',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse B volgens 6-3.6, rijnformaat, hoogte ca. 90 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.52490')
