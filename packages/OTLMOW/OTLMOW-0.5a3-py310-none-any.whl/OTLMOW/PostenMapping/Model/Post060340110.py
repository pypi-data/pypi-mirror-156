...
class Post060340110(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40110',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, grijs volgens 6-3.5, 220 x 110, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40110')
