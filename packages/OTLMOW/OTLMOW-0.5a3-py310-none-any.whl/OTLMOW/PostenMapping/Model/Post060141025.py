...
class Post060141025(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.41025',
            beschrijving='Doorgaand gewapende tweelaagse cementbetonverharding, bouwklassegroep B1-B5 volgens 6-1, dikte E = 25 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.41025')
