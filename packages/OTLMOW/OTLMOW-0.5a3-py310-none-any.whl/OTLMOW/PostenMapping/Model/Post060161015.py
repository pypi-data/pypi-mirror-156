...
class Post060161015(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.61015',
            beschrijving='Verharding in staalvezelbeton, bouwklassegroep B1-B5 volgens 6-1, dikte E = 15 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0601.61015')
