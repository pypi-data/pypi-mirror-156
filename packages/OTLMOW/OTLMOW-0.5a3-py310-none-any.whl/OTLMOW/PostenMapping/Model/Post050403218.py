...
class Post050403218(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.03218',
            beschrijving='Steenslagfundering met continue korrelverdeling zonder toevoegsels, type II volgens 5-4.3, dikte 18 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.03218')
