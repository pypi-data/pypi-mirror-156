...
class Post060340340(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40340',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, gekleurd met kleurondersteunende granulaten volgens 6-3.5, 200 x 200, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40340')
