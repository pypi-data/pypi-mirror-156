...
class Post060320054(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.20054',
            beschrijving='Bed van zandcement voor bestratingen van mozaïekkeien, Enom = 4 cm volgens 6-3.3.4.2',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.20054')
