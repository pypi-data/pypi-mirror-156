...
class Post060331222(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31222',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 220 x 110 in visgraat- of keperverband, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31222')
