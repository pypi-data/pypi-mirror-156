...
class Post060333378(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33378',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, voegstenen 220 x 220, 80 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33378')
