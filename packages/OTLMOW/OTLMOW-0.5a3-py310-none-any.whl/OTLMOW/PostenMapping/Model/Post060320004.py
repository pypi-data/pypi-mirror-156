...
class Post060320004(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.20004',
            beschrijving='Bed van zand voor bestratingen van mozaïekkeien, Enom = 4 cm volgens 6-3.3.4.1',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.20004')
