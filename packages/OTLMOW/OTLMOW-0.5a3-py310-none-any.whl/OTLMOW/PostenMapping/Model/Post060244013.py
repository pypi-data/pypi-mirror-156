...
class Post060244013(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.44013',
            beschrijving='Beschermingslaag, bouwklassegroep B1-B3 volgens 6-2, type APO-D, dikte E = 3 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.44013')
