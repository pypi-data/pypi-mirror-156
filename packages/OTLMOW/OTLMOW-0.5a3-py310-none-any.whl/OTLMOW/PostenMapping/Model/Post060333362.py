...
class Post060333362(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.33362',
            beschrijving='Gewassen betonstraatstenen, met kleurondersteunende granulaten volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.33362')
