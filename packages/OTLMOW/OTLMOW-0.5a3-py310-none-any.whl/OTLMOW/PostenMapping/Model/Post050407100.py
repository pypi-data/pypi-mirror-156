...
class Post050407100(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.07100',
            beschrijving='Fundering en stut van zandcement voor lijnvormige elementen volgens 5-4.7, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.07100')
