...
class Post060331160(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31160',
            beschrijving='Onbehandelde betonstraatstenen, grijs volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 100 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31160')
