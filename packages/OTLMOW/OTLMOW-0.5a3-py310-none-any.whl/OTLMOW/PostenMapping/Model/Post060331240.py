...
class Post060331240(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31240',
            beschrijving='Onbehandelde betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.4, 200 x 200, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31240')
