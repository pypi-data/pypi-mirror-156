...
class Post060290002(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.90002',
            beschrijving='Aanbrengen van een naad in de toplaag volgens 6-2.4.2.4.B, geëxtrudeerde voegband',
            meetstaateenheid='M',
