...
class Post060341282(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.41282',
            beschrijving='Onbehandelde waterdoorlatende betonstraatstenen, gekleurd met anorganische pigmenten volgens 6-3.5, met verbrede voeg, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.41282')
