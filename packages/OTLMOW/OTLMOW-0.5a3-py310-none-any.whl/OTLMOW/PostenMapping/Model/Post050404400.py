...
class Post050404400(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0504.04400',
            beschrijving='Steenslagfundering met continue korrelverdeling met toevoegsel, type IIB volgens 5-4.4, plaatselijke uitvoering',
            meetstaateenheid='M3',
            mappings=[StandaardPostMapping(
                ...
                dotnotation='type',
                defaultWaarde='met-toevoegsel-behandelde-steenslag-met-continue-korrelverdeling---type-IIB',
                range='',
                usagenote='',
                isMeetstaatAttr=0,
                ...
                mappingOpmerking='',
                standaardpostnummer='0504.04400')
