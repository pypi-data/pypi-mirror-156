...
class Post060332120(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.32120',
            beschrijving='Getrommelde betonstraatstenen, grijs volgens 6-3.4, 220 x 110 in visgraat- of keperverband, 100 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.32120')
