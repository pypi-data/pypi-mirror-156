...
class Post060243044(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.43044',
            beschrijving='Beschermingslaag, bouwklassegroep B4-B5 volgens 6-2, type APO-C, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.43044')
