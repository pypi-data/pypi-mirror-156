...
class Post060351565(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.51565',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse A volgens 6-3.6, langformaat, hoogte ca. 65 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.51565')
