...
class Post060351470(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.51470',
            beschrijving='Bestrating van gebakken straatstenen, standaardkwaliteitsklasse A volgens 6-3.6, rijnformaat, hoogte ca. 70 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.51470')
