...
class Post060361228(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.61228',
            beschrijving='Onbehandelde betontegels, gekleurd met anorganische pigmenten volgens 6-3.7, 400 x 400, 80 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.61228')
