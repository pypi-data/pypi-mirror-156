...
class Post060361426(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.61426',
            beschrijving='Onbehandelde betontegels, wit met kleurondersteunende granulaten volgens 6-3.7, 400 x 400, 60 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.61426')
