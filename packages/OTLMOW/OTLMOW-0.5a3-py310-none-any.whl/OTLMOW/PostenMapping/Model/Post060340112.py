...
class Post060340112(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.40112',
            beschrijving='Poreuze waterdoorlatende betonstraatstenen, grijs volgens 6-3.5, 220 x 110, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.40112')
