...
class Post060331162(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.31162',
            beschrijving='Onbehandelde betonstraatstenen, grijs volgens 6-3.4, supplement bisschops- of kardinaalsmutsen, 120 mm',
            meetstaateenheid='M',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.31162')
