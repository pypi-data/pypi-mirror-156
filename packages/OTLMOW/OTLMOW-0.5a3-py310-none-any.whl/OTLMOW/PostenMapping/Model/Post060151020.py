...
class Post060151020(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0601.51020',
            beschrijving='Doorgaand gewapende cementbetonverharding voor rotondes, bouwklassegroep B1-B5 volgens 6-1, dikte E = 20 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                standaardpostnummer='0601.51020')
