...
class Post060222064(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0602.22064',
            beschrijving='Onderlaag, bouwklassegroep B6-B10 en BF volgens 6-2, type APO-B, dikte E = 4 cm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0602.22064')
