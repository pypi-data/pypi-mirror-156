...
class Post060363216(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.63216',
            beschrijving='Gewassen betontegels, gekleurd met anorganische pigmenten volgens 6-3.7, 300 x 300, 60 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.63216')
