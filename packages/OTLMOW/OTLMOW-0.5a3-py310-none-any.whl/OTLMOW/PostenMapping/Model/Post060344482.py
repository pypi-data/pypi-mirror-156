...
class Post060344482(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.44482',
            beschrijving='Gestaalstraalde waterdoorlatende betonstraatstenen, wit met kleurondersteunende granulaten volgens 6-3.5, met verbrede voeg, 120 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.44482')
