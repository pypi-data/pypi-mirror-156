...
class Post060391150(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.91150',
            beschrijving='Verharding van gras-kunststofplaten opgevuld met bodemsubstraat en ingezaaid volgens 6-3.10, nominale dikte 50 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.91150')
