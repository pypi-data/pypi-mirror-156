...
class Post060393150(StandaardPost):
    def __init__(self):
        super().__init__(
            nummer='0603.93150',
            beschrijving='Verharding van gras-kunststofplaten opgevuld met steenslag 2/6,3 volgens 6-3.10, nominale dikte 50 mm',
            meetstaateenheid='M2',
            mappings=[StandaardPostMapping(
                ...
                mappingOpmerking='',
                standaardpostnummer='0603.93150')
