...
class DependencyOp:
    ...
    intersects: Union[None, Set[str]] = attr.ib(
        default=None, converter=as_set, kw_only=True
    )
    operations = {
        "eq": lambda a, b: a == b,
        "ne": lambda a, b: a != b,
    ...
    @classmethod
    def from_dict(
        cls, d: Union[None, str, Dict[str, Any], "DependencyOp"]
    ) -> "Union[None, DependencyOp]":
        if isinstance(d, cls):
            return d
...
class Dependants:
    ...
    @classmethod
    def from_dict(
        cls, d: Union[None, Dict[str, Any], "Dependants"]
    ) -> "Union[None, Dependants]":
        if isinstance(d, cls):
            return d
        elif isinstance(d, dict):
            return cls(
