...
[boto3 1.24.14](https://boto3.amazonaws.com/v1/documentation/api/1.24.14/index.html)
...
- `boto3-stubs-lite[all]` - Type annotations for all 309 services.
...
- `boto3-stubs-lite[redshift-data]` - Type annotations for
  ...
  service.
- `boto3-stubs-lite[redshiftserverless]` - Type annotations for
  [RedshiftServerless](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_redshiftserverless/)
  service.
