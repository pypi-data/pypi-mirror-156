...
```
pip install image_classification_misis
```

After that you can make predictions, using the package:

## Web application
Link to the app: https://github.com/drus-13/fast-api-application

Link to the corresponding Heroku link: https://fast-api-application.herokuapp.com
