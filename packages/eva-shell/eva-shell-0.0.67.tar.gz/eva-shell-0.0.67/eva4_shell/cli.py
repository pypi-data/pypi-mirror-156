...
class CLI:
    ...
    def registry_manage(self, yedb_args=None):
        ...
        try:
            ...
            yedb_socket = f'elbus://{common.bus_path}:eva.registry'
    ...
    def spoint_list(self):
        ...
        print_result(data, cols=['name', 'port', 'version', 'build'])
    ...
    def item_set(self, i, status, value):
        ...
        common.bus.send(
            'RAW/' + i.replace(':', '/', 1),
            elbus.client.Frame(pack(payload), tp=elbus.client.OP_PUBLISH,
