...
class Database(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        cdk.CfnOutput(self, f"DatabaseAppName{identifier_prefix}", export_name=f"Database_AppName_{identifier_prefix}", value=str(app_name))
        cdk.CfnOutput(self, f"DatabaseIsHa{identifier_prefix}", export_name=f"Database_IsHa_{identifier_prefix}", value=str(is_ha))
        cdk.CfnOutput(self, f"DatabaseEngine{identifier_prefix}", export_name=f"Database_Engine_{identifier_prefix}", value=str(database_engine))
        cdk.CfnOutput(self, f"DatabaseEngineVersion{identifier_prefix}", export_name=f"Database_EngineVersion_{identifier_prefix}", value=str(database_engine_version))
        cdk.CfnOutput(self, f"DatabaseAllocatedStorage{identifier_prefix}", export_name=f"Database_AllocatedStorage_{identifier_prefix}", value=str(database_allocated_storage))
        cdk.CfnOutput(self, f"DatabaseWillSendEmail{identifier_prefix}", export_name=f"Database_WillSendEmail_{identifier_prefix}", value=str(sends_emails))
        cdk.CfnOutput(self, f"DatabaseHasBackup{identifier_prefix}", export_name=f"Database_HasBackup_{identifier_prefix}", value=str(to_be_backed_up))
        cdk.CfnOutput(self, f"DatabaseName{identifier_prefix}", export_name=f"Database_Name_{identifier_prefix}", value=str(database_name))
        cdk.CfnOutput(self, f"DatabaseIdentifierPrefix{identifier_prefix}", export_name=f"Database_IdentifierPrefix_{identifier_prefix}", value=str(identifier_prefix))
