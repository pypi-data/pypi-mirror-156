...
MYRIAD_SUPPORTED_FRAMEWORKS: Incomplete
HAILO_SUPPORTED_FRAMEWORKS: str
EYECLOUD_SUPPORTED_FRAMEWORKS: str
...
class ModelConfig:
    ...
    @property
    def device(self) -> Optional[constants.SupportedDevices]: ...
    @property
    ...
    @property
    def dnn_myriad_support(self) -> bool: ...
    @property
    def dnn_cuda_support(self) -> bool: ...
    @property
    def tensor_rt_support(self) -> bool: ...
    @property
    def eyecloud_support(self) -> bool: ...
    @property
