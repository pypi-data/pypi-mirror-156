...
class SSUMulticoreAnalyzer(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        self.n_tasks_label = QtWidgets.QLabel(self.tr("Number of Tasks"))
        ...
        self.n_remains_label = QtWidgets.QLabel(self.tr("Number of Remains"))
    ...
    def retranslate(self):
        ...
        self.n_tasks_label.setText(self.tr("Number of Tasks"))
        self.n_workers_label.setText(self.tr("Number of Workers"))
        self.n_remains_label.setText(self.tr("Number of Remains"))
