class ke2600(object):
    ...
    def forVmeasI_manual_range(instr, voltage_range=6, curr_range=1, ch=1):
        if ch == 1:
            instr.write('smua.source.rangev = %f' % voltage_range)
            instr.write('smua.measure.rangei = %f' % curr_range)
        elif ch == 2:
            instr.write('smub.source.rangev = %f' % voltage_range)
            instr.write('smub.measure.rangei = %f' % curr_range)