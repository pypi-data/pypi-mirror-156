...
class TransformAuth:  # noqa: D
    ...
    def api_key(self, api_key: str) -> None:
        ...
        self.config.remove_config_value(BEARER_TOKEN_CONFIG_KEY)
        self.config.remove_config_value(BEARER_TOKEN_EXPIRES_AT_CONFIG_KEY)
    ...
    def mql_server_url_config_override(self, mql_server_url: str) -> None:  # noqa: D
        if not mql_server_url:
            self.config.remove_config_value(MQL_OVERRIDE_CONFIG_KEY)
