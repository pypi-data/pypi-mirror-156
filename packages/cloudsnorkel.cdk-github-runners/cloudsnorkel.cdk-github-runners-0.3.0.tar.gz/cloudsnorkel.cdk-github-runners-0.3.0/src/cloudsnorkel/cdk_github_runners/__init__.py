...
class GitHubRunners(
    ...
    def __init__(
        ...
        *,
        ...
        :stability: experimental
        '''
        props = GitHubRunnersProps(providers=providers)
...
class RunnerImage:
    def __init__(
        ...
        *,
        ...
        :param image_digest: (experimental) Image digest for providers that need to know the digest like Lambda. WARNING: the digest might change when the builder automatically rebuilds the image on a schedule. Do not expect for this digest to stay the same between deploys.
...
class StaticRunnerImage(
    ...
    @jsii.member(jsii_name="fromDockerHub") # type: ignore[misc]
    @builtins.classmethod
    def from_docker_hub(
        cls,
        scope: constructs.Construct,
