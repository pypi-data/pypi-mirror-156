        ...
        for where_condition in where:
            if isinstance(where_condition, Condition):
                if where_condition.field.column is not None:
                    vars = []
                    negation = None
                    if where_condition.negate is not None:
                        negation = "NOT"
                    ...
                    if where_condition.field.internalDataType is not None:
                        ...
                        if (
                            ...
                            if where_condition.field.sourceFormat is not None:
                                formatted_cond = field_with_agg + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ", format " + where_condition.field.sourceFormat + ") " + operator + " " + formatted_value
                            else:
                                formatted_cond = field_with_agg + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ", format YYYY-MM-DD" + ") " + operator + " " + formatted_value
                        else:
                            # else
                            formatted_cond = field_with_agg + " (" + where_condition.field.sourceDataType + ") " + operator + " " + formatted_value

                        conditions.append(formatted_cond)
                    else:
                        if formatted_value is not None and where_condition.direction is None:
                            if where_condition.negate is None:
                                formatted_cond = field_with_agg + " " + operator + " " + str(formatted_value)

                            else:
                                formatted_cond = field_with_agg + " " + negation + " " + operator + " " + str(formatted_value)
                        elif formatted_value is None and where_condition.direction is not None:
                            ...
                            if negation is None:
                                if where_condition.steps is not None and where_condition.interval is not None:
                                    formatted_cond = field_with_agg + " " + operator + " " + where_condition.interval + " " + direction + " " + where_condition.steps
                                elif where_condition.steps is not None and where_condition.interval is None:
                                    formatted_cond = (
                                            field_with_agg + " " + operator + " " + direction + " " + where_condition.steps
                                    )
                                elif where_condition.steps is None and where_condition.interval is not None:
                                    formatted_cond = field_with_agg + " " + operator + " " + where_condition.interval + " " + direction
                                else:
                                    formatted_cond = field_with_agg + " " + operator + " " + direction
                            else:
                                if where_condition.steps is not None and where_condition.interval is not None:
                                    formatted_cond = field_with_agg + " " + negation + " " + operator + " " + where_condition.interval + " " + direction + " " + where_condition.steps
                                elif where_condition.steps is not None and where_condition.interval is None:
                                    formatted_cond = field_with_agg + " " + negation + " " + operator + " " + direction + " " + where_condition.steps
                                elif where_condition.steps is None and where_condition.interval is not None:
                                    formatted_cond = field_with_agg + " " + negation + " " + operator + " " + where_condition.interval + " " + direction
                                else:
                                    formatted_cond = field_with_agg + " " + negation + " " + operator + " " + direction
                        elif operator is not None:
                            if negation is None:
                                formatted_cond = field_with_agg + " " + operator
                            else:
                                formatted_cond = field_with_agg + " " + negation + " " + operator
                        else:
                            formatted_cond = field_with_agg
                        conditions.append(formatted_cond)
