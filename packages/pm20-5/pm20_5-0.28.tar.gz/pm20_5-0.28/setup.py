...
setup(
  ...
  packages = ['pm20_5', 'qu1'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/ffufcok/pm20_5/archive/refs/tags/0.24.tar.gz',    # I explain this later on
