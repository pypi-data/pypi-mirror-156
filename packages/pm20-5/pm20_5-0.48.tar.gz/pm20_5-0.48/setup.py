...
setup(
  ...
  version = '0.48',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ffufcok/pm20_5/archive/refs/tags/0.47.tar.gz',    # I explain this later on
