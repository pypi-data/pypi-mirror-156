...
_MQTTTopicCallable = TypedDict(
    "_MQTTTopicCallable",
    {
        "avr/autonomous": _AvrAutonomousCallable,
        ...
        "avr/pcm/reset": _AvrPcmResetCallable,
...
_MQTTTopicPayload = TypedDict(
    "_MQTTTopicPayload",
    {
        "avr/autonomous": AvrAutonomousPayload,
        ...
        "avr/pcm/reset": AvrPcmResetPayload,
...
class MQTTModule:
    ...
    @overload
    def send_message(self, topic: Literal["avr/autonomous"], payload: AvrAutonomousPayload) -> None: ...
    ...
    @overload
    def send_message(self, topic: Literal["avr/pcm/reset"], payload: AvrPcmResetPayload) -> None: ...
    ...
    def send_message(self, topic: Literal["avr/autonomous", "avr/pcm/set_base_color", "avr/pcm/set_temp_color", "avr/pcm/set_laser_on", "avr/pcm/set_laser_off", "avr/pcm/set_servo_open_close", "avr/pcm/set_servo_min", "avr/pcm/set_servo_max", "avr/pcm/set_servo_pct", "avr/pcm/reset", "avr/fcm/hil_gps_stats", "avr/fcm/events", "avr/fcm/battery", "avr/fcm/status", "avr/fcm/location/local", "avr/fcm/location/global", "avr/fcm/location/home", "avr/fcm/attitude/euler", "avr/fcm/velocity", "avr/fcm/gps_info", "avr/fusion/position/ned", "avr/fusion/velocity/ned", "avr/fusion/geo", "avr/fusion/groundspeed", "avr/fusion/course", "avr/fusion/climbrate", "avr/fusion/attitude/quat", "avr/fusion/attitude/euler", "avr/fusion/attitude/heading", "avr/fusion/hil_gps", "avr/vio/resync", "avr/vio/position/ned", "avr/vio/velocity/ned", "avr/vio/orientation/eul", "avr/vio/orientation/quat", "avr/vio/heading", "avr/vio/confidence", "avr/apriltags/selected", "avr/apriltags/raw", "avr/apriltags/visible", "avr/apriltags/fps", "avr/thermal/reading", "avr/status/light/pcm", "avr/status/light/vio", "avr/status/light/apriltags", "avr/status/light/fcm", "avr/status/light/thermal"], payload: Union[AvrAutonomousPayload, AvrPcmSetBaseColorPayload, AvrPcmSetTempColorPayload, AvrPcmSetLaserOnPayload, AvrPcmSetLaserOffPayload, AvrPcmSetServoOpenClosePayload, AvrPcmSetServoMinPayload, AvrPcmSetServoMaxPayload, AvrPcmSetServoPctPayload, AvrPcmResetPayload, AvrFcmHilGpsStatsPayload, AvrFcmEventsPayload, AvrFcmBatteryPayload, AvrFcmStatusPayload, AvrFcmLocationLocalPayload, AvrFcmLocationGlobalPayload, AvrFcmLocationHomePayload, AvrFcmAttitudeEulerPayload, AvrFcmVelocityPayload, AvrFcmGpsInfoPayload, AvrFusionPositionNedPayload, AvrFusionVelocityNedPayload, AvrFusionGeoPayload, AvrFusionGroundspeedPayload, AvrFusionCoursePayload, AvrFusionClimbratePayload, AvrFusionAttitudeQuatPayload, AvrFusionAttitudeEulerPayload, AvrFusionAttitudeHeadingPayload, AvrFusionHilGpsPayload, AvrVioResyncPayload, AvrVioPositionNedPayload, AvrVioVelocityNedPayload, AvrVioOrientationEulPayload, AvrVioOrientationQuatPayload, AvrVioHeadingPayload, AvrVioConfidencePayload, AvrApriltagsSelectedPayload, AvrApriltagsRawPayload, AvrApriltagsVisiblePayload, AvrApriltagsFpsPayload, AvrThermalReadingPayload, AvrStatusLightPcmPayload, AvrStatusLightVioPayload, AvrStatusLightApriltagsPayload, AvrStatusLightFcmPayload, AvrStatusLightThermalPayload]) -> None:
        """
