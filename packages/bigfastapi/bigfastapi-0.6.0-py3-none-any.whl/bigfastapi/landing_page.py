...
async def createlandingpage(request: landing_page_schemas.landingPageCreate = Depends(landing_page_schemas.landingPageCreate.as_form), db: Session = Depends(get_db), current_user=Depends(is_authenticated),
    ...
    if current_user.is_superuser:
        ...
        if section_three_image:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST,
                                detail="Please upload section_Three_image")
        ...
        if section_four_image:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST,
                                detail="Please upload Section_Four_image")
        ...
        if body_h3_logo_one:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST,
                                detail="Please upload Body_H3_logo_One")
        ...
        if body_h3_logo_two:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST,
                                detail="Please upload body_h3_logo_two")
        ...
        if body_h3_logo_three:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST,
                                detail="Please upload Body_H3_logo_Three")
        ...
        if body_h3_logo_four:
            ...
            raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST,
                                detail="Please upload Body_H3_logo_Four")
    ...
    if current_user.is_superuser:
        ...
        if isFileExist(company_logo) != True:
            ...
            if deleteFile(company_logo1):
                ...
                update_landing_page_data.company_logo = "/" + \
                    update_landing_page_data.bucket_name + "/" + company_logo
        ...
        if isFileExist(section_one_image_link) != True:
            ...
            if deleteFile(section_one_image_link1):
                ...
                update_landing_page_data.section_one_image_link = "/" + \
                    update_landing_page_data.bucket_name + "/" + section_one_image_link
        ...
        if isFileExist(body_h3_logo_one) != True:
            ...
            if deleteFile(body_h3_logo_one1):
                ...
                update_landing_page_data.body_h3_logo_one = "/" + \
                    update_landing_page_data.bucket_name + "/" + body_h3_logo_one
        ...
        if isFileExist(body_h3_logo_two) != True:
            ...
            if deleteFile(body_h3_logo_two1):
                ...
                update_landing_page_data.body_h3_logo_two = "/" + \
                    update_landing_page_data.bucket_name + "/" + body_h3_logo_two
        ...
        if isFileExist(body_h3_logo_three) != True:
            ...
            if deleteFile(body_h3_logo_three1):
                ...
                update_landing_page_data.Body_H3_logo_Three = "/" + \
        ...
        if isFileExist(body_h3_logo_four) != True:
            ...
            if deleteFile(body_h3_logo_four1):
                ...
                update_landing_page_data.Body_H3_logo_Four = "/" + \
                    update_landing_page_data.bucket_name + "/" + body_h3_logo_four
        ...
        if isFileExist(section_three_image) != True:
            ...
            if deleteFile(section_three_image1):
                ...
                update_landing_page_data.section_Three_image = "/" + \
                    update_landing_page_data.bucket_name + "/" + section_three_image
        ...
        if isFileExist(section_four_image) != True:
            ...
            if deleteFile(section_four_image1):
                ...
                update_landing_page_data.section_Four_image = "/" + \
                    update_landing_page_data.bucket_name + "/" + section_four_image
