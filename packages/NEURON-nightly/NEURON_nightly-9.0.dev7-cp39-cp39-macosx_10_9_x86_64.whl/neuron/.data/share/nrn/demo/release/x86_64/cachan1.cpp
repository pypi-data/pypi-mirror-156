...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cachan1 /Users/runner/work/1/s/build/cmake_install/share/nrn/demo/release/cachan1.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 
#define k _nrnunit_k[_nrnunit_use_legacy_]
static double _nrnunit_k[2] = {1.38064900000000009e-23, 1.38065e-23};
 
#define e _nrnunit_e[_nrnunit_use_legacy_]
static double _nrnunit_e[2] = {1.60217663399999989e-19, 1.60219e-19};
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/runner/work/1/s/build/cmake_install/share/nrn/demo/release/cachan1.mod";
