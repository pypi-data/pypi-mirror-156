...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cachan /Users/runner/work/1/s/build/cmake_install/share/nrn/demo/release/camchan.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 
#define FARADAY _nrnunit_FARADAY[_nrnunit_use_legacy_]
static double _nrnunit_FARADAY[2] = {96485.3321233100141, 96485.3};
 
#define R _nrnunit_R[_nrnunit_use_legacy_]
static double _nrnunit_R[2] = {8.3144626181532395, 8.3145};
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/runner/work/1/s/build/cmake_install/share/nrn/demo/release/camchan.mod";
