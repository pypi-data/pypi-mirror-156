...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IntervalFire /Users/runner/work/1/s/build/cmake_install/share/nrn/demo/release/invlfire.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  int _i; double _save;{
 {
   ...
   m = 0.0 ;
   t0 = t ;
   artcell_net_send ( _tqitem, nullptr, static_cast<Point_process*>(_ppvar[1]._pvoid), t +  firetime ( _threadargs_ ) , 1.0 ) ;
   }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/runner/work/1/s/build/cmake_install/share/nrn/demo/release/invlfire.mod";
