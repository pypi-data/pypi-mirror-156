...
class api(object):
    ...
    def available_hosts(self, hosts=[]):
        ''' 可用服务器 '''
    ...
    def get_history_by_item_key(self, hosts=[], time_from=0, time_till=0, item_key='', data_type=3):
        '''
    ...
    def get_history_by_interface(self, hosts=[], interfaces=[], time_from=0, time_till=0, direction=''):
        ''' 获取网卡历史数据 '''
