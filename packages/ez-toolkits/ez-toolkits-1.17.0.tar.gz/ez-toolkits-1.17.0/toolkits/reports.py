...
class reports(object):
    ...
    def system_memory_utilization(self, hosts, time_from, time_till):
        ...
        _history = utils.retry(30, self._zbx.get_history_by_item_key, hosts, time_from, time_till, 'vm.memory.utilization', 0)
        if _history != None:
            _image = {
    ...
    def system_root_partition_utilization(self, hosts, time_from, time_till):
        ...
        _history = utils.retry(30, self._zbx.get_history_by_item_key, hosts, time_from, time_till, 'vfs.fs.size[/,pused]', 0)
        if _history != None:
    ...
    def system_interface_received(self, hosts, interfaces, time_from, time_till):
        ...
        _net_if_in = self._zbx.get_history_by_interface(hosts, interfaces, time_from, time_till, 'in')
    ...
    def system_interface_sent(self, hosts, interfaces, time_from, time_till):
        ...
        _net_if_out = self._zbx.get_history_by_interface(hosts, interfaces, time_from, time_till, 'out')
