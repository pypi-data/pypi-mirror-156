...
# Package meta-data.
NAME = "veld"
DESCRIPTION = "A suite of tools for command line analytics"
AUTHOR = "Gertjan van den Burg"
EMAIL = "gertjanvandenburg@gmail.com"
LICENSE = "MIT"
LICENSE_TROVE = "License :: OSI Approved :: MIT License"
REQUIRES_PYTHON = ">=3.6.0"
URL = "https://github.com/GjjvdBurg/veld"
VERSION = None

# What packages are required for this module to be executed?
REQUIRED = ["matplotlib>=3.3.4", "wilderness>=0.1.7"]
...
setup(
    ...
    entry_points={"console_scripts": ["veld=veld.__main__:main"]},
