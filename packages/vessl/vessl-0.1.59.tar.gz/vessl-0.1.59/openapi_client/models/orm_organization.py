...
class OrmOrganization(object):
    ...
    openapi_types = {
        ...
        'is_public': 'bool',
        'name': 'str',
        'on_demand_discount_rate': 'float',
        'on_premise_discount_rate': 'float',
        ...
        'stripe_subscription_items': 'dict(str, object)',
        'updated_dt': 'datetime',
        'user_discount_rate': 'float'
    }
    ...
    attribute_map = {
        ...
        'is_public': 'is_public',
        'name': 'name',
        'on_demand_discount_rate': 'on_demand_discount_rate',
        'on_premise_discount_rate': 'on_premise_discount_rate',
        ...
        'stripe_subscription_items': 'stripe_subscription_items',
        'updated_dt': 'updated_dt',
        'user_discount_rate': 'user_discount_rate'
    }

    def __init__(self, aws_external_id=None, created_dt=None, credit_balance=None, description=None, display_name=None, edges=None, fixed_cost=None, id=None, immutable_slug=None, is_public=None, name=None, on_demand_discount_rate=None, on_premise_discount_rate=None, organization_default_storage=None, organization_default_volume=None, organization_pricing_plan=None, organization_primary_owner=None, owner_id=None, stripe_customer_id=None, stripe_subscription_id=None, stripe_subscription_items=None, updated_dt=None, user_discount_rate=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._name = None
        self._on_demand_discount_rate = None
        self._on_premise_discount_rate = None
        ...
        self._stripe_subscription_items = None
        self._updated_dt = None
        self._user_discount_rate = None
        ...
        if name is not None:
            self.name = name
        if on_demand_discount_rate is not None:
            self.on_demand_discount_rate = on_demand_discount_rate
        if on_premise_discount_rate is not None:
            self.on_premise_discount_rate = on_premise_discount_rate
        ...
        if organization_pricing_plan is not None:
        ...
        if stripe_subscription_items is not None:
            self.stripe_subscription_items = stripe_subscription_items
        if updated_dt is not None:
            self.updated_dt = updated_dt
        if user_discount_rate is not None:
    ...
    @property
    def fixed_cost(self):
        """Gets the fixed_cost of this OrmOrganization.  # noqa: E501


        :return: The fixed_cost of this OrmOrganization.  # noqa: E501
        :rtype: float
        """
    ...
    def fixed_cost(self, fixed_cost):
        """Sets the fixed_cost of this OrmOrganization.


        :param fixed_cost: The fixed_cost of this OrmOrganization.  # noqa: E501
    ...
    @property
    def on_demand_discount_rate(self):
        """Gets the on_demand_discount_rate of this OrmOrganization.  # noqa: E501


        :return: The on_demand_discount_rate of this OrmOrganization.  # noqa: E501
        :rtype: float
        """
        return self._on_demand_discount_rate

    @on_demand_discount_rate.setter
    def on_demand_discount_rate(self, on_demand_discount_rate):
        """Sets the on_demand_discount_rate of this OrmOrganization.


        :param on_demand_discount_rate: The on_demand_discount_rate of this OrmOrganization.  # noqa: E501
        :type on_demand_discount_rate: float
        """

        self._on_demand_discount_rate = on_demand_discount_rate

    @property
    def on_premise_discount_rate(self):
        """Gets the on_premise_discount_rate of this OrmOrganization.  # noqa: E501


        :return: The on_premise_discount_rate of this OrmOrganization.  # noqa: E501
        :rtype: float
        """
        return self._on_premise_discount_rate

    @on_premise_discount_rate.setter
    def on_premise_discount_rate(self, on_premise_discount_rate):
        """Sets the on_premise_discount_rate of this OrmOrganization.


        :param on_premise_discount_rate: The on_premise_discount_rate of this OrmOrganization.  # noqa: E501
        :type on_premise_discount_rate: float
        """

        self._on_premise_discount_rate = on_premise_discount_rate
    ...
    @property
    def owner_id(self):
        """Gets the owner_id of this OrmOrganization.  # noqa: E501


        :return: The owner_id of this OrmOrganization.  # noqa: E501
        :rtype: int
        """
    ...
    def owner_id(self, owner_id):
        """Sets the owner_id of this OrmOrganization.


        :param owner_id: The owner_id of this OrmOrganization.  # noqa: E501
        :type owner_id: int
        """
    ...
    @property
    def stripe_subscription_items(self):
        """Gets the stripe_subscription_items of this OrmOrganization.  # noqa: E501


        :return: The stripe_subscription_items of this OrmOrganization.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self._stripe_subscription_items

    @stripe_subscription_items.setter
    def stripe_subscription_items(self, stripe_subscription_items):
        """Sets the stripe_subscription_items of this OrmOrganization.


        :param stripe_subscription_items: The stripe_subscription_items of this OrmOrganization.  # noqa: E501
        :type stripe_subscription_items: dict(str, object)
        """

        self._stripe_subscription_items = stripe_subscription_items
    ...
    @property
    def user_discount_rate(self):
        """Gets the user_discount_rate of this OrmOrganization.  # noqa: E501


        :return: The user_discount_rate of this OrmOrganization.  # noqa: E501
        :rtype: float
        """
        return self._user_discount_rate

    @user_discount_rate.setter
    def user_discount_rate(self, user_discount_rate):
        """Sets the user_discount_rate of this OrmOrganization.


        :param user_discount_rate: The user_discount_rate of this OrmOrganization.  # noqa: E501
        :type user_discount_rate: float
        """

        self._user_discount_rate = user_discount_rate
