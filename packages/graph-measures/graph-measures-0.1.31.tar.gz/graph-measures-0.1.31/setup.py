...
def makefile_command(gpu: bool):
    if gpu:
        return ["conda run -n boost python make -f Makefile-conda"]
    return ["conda run -n boost python make -f Makefile-conda", "conda run -n boost python make -f Makefile-gpu"]
