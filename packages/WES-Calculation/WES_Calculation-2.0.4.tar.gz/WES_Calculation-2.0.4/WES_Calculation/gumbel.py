...
LastEditTime: 2022-06-24 15:09:44
LastEditors: BDFD
Description: 
...
def gumbel(pq, unitt, unitx, i1, i2, i3, meanx, sdx, n, dataolist):
    ...
    if n<nmin:
        ...
        data4 += (('位置系数',str(round(mode1,3)),str(round(mode2,3))),)
        data4 += (('尺度系数',str(round(scale1,3)),str(round(scale2,3))),)
        # print(' ') 
