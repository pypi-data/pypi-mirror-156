...
def get_app_create_msg(shop, name, api_client):
    ...
    install_url_style = click.style(
        f"https://partners.funpinpin.top/partners/apps/appTesting/{api_client['id']}?client_id={api_client['client_id']}",
        underline=True
    )
    dashboard_url_style = click.style(
        f"https://partners.funpinpin.com/partners/apps/info/{api_client['id']}",
        underline=True
    )
