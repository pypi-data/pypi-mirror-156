...
class TestNotifications(unittest.TestCase):
    ...
    def test_notification_alvie(self):
        ...
        data = NotificationAlvieModel(
            ...
            tag="Alert",
            id="12123",
            tokens=['elD8MVzqURSHJFoFxV3hXP:APA91bHP74GbZWDq_CkWdwGGMRAhZrbb0zjEqaDKDh7Cuyq6OP1di5TcL9Ul7vi1mvkk7x7Nvd4lPGHsBqmLWw6ytMjvbrwYAtwTd6HPECPE5er9WqS3smcHu6psBhV7MEy5bCwRA-Pa']
        )
        d = push_notification_to_alvie(data, ul.G_CLOUD_PROJECT)
