...
def TPLSinputchecker(datainput, name, dattype = None, maxval = None, minval = None, variation = 0, integercheck = 0): 
    ...
    assert (inputtype==int or inputtype==float or inputtype==np.ndarray), name + " should be numeric" # numeric check
    ...
    if dattype is not None:
        ...
        elif dattype == 'colvec': # all uses of vectors in TPLS will be forced into a column vector
