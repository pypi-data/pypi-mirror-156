...
def distances_to_equipments(origin,
    ...
    cols = [i for i in od_establ_transit.columns if i not in [id_origin, id_destination, 'hex_o', 'hex_d', 'origin', 'destination', 'origin_norm', 'destination_norm']]
