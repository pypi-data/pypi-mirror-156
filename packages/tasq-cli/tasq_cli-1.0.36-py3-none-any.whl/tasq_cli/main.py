...
from tasq_cli import jobs, export_files
...
def main():
    ...
    get_export_link = subparsers.add_parser('get-export-link',
                                                       help='get a link to an export file, which is '
                                                            'not necessarily populated yet')
    get_export_link.add_argument('export_file_id', help='the export file id')

    get_export_file = subparsers.add_parser('get-export-file',
                                                help='get export file details')
