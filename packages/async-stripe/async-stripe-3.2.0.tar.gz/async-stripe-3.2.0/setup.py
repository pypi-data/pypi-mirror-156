...
['async_stripe',
 ...
 'async_stripe.api_resources.apps',
 'async_stripe.api_resources.checkout',
 'async_stripe.api_resources.financial_connections',
 'async_stripe.api_resources.identity',
 'async_stripe.api_resources.issuing',
 'async_stripe.api_resources.terminal',
 'async_stripe.api_resources.test_helpers',
 'async_stripe.api_resources.treasury']

package_data = \
{'': ['*']}

install_requires = \
['stripe==3.2.0', 'tornado>=5.1']
