...
def do_setup():
    ...
    setup(
        version=version,
        extras_require={
            'amazon': ['apache-airflow-providers-amazon', 'apache-airflow-providers-amazon>=2.6.0'],
            ...
            'facebook': ['apache-airflow-providers-facebook', 'apache-airflow-providers-facebook>=2.2.0'],
            'microsoft.azure': ['apache-airflow-providers-microsoft-azure'],
            'microsoft.mssql': ['apache-airflow-providers-microsoft-mssql'],
            'mysql': ['apache-airflow-providers-mysql'],
            'oracle': ['apache-airflow-providers-oracle', 'apache-airflow-providers-oracle>=3.1.0'],
