...
class EmployerTrainingModel(CommonModel):
    ...
    def makeDocx(self, output_docx):
        template_path = os.path.abspath(
            os.path.join(DATADIR, "word/lmia_employer_training.docx")
        )
        wm = WordMaker(template_path, self, output_docx)
        wm.make()


class M5593EmployerTrainingModel(EmployerTrainingModel):
    pass


class M5626EmployerTrainingModel(EmployerTrainingModel):
    pass


class M5627EmployerTrainingModel(EmployerTrainingModel):
    pass
