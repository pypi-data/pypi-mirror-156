...
def obj_export(filepath: str = "",
               ...
               forward_axis: typing.Union[int, str] = 'NEGATIVE_Z',
               up_axis: typing.Union[int, str] = 'Y',
...
def operator_cheat_sheet():
    ''' List all the operators in a text-block, useful for scripting :file: startup/bl_operators/wm.py\:2058 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2058> _
...
def stl_import(
        ...
        forward_axis: typing.Union[int, str] = 'Y',
        up_axis: typing.Union[int, str] = 'Z',
...
def toolbar():
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __. :file: startup/bl_operators/wm.py\:2244 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2244> _
...
def toolbar_fallback_pie():
    ''' Undocumented, consider contributing <https://developer.blender.org/T51061> __. :file: startup/bl_operators/wm.py\:2268 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2268> _
...
def toolbar_prompt():
    ''' Leader key like functionality for accessing tools :file: startup/bl_operators/wm.py\:2368 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/wm.py$2368> _
...
def usd_import(
        ...
        mtl_name_collision_mode: typing.Union[int, str] = 'MAKE_UNIQUE'):
    ...
    :type mtl_name_collision_mode: typing.Union[int, str]
    '''
