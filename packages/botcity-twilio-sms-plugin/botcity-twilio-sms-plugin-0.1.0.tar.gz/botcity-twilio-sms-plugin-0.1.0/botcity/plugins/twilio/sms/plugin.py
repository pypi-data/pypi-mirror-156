...
class BotTwilioSMSPlugin:
    ...
    def __init__(self, account_sid: str, auth_token: str, phone_number: str) -> None:
        ...
        Args:
            ...
            phone_number (str): A number that is active on your Twilio account to be used for sending messages.
    ...
    def send_sms(self, to_number: str, msg_content: str, media_urls: List[str] = None) -> None:
        """
        Sends an SMS message to the specified phone number.
        The to_number must be informed in this format: [+][country code][phone number including area code]

        Args:
            to_number (str): The phone number that will receive the message.
            msg_content (str): The message body content.
            media_urls (List[str]): The URLs of media contents that will be sent in the message.
        """
    ...
    def get_received_messages(self, from_number: str = None, before_date: datetime = None, after_date: datetime = None,
                              on_date: datetime = None, limit: int = None) -> List[MessageInstance]:
        """
    ...
    def reply_sms(self, msg: MessageInstance, text_content: str, media_urls: List[str] = None) -> None:
        """
        ...
        Args:
            ...
            media_urls (List[str]): The URLs of media contents that will be sent in the message.
        """
        self.send_sms(to_number=msg.from_, msg_content=text_content, media_urls=media_urls)

    def wait_for_new_sms(self, from_number: str = None, timeout: int = 60) -> MessageInstance:
        """
    ...
    def download_media_file(self, msg: MessageInstance, download_folder_path: str = None) -> None:
        ...
        Args:
            ...
            download_folder_path (str, optional): The folder where the files will be saved.
            ...
            for media in msg.media.list():
                ...
                if media_type:
                    ...
                    try:
                        ...
                        Please verify that the message contains a valid media content.''') from ex
