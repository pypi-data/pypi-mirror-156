...
from ..utils import from_api, parse_time, raw_prediction_response_to_dataframe
...
class Predictions(APIObject):
    ...
    def _build_list_path(
        cls, project_id, model_id=None, dataset_id=None
    ...
    @classmethod
    def _from_server_object(cls, project_id, item):  # pylint: disable=missing-function-docstring
        pred = cls(
            project_id,
