    ...
    data_source_trafaret = t.Dict(
        {
            ...
            t.Key("schema", optional=True): String(allow_blank=True) | t.Null,
            t.Key("catalog", optional=True): String(allow_blank=True) | t.Null,
            t.Key("data_source_id", optional=True): String | t.Null,
        }
    ).ignore_extra("*")
