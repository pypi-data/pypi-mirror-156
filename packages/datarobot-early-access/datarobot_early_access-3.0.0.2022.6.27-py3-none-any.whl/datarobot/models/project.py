...
from .job import Job
from .model import BiasMitigatedModelInfo, BiasMitigationFeatureInfo, CombinedModel
...
class Project(APIObject):
    ...
    def __init__(
        ...
        if isinstance(id, dict):
            ...
            self.__init__(**id)  # pylint: disable=non-parent-init-called
        else:
    ...
    def __repr__(self):
        return "{}({})".format(self.__class__.__name__, self.project_name or self.id)
    ...
    def get_datetime_models(self):
        ...
        models : list of DatetimeModel
            the datetime models
        """
        from . import DatetimeModel  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def get_prime_models(self):
        ...
        """
        from . import PrimeModel  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def create_type_transform_feature(
        ...
        """
        from .feature import Feature  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def get_blenders(self):
        ...
        """
        from . import BlenderModel  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def get_frozen_models(self):
        ...
        """
        from . import FrozenModel  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def get_rating_table_models(self):
        ...
        """
        from . import RatingTableModel  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def get_rating_tables(self):
        ...
        """
        from . import RatingTable  # pylint: disable=import-outside-toplevel,cyclic-import
    ...
    def create_interaction_feature(self, name, features, separator, max_wait=DEFAULT_MAX_WAIT):
        ...
        AsyncTimeoutError
            If the resource did not resolve in time
        """
        from .feature import (  # pylint: disable=import-outside-toplevel,cyclic-import
            InteractionFeature,
        )
    ...
    def get_bias_mitigated_models(self, parent_model_id=None, offset=0, limit=100):
        ...
        models : list of dict
        """
        url = "{}{}/biasMitigatedModels/".format(self._path, self.id)
    ...
    def apply_bias_mitigation(
        self,
        bias_mitigation_parent_leaderboard_id,
