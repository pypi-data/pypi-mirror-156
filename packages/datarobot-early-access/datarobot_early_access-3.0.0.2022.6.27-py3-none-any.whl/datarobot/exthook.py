...
class ExtensionImporter(object):
    ...
    def load_module(self, fullname):  # pylint: disable=missing-function-docstring
    ...
    def is_important_frame(self, important_module, tb):
        ...
        return (
            test_string + ".py" in filename or test_string + os.path.sep + "__init__.py" in filename
        )
