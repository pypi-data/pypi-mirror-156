...
def dataframe_to_buffer(df: pd.DataFrame) -> six.StringIO:
...
def list_of_records_to_buffer(list_of_records: List[Dict[str, Any]]) -> six.StringIO:
    """
...
def assert_modelable(sourcedata: Any) -> None:
    """
