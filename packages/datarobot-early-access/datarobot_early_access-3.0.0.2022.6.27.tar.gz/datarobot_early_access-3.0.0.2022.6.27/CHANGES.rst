...
- Dropped support for Python 3.6 and earlier. 
  Moving forwards, all versions of the Python SDK will support Python 3.7 and newer.
...
- Added new property `status` to :class:`datarobot.Deployment` that represents model deployment status.

- Added new :meth:`Deployment.activate <datarobot.Deployment.activate>`
  and :meth:`Deployment.deactivate <datarobot.Deployment.deactivate>`
