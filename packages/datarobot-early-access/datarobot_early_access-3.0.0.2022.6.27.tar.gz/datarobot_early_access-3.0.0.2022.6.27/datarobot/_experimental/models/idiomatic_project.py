...
class IdiomaticProject(Project):
    ...
    def fit(
        ...
        feature_list : str or list of str, optional
    ...
    def _resolve_fit_featurelist_id(
        ...
        elif isinstance(feature_list, six.string_types):
            feature_list = six.ensure_text(feature_list)
            # First check for IDs
            featurelist_id = next(
