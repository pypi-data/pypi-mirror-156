...
def get_class(cv_method, validation_type):  # pylint: disable=missing-function-docstring
...
class PartitioningMethod(object):  # pylint: disable=missing-class-docstring
