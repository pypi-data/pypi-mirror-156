...
class WordCloud(APIObject):
                ...
                t.Dict(
                    {
                        ...
                        t.Key("class", optional=True, default=None): String | t.Null,
                        t.Key("variable", optional=True, default=None): String | t.Null,
                    }
                ).ignore_extra("*")
            )
        }
    ...
    def __repr__(self) -> str:
        return "WordCloud({} ngrams)".format(len(self.ngrams))
