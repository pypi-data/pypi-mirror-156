...
class Model(APIObject):
    ...
    def __init__(
        ...
        if isinstance(id, dict):
            ...
            self.__init__(**data)  # pylint: disable=non-parent-init-called
    ...
    def fetch_resource_data(cls, url, join_endpoint=True):  # pylint: disable=unused-argument
        """
...
class CombinedModel(Model):
    ...
    @classmethod
    def get(cls, project_id, combined_model_id):  # pylint: disable=arguments-renamed
