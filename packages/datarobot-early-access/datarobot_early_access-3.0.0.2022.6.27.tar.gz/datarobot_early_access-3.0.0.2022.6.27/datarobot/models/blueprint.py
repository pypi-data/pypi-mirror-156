...
class BlueprintTaskDocument(APIObject):
                ...
                t.Dict(
                    {
                        ...
                        t.Key("url", optional=True, default=None): String | t.Null,
                    }
                ).ignore_extra("*")
            ),
        }
    ...
    def __repr__(self):
        return "BlueprintTaskDocument({})".format(self.title)
...
class BlueprintChart(APIObject):
    ...
    def __repr__(self):
        return "BlueprintChart({} nodes, {} edges)".format(len(self.nodes), len(self.edges))
...
class ModelBlueprintChart(BlueprintChart):
    ...
    def __repr__(self):
        return "ModelBlueprintChart({} nodes, {} edges)".format(len(self.nodes), len(self.edges))
...
class Blueprint(APIObject):
    ...
    def __repr__(self):
        return "Blueprint({})".format(self.model_type)
