...
class FeatureFitMetadata(FeatureEffectMetadata):
    ...
    def __repr__(self):
        return "FeatureFitMetadata({}/{})".format(self.status, self.sources)
...
class FeatureFitMetadataDatetime(FeatureEffectMetadataDatetime):
    ...
    * ``sources`` : list(string).
    ...
    def __repr__(self):
        return "FeatureFitMetadataDatetime({})".format(self.data)
...
class FeatureFitMetadataDatetimePerBacktest(FeatureEffectMetadataDatetimePerBacktest):
    ...
    def __repr__(self):
        return (
            "FeatureFitMetadataDatetimePerBacktest(backtest_index={},"
...
class FeatureFit(APIObject):
    ...
    _IndividualConditionalExpectation = t.Dict(
        {
            ...
            t.Key("data"): t.List(
                t.List(
                    t.Dict(
                        {t.Key("label"): String | Int, t.Key("dependence"): t.Float}
                    ).ignore_extra("*")
                )
            ),
        }
                ...
                t.Dict(
                    {
                        ...
                        t.Key("is_scalable"): t.Bool | t.Null,
    ...
    def __repr__(self):
        return (
            "{}(project_id={},"
            "model_id={}, source={}, backtest_index={}, feature_fit={}".format(
