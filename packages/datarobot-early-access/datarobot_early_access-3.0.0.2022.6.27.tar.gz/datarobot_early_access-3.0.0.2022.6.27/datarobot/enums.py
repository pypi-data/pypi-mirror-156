...
class SERVICE_STAT_METRIC(object):  # pylint: disable=missing-class-docstring
...
class ACCURACY_METRIC(object):  # pylint: disable=missing-class-docstring
    ACCURACY = "Accuracy"
    AUC = "AUC"
...
class DATETIME_TREND_PLOTS_RESOLUTION(object):  # pylint: disable=missing-class-docstring
...
class BiasMitigationTechnique(object):
