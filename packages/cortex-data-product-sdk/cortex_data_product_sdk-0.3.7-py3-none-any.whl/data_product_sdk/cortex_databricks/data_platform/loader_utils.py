...
def gold_to_kafka(input_table_name, data_pack_name, dataset_name, topic_name, input_db_name=GOLD_DB_NAME, spark=None, write_options: dict = None,
    ...
    stream = df.selectExpr("CAST(feed_name AS STRING) as key", "to_json(struct(*)) AS value") \
