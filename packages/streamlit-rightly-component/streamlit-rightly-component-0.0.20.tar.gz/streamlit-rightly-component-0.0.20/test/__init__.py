...
def render_dagre():
    ...
    with col2:
        dagre_click = rightly_component(component_name='Dag',
            data={"node_tree":{"id":"gmv","label":"gmv","value":100,"children":[{"id":"tb","label":"tb","value":100,"children":[{"id":"190043425","label":"190043425","value":100,"children":[{"id":"tb_price_strategy__190043425","label":"天猫商品定价策略","value":100,"children":[]},{"id":"tb_adv_strategy__190043425","label":"天猫广告策略","value":100,"children":[]},{"id":"pay_amt|item_id|biz_date|channel2:allchn__190043425","label":"成交金额","value":100,"children":[]}]}]}]}},
            default=None
        )
