...
(self['webpackChunkjupyterlab_voice_control'] =
  ...
  \*************************/
      /***/ (
        ...
        /* harmony import */ var _jupyterlab_fileeditor__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! @jupyterlab/fileeditor */ 'webpack/sharing/consume/default/@jupyterlab/fileeditor'
          );
        /* harmony import */ var _jupyterlab_fileeditor__WEBPACK_IMPORTED_MODULE_1___default =
          /*#__PURE__*/ __webpack_require__.n(
            _jupyterlab_fileeditor__WEBPACK_IMPORTED_MODULE_1__
          );
        ...
        function getEditor(widget) {
          if (
            ...
            widget instanceof
            _jupyterlab_fileeditor__WEBPACK_IMPORTED_MODULE_1__.FileEditor
          ) {
            ...
            this.recognition.onerror = event => {
              ...
              switch (event.error) {
                ...
                case 'not-allowed':
                  ...
                  _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(
                    title,
                    'Access to microphone was denied or blocked'
                  );
                  break;
                case 'no-speech':
            ...
            if (typeof option !== 'undefined') {
              if (this._currentSuggestions.length > option) {
                this.commandRegistry.execute(
                  this._currentSuggestions[option].id
                );
                this._currentSuggestions = [];
              } else {
                this.communicate(
...
//# sourceMappingURL=lib_index_js.a01f34a3494544a79ee2.js.map
