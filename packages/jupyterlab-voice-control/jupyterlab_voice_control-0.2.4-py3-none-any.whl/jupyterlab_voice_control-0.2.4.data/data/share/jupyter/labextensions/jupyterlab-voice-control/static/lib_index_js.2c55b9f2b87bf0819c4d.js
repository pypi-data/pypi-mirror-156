      ...
      /***/ (
        ...
        function deleteText(options, currentWidget) {
          ...
          if (editor && editor.hasFocus && editor.host.contains(focused)) {
            ...
            editor.model.value.remove(lastSpace === -1 ? 0 : lastSpace, offset);
            ...
            return react__WEBPACK_IMPORTED_MODULE_0__.createElement(
              ...
              (sender, status) => {
                ...
                const shortText = status.executed
                  ? this.trans.__('🙂 executed', status.lastResult)
...
//# sourceMappingURL=lib_index_js.2c55b9f2b87bf0819c4d.js.map
