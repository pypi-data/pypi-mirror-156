"use strict";
(self["webpackChunkjupyterlab_voice_control"] = self["webpackChunkjupyterlab_voice_control"] || []).push([["lib_index_js"],{
...
function deleteText(options, currentWidget) {
    ...
    if (typeof focused.value !== 'undefined') {
        ...
        focused.value = value.substring(0, end);
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VoiceControlStatusIndicator": () => (/* binding */ VoiceControlStatusIndicator)
/* harmony export */ });
...
class VoiceControlStatusIndicator extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.UseSignal, { signal: this.signal }, (sender, status) => {
            if (!status) {
                status = {
                    enabled: false
                };
            ...
            const text = status.executed
                ? this.trans.__('Executed %1 based on %2 (%3%)', status.executed.label, status.lastResult, confidence)
                : this.trans.__('Recognised %1 (%2%) but do not understand.', status.lastResult, confidence);
            const shortText = status.executed
                ? this.trans.__('🙂 executed %1', status.lastResult)
                : this.trans.__('🤔 %1 (%2%)', status.lastResult, confidence);
            const controller = this.controller;
            return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_statusbar__WEBPACK_IMPORTED_MODULE_2__.GroupItem, { spacing: 0, title: text, onClick: () => {
                    controller.isEnabled
                        ? controller.disable()
                        : controller.enable();
                } },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(icon.react, { top: '2px', kind: 'statusBar' }),
                status.error || status.lastResult ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_statusbar__WEBPACK_IMPORTED_MODULE_2__.TextItem, { className: 'status-message', source: status.error ? status.error : shortText })) : (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null))));
        }));
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VoiceController": () => (/* binding */ VoiceController)
/* harmony export */ });
/* harmony import */ var fastest_levenshtein__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fastest-levenshtein */ "webpack/sharing/consume/default/fastest-levenshtein/fastest-levenshtein");
...
class VoiceController {
    constructor(commandRegistry, trans, palette) {
        ...
        this.statusChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_1__.Signal(this);
        const SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition;
        if (!SpeechRecognition) {
            (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(trans.__('Speech recognition not supported'), trans.__('Your browser does not support speech recognition.'));
        ...
        this.recognition.onerror = event => {
            ...
            switch (event.error) {
                case 'audio-capture':
                    (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(title, this.trans.__('Microphone not detected'));
                    break;
                case 'not-allowed':
                    (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(title, this.trans.__('Access to microphone was denied or blocked'));
                    break;
                case 'no-speech':
    ...
    matchPhrase(phrase) {
        ...
        if (command) {
            ...
            for (const [candidateLabel, command] of this.jupyterCommands.entries()) {
                const matchScore = Math.min((0,fastest_levenshtein__WEBPACK_IMPORTED_MODULE_0__.distance)(candidateLabel, phrase), (0,fastest_levenshtein__WEBPACK_IMPORTED_MODULE_0__.distance)(normalise(command.caption), phrase));
                if (matchScore < best) {
                    best = matchScore;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "recognitionDisabledIcon": () => (/* binding */ recognitionDisabledIcon),
/* harmony export */   "recognitionEnabledIcon": () => (/* binding */ recognitionEnabledIcon)
/* harmony export */ });
/* harmony import */ var _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @jupyterlab/ui-components */ "webpack/sharing/consume/default/@jupyterlab/ui-components");
/* harmony import */ var _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_icons_microphone_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../style/icons/microphone.svg */ "./style/icons/microphone.svg");
/* harmony import */ var _style_icons_microphone_off_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../style/icons/microphone-off.svg */ "./style/icons/microphone-off.svg");



const recognitionEnabledIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
    name: 'voice:enabled',
    svgstr: _style_icons_microphone_svg__WEBPACK_IMPORTED_MODULE_1__["default"]
});
const recognitionDisabledIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
    name: 'voice:disabled',
    svgstr: _style_icons_microphone_off_svg__WEBPACK_IMPORTED_MODULE_2__["default"]
});
...
/* harmony import */ var _components_status__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/status */ "./lib/components/status.js");
/* harmony import */ var _controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controller */ "./lib/controller.js");
...
const plugin = {
    ...
    optional: [_jupyterlab_settingregistry__WEBPACK_IMPORTED_MODULE_4__.ISettingRegistry, _jupyterlab_statusbar__WEBPACK_IMPORTED_MODULE_2__.IStatusBar, _jupyterlab_translation__WEBPACK_IMPORTED_MODULE_3__.ITranslator],
    activate: (app, palette, settingRegistry, statusBar, translator) => {
        ...
        const controller = new _controller__WEBPACK_IMPORTED_MODULE_5__.VoiceController(app.commands, trans, palette);
        let canonical;
        ...
        if (settingRegistry) {
            ...
            settingRegistry.transform(plugin.id, {
                fetch: plugin => {
                    ...
                    if (!canonical) {
                        canonical = _lumino_coreutils__WEBPACK_IMPORTED_MODULE_0__.JSONExt.deepCopy(plugin.schema);
                        populate(canonical);
                    }
                    return {
                        data: plugin.data,
        ...
        if (statusBar) {
            statusBar.registerStatusItem(PLUGIN_ID, {
                item: new _components_status__WEBPACK_IMPORTED_MODULE_6__.VoiceControlStatusIndicator(controller.statusChanged, trans, controller),
                rank: 900
            });
        }
        ...
        app.commands.addCommand('vc:scroll-by', {
            ...
            execute: args => (0,_commands__WEBPACK_IMPORTED_MODULE_7__.scrollBy)(args)
        });
        app.commands.addCommand('vc:type-text', {
            label: trans.__('Type Text Into Focused Element'),
            execute: args => (0,_commands__WEBPACK_IMPORTED_MODULE_7__.typeText)(args, app.shell.currentWidget)
        });
        app.commands.addCommand('vc:delete-text', {
            label: trans.__('Delete Text From Focused Element'),
            execute: args => (0,_commands__WEBPACK_IMPORTED_MODULE_7__.deleteText)(args, app.shell.currentWidget)
        });
        ...
        app.commands.addCommand('vc:move-cursor', {
            ...
            execute: args => (0,_commands__WEBPACK_IMPORTED_MODULE_7__.moveCursor)(args)
        });
    }
};
...
//# sourceMappingURL=lib_index_js.f806464c9985540079ba.js.map