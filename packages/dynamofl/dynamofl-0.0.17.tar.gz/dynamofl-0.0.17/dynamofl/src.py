...
class _Datasource(_Base):
    ...
    def add_trainer(self, key, train_callback, test_callback, default_hyper_params={} , description=None, model_path=None):
        params = {'key': key , "defaultHyperParams": default_hyper_params}
...
class DynamoFL(_Base):
    ...
    def train_and_test_callback(self, datasource_key, project_info):
        ...
        if not yes_submission:
            ...
            train(datasource_key, federated_model_path, new_model_path, project_info, hyper_param_values)
