...
class HOBO(AbstractReader):
    ...
    def __init__(self, properties: "Optional[HOBOProperties]"=None):
        ...
        properties : HOBOProperties, optional
            A :py:class:`teaspoon.dataloggers.HOBO.HOBOProperties` object that provides information about how the csv export was configured. If not provided, the software will attempt to figure out the configuration properties, by default None
        """
        super().__init__()
        self.tz = None
...
class HOBOProperties:
    ...
    def __init__(self, separator=",",
                 ...
                 negative_number_format=1,
                 include_plot_details=False):
        """ An object used to describe the CSV export configuration from HOBOWare. 
    ...
    @staticmethod
    def evaluate_negative_number_format(negative_open:str, negative_terminator:str) -> int:
        """
