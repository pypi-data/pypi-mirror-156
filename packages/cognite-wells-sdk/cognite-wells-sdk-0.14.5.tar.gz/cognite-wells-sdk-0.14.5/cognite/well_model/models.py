...
class HoleSectionGroupIngestion(WellsBaseModel):
    ...
    source_name: str = Field(..., alias="sourceName", description="Name of the source for ingested hole sections.")
    wellbore_asset_external_id: str = Field(
        ...,
        alias="wellboreAssetExternalId",
        description="An external id for a source specific wellbore asset this hole section group is associated with. Source for the wellbore and for the hole section group must be the same.",
    )
    measured_depth_unit: DistanceUnitEnum = Field(..., alias="measuredDepthUnit")
    ...
    external_id: str = Field(
        ...,
        alias="externalId",
        description="A project unique identifier for the hole section group. This id will be used to reference this hole section group.",
    )
    is_definitive: Optional[bool] = Field(
        False,
        alias="isDefinitive",
        description="If true, this hole section group will become a new definite hole section group for the matched wellbore.",
    )
...
class HoleSectionGroup(WellsBaseModel):
    ...
    source_name: str = Field(..., alias="sourceName", description="Name of the source for holes section group.")
    wellbore_asset_external_id: str = Field(
        ..., alias="wellboreAssetExternalId", description="Id of the related source specific wellbore ingestion."
    )
    measured_depth_unit: DistanceUnitEnum = Field(..., alias="measuredDepthUnit")
    size_unit: DistanceUnitEnum = Field(..., alias="sizeUnit")
    external_id: str = Field(
        ...,
        alias="externalId",
        description="A project unique identifier for the hole section group. This id is used to reference this hole section group.",
    )
    is_definitive: Optional[bool] = Field(
        None,
        alias="isDefinitive",
        description="Describes if the hole section group is definite. A definite hole section group is a group that contains information about the actual hole section for a given wellbore.",
    )
