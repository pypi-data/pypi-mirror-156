...
import numpy as np
import os
test_original = cv2.imread("dms_app/sample.jpeg")

for file in [file for file in os.listdir("dms_app/fingerprint_img")]:
	fingerprint_database_image = cv2.imread("dms_app/fingerprint_img/" + file)
