...
from .dates import set_next_vigency, calculate_payment_date, get_periodo, localize, DIAS_ANTICIPO_DE_PAGO, today_argentina
...
def get_client_price(client: dict, plan_price: int, corpo_discount: float, sum_access=True, access_count_limit: int = 9999) -> dict:
...
def create_payment_data(_client: dict, prices: dict, merchant_id: ObjectId, source: str, insert=True) -> dict:
