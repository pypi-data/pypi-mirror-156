...
@Desc    :   邮件发送帮助工具。钟老师修改于22.06.23，增加了邮件的图片。
"""
...
class EmailUtil:
    ...
    def send(self, recipients: list, sender_nickname: str, subject: str, content: str, cc: list = [], attach_files: list = [], imgs: list = []):
        """
        发送邮件
        ...
        if imgs is not None:
            ...
            for img in imgs:
                ...
                try:
                    ...
                    fp.close()
                    msgImage.add_header('Content-ID', f'<image{imgindex}>')
