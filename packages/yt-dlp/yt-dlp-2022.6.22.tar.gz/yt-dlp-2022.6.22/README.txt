...
-   Based on YOUTUBE-DL 2021.12.17 COMMIT/8A158A9 and YOUTUBE-DLC
...
-   certifi will be used for SSL root certificates, if installed. If you
    want to use only system certificates, use
...
Alternatives
  ...
  File               Description
  ------------------ ------------------
  yt-dlp_x86.exe     Windows (Vista
                     SP2+) standalone
                     x86 (32-bit)
                     binary

  yt-dlp_min.exe     Windows (Win7
                     SP1+) standalone
                     x64 binary built
                     with py2exe (Not
                     recommended)

  yt-dlp_linux       UNIX standalone
                     x64 binary

  yt-dlp_linux.zip   Unpackaged Unix
                     executable (no
                     auto-update)
