...
from .modules.v2.deployments import deploy, update, delete, status
...
kaiyo.add_command(deploy)
kaiyo.add_command(update)
kaiyo.add_command(status)
kaiyo.add_command(delete)
