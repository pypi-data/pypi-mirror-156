...
class Task(irisml.core.TaskBase):
    ...
    Data will be downloaded to the current directory. Downloading will be skipped if the data is still  in the current directory.
    ...
    def execute(self, inputs):
        ...
        return self.Outputs(train_dataset=train_dataset, val_dataset=val_dataset, num_classes=num_classes)
