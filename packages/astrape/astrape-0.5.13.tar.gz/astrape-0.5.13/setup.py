...
setuptools.setup(
    ...
    version='0.5.13',                                # important for updates
    ...
    install_requires=['pytorch-lightning', 'torch', 'numpy', 'rich', 'sklearn', 'pandas', 'overrides', 'scipy', 'tensorflow', 'torchmetrics', 'matplotlib'],                  # list all packages that your package uses
