...
class Client:
    ...
    def __init__(self, api_key='', api_url='http://113.108.100.57:8005', keep_alive=False, max_retry=5, ):
    ...
    def _init_session(self, api_key):
        ...
        if self.keep_alive:
            ...
            retries = Retry(total=self.max_retry, backoff_factor=1, status_forcelist=[502, 503, 504])
