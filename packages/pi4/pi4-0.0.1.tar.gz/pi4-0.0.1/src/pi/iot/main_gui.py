...
class MainGui(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        btn.grid(row=10, column=0, columnspan=2, sticky=W)
        ...
        bus_prop_btn.grid(row=10, column=2, columnspan=1, sticky=W)
...
- GPIO26 (37) (38) - GPIO20
   GND (39) (40) - GPIO21
    ...
    def get_image(self):
        ...
        resize_image = img.resize((300,200)) # img.resize((self.media.winfo_width() , max(self.media.winfo_height() - 50, 1) ))
