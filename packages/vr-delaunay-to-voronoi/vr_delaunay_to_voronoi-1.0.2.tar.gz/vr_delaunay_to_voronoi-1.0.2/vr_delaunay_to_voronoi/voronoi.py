...
def get_polygon_patch(
    *,
    ...
    polygon_patch: matplotlib.patches.Polygon = \
        matplotlib.patches.Polygon(
            xy=polygon,
...
def get_polygon_patches(
    *,
    polygons: List[Any],
) -> List[matplotlib.patches.Polygon]:
    polygon_patches: List[matplotlib.patches.Polygon] = [
        get_polygon_patch(polygon=polygon)
...
def main():
    ...
    polygons: List[Any] = get_voronoi_polygons(delaunay=delaunay)
    ...
    polygon_patches: List[matplotlib.patch.Polygon] = \
        get_polygon_patches(polygons=polygons)

    for polygon_patch in polygon_patches:
        axes.add_patch(p=polygon_patch)
