...
- API version: v3
- Package version: 0.1.0b10.dev1655956509
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, file=file, artifact=artifact, repository=repository, upload=upload, version=version)
        pprint(api_response)
