...
- API version: v3
- Package version: 0.1.0b10.dev1656129030
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, upload=upload, file=file, artifact=artifact, repository=repository, version=version)
        pprint(api_response)
