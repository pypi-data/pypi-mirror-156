...
- API version: v3
- Package version: 0.1.0b10.dev1656216253
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, upload=upload, repository=repository, file=file, artifact=artifact, version=version)
        pprint(api_response)
