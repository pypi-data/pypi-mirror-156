...
class BaseType(object):
    ...
    def __init__(self, name, length: int = None, index: bool = False, unique: bool = False, default: Any = None, null=True):
        self.name = name
        self.length = length
        self.index = index
        self.unique = unique
...
def stmt_to_fieldtype(stmt):
    ...
    return FieldType(field_type=_type, name=_name, index=_index, unique=_unique)
