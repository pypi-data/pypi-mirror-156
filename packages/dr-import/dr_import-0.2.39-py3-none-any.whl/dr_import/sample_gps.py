...
from gps_utilities import MultiviewsGPSInfo
    ...
    for sample in final_samples:
        ...
        if sample["valid_gps"] is None:
            ...
            spec = {
                ...
                "frame": sample["frame"]}
            spec.update(state.attributes)
            spec["Datecode"] = sample["start"].isoformat()
