...
def fetch_pipelines(run_params: dict,
    ...
    auto_pipelines_parameters: dict, optional
...
def prepare_auto_ai_model_to_publish_notebook_normal_scenario(
        ...
        run_params: Dict,
        space_id: str,
        auto_pipelines_parameters = None) -> Union[Tuple[str, Dict[str, dict]]]:
    """
...
def validate_additional_params_for_optimizer(params):
    expected_params = [
        ...
        '_enable_snapml_estimators', 'return_holdout_indices', 'retrain_pipelines_on_holdout_data', 'sample_size_limit',
        'sampling_type', 'n_parallel_data_connections', 'calculate_data_metrics', 'number_of_batch_rows',
