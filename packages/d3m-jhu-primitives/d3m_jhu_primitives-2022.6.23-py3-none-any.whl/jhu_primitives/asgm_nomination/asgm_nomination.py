...
from jhu_primitives.asgm_nomination.ali_sgm import GraphMatch
...
from jhu_primitives import __version__
    ...
    metadata = metadata_module.PrimitiveMetadata({
        ...
        'source': {
            ...
            'uris': [
                ...
                'https://gitlab.com/datadrivendiscovery/contrib/jhu-primitives/-/blob/master/jhu_primitives//asgm_nomination/asgm_nomination.py',
