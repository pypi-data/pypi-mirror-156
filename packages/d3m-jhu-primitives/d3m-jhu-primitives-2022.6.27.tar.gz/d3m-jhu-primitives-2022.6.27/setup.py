...
def read_package_variable(key):
    ...
    module_path = os.path.join('jhu_primitives', '__init__.py')
...
setup(
 #   cmdclass={'install': CustomInstallCommand},
    ...
    packages=[
              'jhu_primitives',
              'jhu_primitives.asgm_nomination',
              'jhu_primitives.asgm_nomination.ali_sgm',
              ...
              # 'jhu_primitives.link_pred_se',
              # 'jhu_primitives.oosase',
              # 'jhu_primitives.ooslse',
              # 'jhu_primitives.oosgmm',
              'jhu_primitives.sgc',
              'jhu_primitives.sgm',
              'jhu_primitives.sgm.ben_sgm',
              'jhu_primitives.sgm.ben_sgm.backends',
              'jhu_primitives.sgvn',
    ...
    entry_points = {
        'd3m.primitives': [
            ...
            'graph_matching.asgm_nomination.JHU=jhu_primitives.asgm_nomination:AsgmNomination',
    ...
    url='https://gitlab.com/datadrivendiscovery/contrib/jhu-primitives',
