...
def load_dataset(id, SD = 1, shift = 200, x_range = None):
...
def open_dataset(path, delimiter = ',', has_y = True, x_range = None):
    '''
    Parameters
    ----------
...
def peek_dataset(path,  delimiter = ',', has_y = True, SD = 1, shift = 200, x_range = None):

    X, y, X_names = open_dataset(path, delimiter=delimiter, has_y = has_y, x_range = x_range)
