# -*- coding: utf-8 -*-
"""
Created on Thu Jun 16 15:51:29 2022
...
class Yahoo:
    ...
    ### e.g. https://finance.yahoo.com/quote/NVDA/key-statistics ###
    def yahoo_statistics_df_p(self):
        ...
        #s = Yahoo.yahoo_statistics_df(self)
        s = self.yahoo_statistics_df()
