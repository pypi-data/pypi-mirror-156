...
@click.group('registries', cls=AliasedGroup, aliases=['reg'], hidden=True)
...
class ServiceRegistryCommandHandler:
    ...
    def __init__(self):
        ...
        self.__manager = ServiceRegistryManager(self.__config_manager.load())
