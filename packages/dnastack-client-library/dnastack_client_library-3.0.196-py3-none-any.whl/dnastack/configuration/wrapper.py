...
from dnastack.configuration.models import Configuration, Context, DEFAULT_CONTEXT
...
class ConfigurationWrapper:
    ...
    def current_context(self) -> Context:
        ...
        if self.__context_name == DEFAULT_CONTEXT and context is None:
            context = self.__config.contexts[self.__context_name] = Context(auto_sync=False)
        ...
        for endpoint in self.endpoints:
            ...
            if endpoint_id:
                ...
                if endpoint.model_version == 2.0:
                    ...
                    raise UnsupportedModelVersionError(f'{type(endpoint).__name__}/{endpoint.model_version}')
