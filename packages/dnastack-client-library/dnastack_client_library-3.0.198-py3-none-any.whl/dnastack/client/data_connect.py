...
class TableListLoader(ResultLoader):
    ...
    def load(self) -> List[TableInfo]:
        ...
        with self.__http_session as session:
            current_url = self.__current_url or self.__initial_url
    ...
    def info(self):
        ...
        with self.__http_session as session:
            ...
            if status_code == 401:
                ...
                raise ServerError(
                    f'Unexpected error: {raw_response_body}',
                    status_code,
                    raw_response_body,
                    url=self.__url
                )
