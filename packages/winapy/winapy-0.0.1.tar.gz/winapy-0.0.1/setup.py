...
setup(
    name='winapy', version='0.0.1',
    ext_modules=[Extension('winapyC', ['LeTrille\\winapi.c'])],
    packages=['winapy'], data_files=['winapy\\const.py'],
    ...
    description='A WinAPI wrapper made in C for Python.',
