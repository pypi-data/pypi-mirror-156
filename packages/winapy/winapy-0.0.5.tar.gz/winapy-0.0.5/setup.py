...
setup(
    name='winapy', version='0.0.5',
    ext_modules=[
        Extension('winapy_gdi', ['LeTrille\\winapy_gdi.c']),
        Extension('winapy_user', ['LeTrille\\winapy_user.c']),
        Extension('winapy_mme', ['LeTrille\\winapy_mme.c'])
    ],
    packages=['winapy', 'winapy_con'],
