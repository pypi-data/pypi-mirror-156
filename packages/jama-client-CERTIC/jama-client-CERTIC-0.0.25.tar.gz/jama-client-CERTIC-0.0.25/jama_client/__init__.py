...
def add_meta_to_resource(self, resource_id: int, meta_id: int, meta_value: str) -> int:
    """
...
def add_meta_to_selection(
    ...
    """
    return self.__call(
        "add_meta_to_selection", [from_collection_id, selection, meta_id, meta_value]
    )
...
def move_collection(self, child_collection_id: int, parent_collection_id: int) -> bool:
    """
    ...
    """
    return self.__call("move_collection", [child_collection_id, parent_collection_id])
...
def remove_meta_value_from_collection(
    ...
    """
    return self.__call(
        "remove_meta_value_from_collection", [collection_id, meta_value_id, recursive]
    )


def remove_meta_value_from_resource(self, resource_id: int, meta_value_id: int) -> bool:
    """
    Remove a meta_value from a resource given their ids.
    """
    return self.__call("remove_meta_value_from_resource", [resource_id, meta_value_id])
...
def remove_resource_from_collection(self, resource_id: int, collection_id: int) -> bool:
    ...
    """
    return self.__call("remove_resource_from_collection", [resource_id, collection_id])
...
def restore_collection(
    ...
    """
    return self.__call("restore_collection", [collection_id, destination_collection_id])


def restore_resource(self, resource_id: int, destination_collection_id: int) -> bool:
    """
...
def set_role(self, project_id: int, role_label: str, permissions: List[int]) -> Dict:
    """
