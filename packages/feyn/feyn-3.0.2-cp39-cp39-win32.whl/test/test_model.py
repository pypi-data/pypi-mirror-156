...
class TestModel(unittest.TestCase):
    ...
    def test_iter(self):
        ...
        self.assertEqual(model[0].fname, "out:linear")
        ...
        self.assertEqual(model[1].fname, "add")
        ...
        self.assertEqual(model[2].fname, "in:linear")
        ...
        self.assertEqual(model[3].fname, "in:linear")
    ...
    def test_edges_and_depth(self):
        ...
        g = quickmodels.get_complicated_binary_model(["x1","x2"], "y", "exp")
    ...
    def test_init_with_missing_output(self):
        ...
        with self.assertRaises(ValueError):
            feyn.Model(program, names[1:], fnames[1:])
