...
from mlflow.utils.uri import construct_run_url, is_databricks_uri
...
class MlflowClient:
    ...
    def get_experiment_by_name(
        self, name: str, owner_subject_id: Optional[str] = None
    ) -> Optional[Experiment]:
        """
        Retrieve an experiment by experiment name from the backend store

        :param name: The experiment name, which is case sensitive.
               owner_subject_id: owner of the experiment
