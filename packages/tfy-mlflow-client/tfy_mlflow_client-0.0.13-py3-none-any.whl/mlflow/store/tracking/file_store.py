...
def _make_persisted_run_info_dict(run_info):
    ...
    run_info_dict["tags"] = []
    run_info_dict["name"] = run_info.name
...
class FileStore(AbstractStore):
    ...
    def list_experiments(
        ...
        :param ids: list of experiment ids - which you want to return
                    [Currently not implemented for file store]
    ...
    def _create_experiment_with_id(self, name, experiment_id, artifact_uri, tags):
        ...
        experiment_dict["privacy_type"] = experiment_dict["privacy_type"].value
    ...
    def update_run_info(self, run_id, run_status, end_time, description=SENTINEL):
    ...
    def create_run(self, experiment_id, user_id, start_time, tags, name, description=None):
        """
