...
class TestReportTests(unittest.TestCase):
    ...
    def evaluate_simplified_json(self, inst):
        ...
        # test values
        for simplified_key, simplified_values in simplified_js.items():
            ...
            for simplified_value in simplified_values:
                simplified_value_is_fhir_resource = 'fhirclient.models' in simplified_value.__class__.__name__
                if simplified_value_is_fhir_resource:
