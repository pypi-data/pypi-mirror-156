...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MedicinalProduct) on 2022-06-21.
...
class MedicinalProduct(domainresource.DomainResource):
    ...
    _attribute_docstrings['identifier'] = """Business identifier for this product. Could be an MPID."""
    _attribute_docstrings['type'] = """Regulatory type, e.g. Investigational or Authorized."""
    _attribute_docstrings['domain'] = """If this medicine applies to human or veterinary uses."""
    _attribute_docstrings['combinedPharmaceuticalDoseForm'] = """The dose form for a single part product, or combined form of a multiple part product."""
    ...
    _attribute_docstrings['additionalMonitoringIndicator'] = """Whether the Medicinal Product is subject to additional monitoring for regulatory reasons."""
    _attribute_docstrings['specialMeasures'] = """Whether the Medicinal Product is subject to special measures for regulatory reasons."""
    _attribute_docstrings['paediatricUseIndicator'] = """If authorised for use in children."""
    _attribute_docstrings['productClassification'] = """Allows the product to be classified by various systems."""
    _attribute_docstrings['marketingStatus'] = """Marketing status of the medicinal product, in contrast to marketing authorizaton."""
    _attribute_docstrings['pharmaceuticalProduct'] = """Pharmaceutical aspects of product."""
    _attribute_docstrings['packagedMedicinalProduct'] = """Package representation for the product."""
    _attribute_docstrings['attachedDocument'] = """Supporting documentation, typically for regulatory submission."""
    _attribute_docstrings['masterFile'] = """A master file for to the medicinal product (e.g. Pharmacovigilance System Master File)."""
    _attribute_docstrings['contact'] = """A product specific contact, person (in a role), or an organization."""
    _attribute_docstrings['clinicalTrial'] = """Clinical trials or studies that this product is involved in."""
    _attribute_docstrings['name'] = """The product's name, including full name and possibly coded parts."""
    _attribute_docstrings['crossReference'] = """Reference to another product, e.g. for linking authorised to investigational product."""
    _attribute_docstrings['manufacturingBusinessOperation'] = """An operation applied to the product, for manufacturing or adminsitrative purpose."""
    _attribute_docstrings['specialDesignation'] = """Indicates if the medicinal product has an orphan designation for the treatment of a rare disease."""
...
class MedicinalProductManufacturingBusinessOperation(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['operationType'] = """The type of manufacturing operation."""
    _attribute_docstrings['authorisationReferenceNumber'] = """Regulatory authorization reference number."""
    _attribute_docstrings['effectiveDate'] = """Regulatory authorization date."""
    _attribute_docstrings['confidentialityIndicator'] = """To indicate if this proces is commercially confidential."""
    _attribute_docstrings['manufacturer'] = """The manufacturer or establishment associated with the process."""
    _attribute_docstrings['regulator'] = """A regulator which oversees the operation."""
...
class MedicinalProductName(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['productName'] = """The full product name."""
    _attribute_docstrings['namePart'] = """Coding words or phrases of the name."""
    _attribute_docstrings['countryLanguage'] = """Country where the name applies."""
...
class MedicinalProductNameCountryLanguage(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['country'] = """Country code for where this name applies."""
    _attribute_docstrings['jurisdiction'] = """Jurisdiction code for where this name applies."""
    _attribute_docstrings['language'] = """Language code for this name."""
...
class MedicinalProductNameNamePart(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['part'] = """A fragment of a product name."""
    _attribute_docstrings['type'] = """Idenifying type for this part of the name (e.g. strength part)."""
...
class MedicinalProductSpecialDesignation(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['identifier'] = """Identifier for the designation, or procedure number."""
    _attribute_docstrings['type'] = """The type of special designation, e.g. orphan drug, minor use."""
    _attribute_docstrings['intendedUse'] = """The intended use of the product, e.g. prevention, treatment."""
    _attribute_docstrings['indicationCodeableConcept'] = """Condition for which the medicinal use applies."""
    _attribute_docstrings['indicationReference'] = """Condition for which the medicinal use applies."""
    _attribute_docstrings['status'] = """For example granted, pending, expired or withdrawn."""
    _attribute_docstrings['date'] = """Date when the designation was granted."""
    _attribute_docstrings['species'] = """Animal species for which this applies."""
