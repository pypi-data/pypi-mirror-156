...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MedicinalProductIngredient) on 2022-06-21.
...
class MedicinalProductIngredient(domainresource.DomainResource):
    ...
    _attribute_docstrings['identifier'] = """Identifier for the ingredient."""
    _attribute_docstrings['role'] = """Ingredient role e.g. Active ingredient, excipient."""
    _attribute_docstrings['allergenicIndicator'] = """If the ingredient is a known or suspected allergen."""
    _attribute_docstrings['manufacturer'] = """Manufacturer of this Ingredient."""
    _attribute_docstrings['specifiedSubstance'] = """A specified substance that comprises this ingredient."""
    _attribute_docstrings['substance'] = """The ingredient substance."""
...
class MedicinalProductIngredientSpecifiedSubstance(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['code'] = """The specified substance."""
    _attribute_docstrings['group'] = """The group of specified substance, e.g. group 1 to 4."""
    _attribute_docstrings['confidentiality'] = """Confidentiality level of the specified substance as the ingredient."""
    _attribute_docstrings['strength'] = """Quantity of the substance or specified substance present in the manufactured item or pharmaceutical product."""
...
class MedicinalProductIngredientSpecifiedSubstanceStrength(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['presentation'] = """The quantity of substance in the unit of presentation, or in the volume (or mass) of the single pharmaceutical product or manufactured item."""
    _attribute_docstrings['presentationLowLimit'] = """A lower limit for the quantity of substance in the unit of presentation. For use when there is a range of strengths, this is the lower limit, with the presentation attribute becoming the upper limit."""
    _attribute_docstrings['concentration'] = """The strength per unitary volume (or mass)."""
    _attribute_docstrings['concentrationLowLimit'] = """A lower limit for the strength per unitary volume (or mass), for when there is a range. The concentration attribute then becomes the upper limit."""
    _attribute_docstrings['measurementPoint'] = """For when strength is measured at a particular point or distance."""
    _attribute_docstrings['country'] = """The country or countries for which the strength range applies."""
    _attribute_docstrings['referenceStrength'] = """Strength expressed in terms of a reference substance."""
...
class MedicinalProductIngredientSpecifiedSubstanceStrengthReferenceStrength(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['substance'] = """Relevant reference substance."""
    _attribute_docstrings['strength'] = """Strength expressed in terms of a reference substance."""
    _attribute_docstrings['strengthLowLimit'] = """Strength expressed in terms of a reference substance."""
    _attribute_docstrings['measurementPoint'] = """For when strength is measured at a particular point or distance."""
    _attribute_docstrings['country'] = """The country or countries for which the strength range applies."""
...
class MedicinalProductIngredientSubstance(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['code'] = """The ingredient substance."""
    _attribute_docstrings['strength'] = """Quantity of the substance or specified substance present in the manufactured item or pharmaceutical product."""
