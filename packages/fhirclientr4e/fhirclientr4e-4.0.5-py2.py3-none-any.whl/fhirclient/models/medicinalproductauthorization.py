...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MedicinalProductAuthorization) on 2022-06-21.
...
class MedicinalProductAuthorization(domainresource.DomainResource):
    ...
    _attribute_docstrings['identifier'] = """Business identifier for the marketing authorization, as assigned by a regulator."""
    _attribute_docstrings['subject'] = """The medicinal product that is being authorized."""
    _attribute_docstrings['country'] = """The country in which the marketing authorization has been granted."""
    _attribute_docstrings['jurisdiction'] = """Jurisdiction within a country."""
    _attribute_docstrings['status'] = """The status of the marketing authorization."""
    _attribute_docstrings['statusDate'] = """The date at which the given status has become applicable."""
    _attribute_docstrings['restoreDate'] = """The date when a suspended the marketing or the marketing authorization of the product is anticipated to be restored."""
    _attribute_docstrings['validityPeriod'] = """The beginning of the time period in which the marketing authorization is in the specific status shall be specified A complete date consisting of day, month and year shall be specified using the ISO 8601 date format."""
    _attribute_docstrings['dataExclusivityPeriod'] = """A period of time after authorization before generic product applicatiosn can be submitted."""
    _attribute_docstrings['dateOfFirstAuthorization'] = """The date when the first authorization was granted by a Medicines Regulatory Agency."""
    _attribute_docstrings['internationalBirthDate'] = """Date of first marketing authorization for a company's new medicinal product in any country in the World."""
    _attribute_docstrings['legalBasis'] = """The legal framework against which this authorization is granted."""
    _attribute_docstrings['jurisdictionalAuthorization'] = """Authorization in areas within a country."""
    _attribute_docstrings['holder'] = """Marketing Authorization Holder."""
    _attribute_docstrings['regulator'] = """Medicines Regulatory Agency."""
    _attribute_docstrings['procedure'] = """The regulatory procedure for granting or amending a marketing authorization."""
...
class MedicinalProductAuthorizationJurisdictionalAuthorization(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['identifier'] = """The assigned number for the marketing authorization."""
    _attribute_docstrings['country'] = """Country of authorization."""
    _attribute_docstrings['jurisdiction'] = """Jurisdiction within a country."""
    _attribute_docstrings['legalStatusOfSupply'] = """The legal status of supply in a jurisdiction or region."""
    _attribute_docstrings['validityPeriod'] = """The start and expected end date of the authorization."""
...
class MedicinalProductAuthorizationProcedure(backboneelement.BackboneElement):
    ...
    _attribute_docstrings = {}
    """ Dictionary of attribute documentation."""
    _attribute_docstrings['identifier'] = """Identifier for this procedure."""
    _attribute_docstrings['type'] = """Type of procedure."""
    _attribute_docstrings['datePeriod'] = """Date of procedure."""
    _attribute_docstrings['dateDateTime'] = """Date of procedure."""
    _attribute_docstrings['application'] = """Applcations submitted to obtain a marketing authorization."""
