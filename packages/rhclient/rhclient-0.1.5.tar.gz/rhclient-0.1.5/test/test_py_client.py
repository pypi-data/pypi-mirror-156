...
class test_py_client(unittest.TestCase) :
    ...
    def test_01_create(self):
        ...
        expected = "New path created:\n/test:{'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 200, 'return_value': 'test <strong>test</strong> test'}"
    ...
    def test_02_create_another(self) :
        ...
        expected = "New path created:\n/test:{'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 202, 'return_value': 'test <em>test2</em> test'}"
        actual = 'New path created:\n/test:{}'.format( client.get_path('/test'))
        self.assertEqual(expected, actual)
        client.delete_path('/test')
    ...
    def test_04_read(self):
        client.create_path('/test', 200, 'test <strong>test</strong> test')
        print("\nRead_path results:")
        expected = "/test:{'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 200, 'return_value': 'test <strong>test</strong> test'}"
    ...
    def test_05_read_all(self):
        ...
        expected = "{'/test': {'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 200, 'return_value': 'test <strong>test</strong> test'}, '/test2': {'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 202, 'return_value': 'test2 <em>test2</em> test2'}}"
    ...
    def test_06_update(self):
        ...
        expected = "{'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 300, 'return_value': 'IM AN UPDATE, LOOK AT ME ALL UPDATED!!!'}"
