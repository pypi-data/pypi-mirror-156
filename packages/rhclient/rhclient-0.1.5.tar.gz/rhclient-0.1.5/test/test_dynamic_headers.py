...
class test_dynamicHeaders(unittest.TestCase) :
    ...
    def test_01_single_path_default_header(self):
        ...
        expected = {'delay': 0, 'headers': {'User-Agent': 'application/json'}, 'rc': 200, 'return_value': 'test1'}
    ...
    def test_02_single_path_additional_header(self):
        ...
        expected = {'delay': 0, 'headers': {'Expires': 'Wed, 21 Oct 2015 07:28:00 GMT', 'User-Agent': 'application/json'}, 'rc': 200, 'return_value': 'test2'}
    ...
    def test_03_single_path_garbage_header(self):
        ...
        with self.assertRaises(TypeError) as err_context1:
            client.create_path('/test3-1', 200, 'test3-1', headers='User-Agent : application/json')
        with self.assertRaises(TypeError) as err_context2:
            client.create_path('/test3-2', 200, 'test3-2', headers=['User-Agent', 'application/json'])
    ...
    def test_04_update_single_path_with_header(self):
        ...
        expected = {'delay': 0, 'headers': {'Expires': 'Wed, 21 Oct 2015 07:28:00 GMT', 'User-Agent': 'application/json'}, 'rc': 200, 'return_value': 'test4'}
    ...
    def test_05_multipath_default_header(self):
        ...
        expected = [
                {'delay': 0, 'headers': {'User-Agent' : 'application/json'},'rc':200, 'return_value':'test5-1'},
                {'delay': 0, 'headers': {'User-Agent' : 'application/json'},'rc':200, 'return_value':'test5-2'},
                {'delay': 0, 'headers': {'User-Agent' : 'application/json'},'rc':200, 'return_value':'test5-3'},
                {'delay': 0, 'headers': {'User-Agent' : 'application/json'},'rc':200, 'return_value':'test5-4'}
                ]
    ...
    def test_06_multipath_additional_headers(self):
        ...
        client.create_paths(data)
        expected = [
                {'delay': 0, 'headers': {'Expires': 'Wed, 21 Oct 2015 07:28:00 GMT', 'User-Agent' : 'application/json'},'rc':200, 'return_value':'test6-1'},
                {'delay': 0, 'headers': {'Expires': 'Wed, 21 Oct 2015 07:28:00 GMT', 'User-Agent' : 'application/json'},'rc':200, 'return_value':'test6-2'},
                {'delay': 0, 'headers': {'Expires': 'Wed, 21 Oct 2015 07:28:00 GMT', 'User-Agent' : 'application/json'},'rc':200, 'return_value':'test6-3'},
                {'delay': 0, 'headers': {'Expires': 'Wed, 21 Oct 2015 07:28:00 GMT', 'User-Agent' : 'application/json'},'rc':200, 'return_value':'test6-4'}
                ]
