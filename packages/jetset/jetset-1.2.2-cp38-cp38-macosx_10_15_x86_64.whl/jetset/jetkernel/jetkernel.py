...
class blob(object):
    ...
    Vol_sphere = property(_jetkernel.blob_Vol_sphere_get, _jetkernel.blob_Vol_sphere_set)
    Surf_sphere = property(_jetkernel.blob_Surf_sphere_get, _jetkernel.blob_Surf_sphere_set)
    ...
    MPI_kernel_delta = property(_jetkernel.blob_MPI_kernel_delta_get, _jetkernel.blob_MPI_kernel_delta_set)
    MPI_kernel_delta_Emin = property(_jetkernel.blob_MPI_kernel_delta_Emin_get, _jetkernel.blob_MPI_kernel_delta_Emin_set)
    ...
    nu = property(_jetkernel.blob_nu_get, _jetkernel.blob_nu_set)
    nu_1 = property(_jetkernel.blob_nu_1_get, _jetkernel.blob_nu_1_set)
    nu_compton_0 = property(_jetkernel.blob_nu_compton_0_get, _jetkernel.blob_nu_compton_0_set)
    ...
    g_min_IC = property(_jetkernel.blob_g_min_IC_get, _jetkernel.blob_g_min_IC_set)
    ...
    EC_factor = property(_jetkernel.blob_EC_factor_get, _jetkernel.blob_EC_factor_set)
    R_H_scale_factor = property(_jetkernel.blob_R_H_scale_factor_get, _jetkernel.blob_R_H_scale_factor_set)
    R_ext_factor = property(_jetkernel.blob_R_ext_factor_get, _jetkernel.blob_R_ext_factor_set)
    EC_theta_lim = property(_jetkernel.blob_EC_theta_lim_get, _jetkernel.blob_EC_theta_lim_set)
    L_Star = property(_jetkernel.blob_L_Star_get, _jetkernel.blob_L_Star_set)
    T_Star_max = property(_jetkernel.blob_T_Star_max_get, _jetkernel.blob_T_Star_max_set)
    ...
    Star_mu_1 = property(_jetkernel.blob_Star_mu_1_get, _jetkernel.blob_Star_mu_1_set)
    Star_mu_2 = property(_jetkernel.blob_Star_mu_2_get, _jetkernel.blob_Star_mu_2_set)
    ...
    Ne_IC = property(_jetkernel.blob_Ne_IC_get, _jetkernel.blob_Ne_IC_set)
    Ne_stat = property(_jetkernel.blob_Ne_stat_get, _jetkernel.blob_Ne_stat_set)
    ...
    griglia_gamma_Ne_log_IC = property(_jetkernel.blob_griglia_gamma_Ne_log_IC_get, _jetkernel.blob_griglia_gamma_Ne_log_IC_set)
    ...
    i_griglia_gamma = property(_jetkernel.blob_i_griglia_gamma_get, _jetkernel.blob_i_griglia_gamma_set)
...
def CooolingEquilibrium(pt, T_esc):
    return _jetkernel.CooolingEquilibrium(pt, T_esc)
...
def InitRadiative(pt_base):
    return _jetkernel.InitRadiative(pt_base)
...
def rate_neutrino_mu_1_pp(pt, nu_nu_mu):
    return _jetkernel.rate_neutrino_mu_1_pp(pt, nu_nu_mu)

def pp_gamma_kernel(gamma_p, E_out_TeV, pt):
    return _jetkernel.pp_gamma_kernel(gamma_p, E_out_TeV, pt)

def pp_gamma_kernel_delta(pt, E_pi):
    return _jetkernel.pp_gamma_kernel_delta(pt, E_pi)

def pp_electron_kernel_delta(pt, E_pi):
    return _jetkernel.pp_electron_kernel_delta(pt, E_pi)

def pp_electrons_kernel(gamma_p, E_out_TeV, pt):
    return _jetkernel.pp_electrons_kernel(gamma_p, E_out_TeV, pt)

def pp_neturino_mu_1_kernel(gamma_p, E_out_TeV, pt):
    return _jetkernel.pp_neturino_mu_1_kernel(gamma_p, E_out_TeV, pt)

def pp_neutrino_mu_1_kernel_delta(pt, E_pi):
    return _jetkernel.pp_neutrino_mu_1_kernel_delta(pt, E_pi)
...
def integrale_pp_second_low_en_rate(pf_pp_delta_kernel, E_min_pi, E_max_pi, E_out_TeV, pt):
    return _jetkernel.integrale_pp_second_low_en_rate(pf_pp_delta_kernel, E_min_pi, E_max_pi, E_out_TeV, pt)
...
def integrale_IC(pt, a, b, stat_frame):
    return _jetkernel.integrale_IC(pt, a, b, stat_frame)
