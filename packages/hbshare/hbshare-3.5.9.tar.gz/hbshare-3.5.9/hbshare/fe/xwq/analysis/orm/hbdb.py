...
class HBDB:
    ...
    def read_fund_info(self):
        sql = "select jjdm, jjmc, jjjc, clrq, zzrq, cpfl, kffb, jjfl, ejfl from st_fund.t_st_gm_jjxx"
        df = self.get_df(sql, db='funduser')
        return df
    ...
    def read_bond_fund_info(self):
        sql = "select jjdm, jjmc, jjjc, clrq, zzrq, ejfl, kffb from st_fund.t_st_gm_jjxx where ejfl in ('21', '22', '23', '24', '25', '27', '28', '34', '35', '38')"
        df = self.get_df(sql, db='funduser')
        return df
