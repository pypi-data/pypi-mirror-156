...
def sound_spectre(text, plot=False, input_is_transcribed=False):
...
def sound_spectre_grouped(text, plot=False, input_is_transcribed=False):
    if not input_is_transcribed:
      text = transcribe(text, simplify=True)
...
def sound_spectre_grouped_custom(text, plot=False, input_is_transcribed=False):
    if not input_is_transcribed:
      text = transcribe(text, simplify=True)
