...
def get_modules(
    package: Union[ModuleType, str], search_subpackages: bool = True, names_only: bool = False
...
def class_impls_from_module(
    base_class: Union[ModuleType, str], module: Union[ModuleType, str], names_only: bool = False
) -> Union[List[str], List[ModuleType]]:
...
def class_impls_from_package(
    ...
    for module in get_modules(package, search_subpackages, names_only):
        class_impls += class_impls_from_module(base_class, module, names_only)
    return class_impls


def class_instances_from_module(module: Union[ModuleType, str], class_type: ModuleType):
    if isinstance(module, str):
        module = import_module(module)
