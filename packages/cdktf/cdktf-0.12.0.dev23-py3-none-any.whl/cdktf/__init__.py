...
class TerraformIterator(
    ...
    def from_list(
        cls,
        list: typing.Union[IResolvable, "ComplexList", StringMapList, NumberMapList, "BooleanMapList", "AnyMapList", typing.Sequence[builtins.str], typing.Sequence[jsii.Number], typing.Sequence[typing.Union[builtins.bool, IResolvable]]],
