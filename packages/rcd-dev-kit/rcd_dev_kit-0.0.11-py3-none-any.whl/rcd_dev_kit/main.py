...
from rcd_dev_kit.database_manager.redshift_operator import RedshiftOperator, send_to_redshift, send_metadata_to_redshift
...
def test_rs_operator():
    ...
    ddl_model = ro.get_DDL(verbose=True, not_include=["pv_reference", "platform", "pg_catalog", "information_schema"])
...
def test_function_columns_desc():
    load_dotenv(find_dotenv())
    send_metadata_to_redshift(database="staging", file_path="./table_metadata.json")
