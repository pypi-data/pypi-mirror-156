...
from cccs.common.exceptions import ChainAll
from cccs.common.loader import APP_NAME
from cccs.common.path import splitpath
from cccs.common.uid import get_random_id
from cccs.filestore.transport.base import Transport, TransportException, normalize_srl_path
...
class TransportFTP(Transport):
    ...
    def __init__(self, base=None, host=None, password=None, user=None, port=None, use_tls=None):
        self.log: logging.Logger = logging.getLogger(f'{APP_NAME}.transport.ftp')
        self.base: str = base
