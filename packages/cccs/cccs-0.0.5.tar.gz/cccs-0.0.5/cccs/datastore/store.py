...
from cccs.datastore.collection import ESCollection
from cccs.datastore.exceptions import DataStoreException
...
class ESStore(object):
    ...
    def __init__(self, config=None, archive_access=True):
        if not config:
        ...
        self._hosts = config.datastore.hosts
        self._closed = False
        self._collections = {}
        self._models = {}
        ...
        self.client = elasticsearch.Elasticsearch(hosts=config.datastore.hosts,
