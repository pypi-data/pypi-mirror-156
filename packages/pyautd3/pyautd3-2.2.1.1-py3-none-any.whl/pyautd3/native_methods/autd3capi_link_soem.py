...
class NativeMethods(metaclass=Singleton):
    ...
    def init_dll(self):
        if hasattr(self, 'dll'):
            return
        self.dll = ctypes.CDLL(os.path.join(self.bin, f'{self.prefix}autd3capi-link-soem-{self.version}{self.ext}'))
        ...
        self.dll.AUTDLinkSOEM.argtypes = [ctypes.POINTER(ctypes.c_void_p), ctypes.c_char_p, ctypes.c_int32, ctypes.c_uint16, ctypes.c_void_p, ctypes.c_bool] 
