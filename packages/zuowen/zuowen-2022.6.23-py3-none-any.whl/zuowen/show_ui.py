...
title = st.text_input("标题", placeholder="家乡的四季")
context = st.text_input("作文上文", placeholder="家乡的四季,最美不过了")
max_len = st.slider("作文长度", min_value=100, max_value=1000, step=50, value=200)
st.subheader("高级")
...
topp = st.slider("最高积累概率", min_value=0.0, max_value=1.0, step=0.01, value=0.85)
