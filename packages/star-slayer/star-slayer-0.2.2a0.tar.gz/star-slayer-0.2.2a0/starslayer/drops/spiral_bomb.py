"""
Spiral Bomb Drop Module.
"""

from math import pi as PI
from typing import TYPE_CHECKING

from ..bullets import BulletSpiralSimple
from ..consts import SPIRAL_BOMB_REL_PATH, WIDTH
from .drop import Drop

if TYPE_CHECKING:
    from ..state import Game

class SpiralBomb(Drop):
    """
    Med Kit Drop class.
    """
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        """
        Initializes an instance of type 'SpiralBomb'.
        """
        ...
        super().__init__(x1=x1,
                         ...
                         x2=x2,
                         y2=y2,
                         texture_path=SPIRAL_BOMB_REL_PATH,
                         accel=2.0,
                         **kwargs)
    ...
    def effect(self, game: "Game") -> None:
        ...
        for i in range(how_many):
            game.player_bullets.append(BulletSpiralSimple(cx=center_x,
                                                          cy=center_y,
                                                          radius=rad_aux,
