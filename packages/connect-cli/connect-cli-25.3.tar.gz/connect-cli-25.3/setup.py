...
{'': ['*'],
 ...
 'connect.cli.plugins.project.extension': ['template/project_dir/*',
                                           'template/project_dir/github_dir/*',
                                           'template/project_dir/package_dir/*',
                                           'template/project_dir/tests_dir/*']}

install_requires = \
['Jinja2>=3.1.2,<4.0.0',
 'click>=7.1.2,<8.0.0',
 'connect-eaas-core>=2,<3',
 'connect-markdown-renderer>=2.0.1,<3',
 'connect-openapi-client>=25.4',
 'connect-reports-core>=24.0.0,<25.0.0',
 'cookiecutter>=1.7.2,<2.0.0',
 'fs>=2.4.12,<3.0.0',
 'interrogatio>=2.1.2,<3.0.0',
 'iso3166>=1.0.1,<2.0.0',
