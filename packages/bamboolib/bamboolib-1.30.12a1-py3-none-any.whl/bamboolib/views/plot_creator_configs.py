    ...
    def render(self):
        ...
        if self.user_accepts_sampling and self.recommend_sampling:
            ...
            output = widgets.VBox(
                [
                    notification(
                        f"Your dataframe has more than {plotly_row_limit:,} rows which can lead to long loading times for the plots. Therefore, we randomly sampled {plotly_row_limit:,} rows. If you want you can remove the sampling. Alternatively, you might want to filter or aggregate the data manually before plotting it.",
                        type="warning",
                    ),
                    Button(
