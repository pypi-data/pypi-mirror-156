...
class FileProperties(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, url, name, content_type, size, *args, **kwargs):  # noqa: E501
        """FileProperties - a model defined in OpenAPI

        Args:
            type (str): The type of this file. Either external or hosted by ChatKitty
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, url, name, content_type, size, *args, **kwargs):  # noqa: E501
        """FileProperties - a model defined in OpenAPI
