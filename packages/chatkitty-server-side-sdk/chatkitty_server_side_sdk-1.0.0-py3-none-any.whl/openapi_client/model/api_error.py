...
class ApiError(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, error, message, timestamp, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            properties ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, error, message, timestamp, *args, **kwargs):  # noqa: E501
        """ApiError - a model defined in OpenAPI
