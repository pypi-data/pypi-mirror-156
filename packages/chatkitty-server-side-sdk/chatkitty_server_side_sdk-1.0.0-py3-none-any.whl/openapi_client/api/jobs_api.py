...
class JobsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_job_endpoint = _Endpoint(
            settings={
                'response_type': (ApplicationJobResource,),
                'auth': [
                    'application_authorization'
                ],
                'endpoint_path': '/v1/jobs/{id}',
        ...
        self.retrieve_jobs_endpoint = _Endpoint(
            settings={
                'response_type': (PagedModelApplicationJobResource,),
                'auth': [
                    'application_authorization'
                ],
                'endpoint_path': '/v1/jobs',
                'operation_id': 'retrieve_jobs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_job(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.retrieve_job_endpoint.call_with_http_info(**kwargs)
    ...
    def retrieve_jobs(
        ...
        **kwargs
        ...
        Returns a page of jobs created for this application  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            ...
            running (bool): Filters for jobs currently running. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.retrieve_jobs_endpoint.call_with_http_info(**kwargs)
