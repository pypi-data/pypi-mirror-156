...
class ChannelInviteResource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_time, *args, **kwargs):  # noqa: E501
        """ChannelInviteResource - a model defined in OpenAPI

        Args:
            created_time (datetime): The time this invite was created
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_time, *args, **kwargs):  # noqa: E501
        """ChannelInviteResource - a model defined in OpenAPI
