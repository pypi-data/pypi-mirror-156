...
class ChatRuntimeScriptProperties(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, script, *args, **kwargs):  # noqa: E501
        """ChatRuntimeScriptProperties - a model defined in OpenAPI

        Args:
            script (str): The JavaScript/TypeScript source of this script
    ...
    @convert_js_args_to_python_args
    def __init__(self, script, *args, **kwargs):  # noqa: E501
        """ChatRuntimeScriptProperties - a model defined in OpenAPI
