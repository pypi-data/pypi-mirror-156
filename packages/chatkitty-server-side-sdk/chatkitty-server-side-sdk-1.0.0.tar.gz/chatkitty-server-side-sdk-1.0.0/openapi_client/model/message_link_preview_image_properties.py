...
class MessageLinkPreviewImageProperties(ModelNormal):
    ...
    def _from_openapi_data(cls, source, *args, **kwargs):  # noqa: E501
        """MessageLinkPreviewImageProperties - a model defined in OpenAPI

        Args:
            source (str): The url source of this image
