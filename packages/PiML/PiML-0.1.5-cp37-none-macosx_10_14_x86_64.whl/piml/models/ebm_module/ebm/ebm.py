...
from ..utils import gen_perf_dicts, unify_data, autogen_schema, unify_vector
from ..api import ExplainerMixin, FeatureValueExplanation
...
class BaseEBM(BaseEstimator):
    ...
    def fit(self, X, y, sample_weight=None):  # noqa: C901
        ...
        BaseCoreEBM.fit_parallel(estimators[0], X, y, w, X_pair, n_classes)
