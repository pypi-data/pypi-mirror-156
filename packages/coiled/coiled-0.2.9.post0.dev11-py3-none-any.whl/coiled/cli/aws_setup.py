...
def do_intro(sts, iam, region):
    ...
    try:
        ...
        print(
            f"Proposed region for Coiled:\t[green]{region}[/green]\t(use `--region` to change)"
        )
        ...
        print(
            ...
            "\nUsually these credentials are in `~/.aws/credentials`. "
...
def do_setup(
    ...
    try:
        ...
        try:
            ...
            if not (account := do_intro(sts, iam, region=region)):
                return False
