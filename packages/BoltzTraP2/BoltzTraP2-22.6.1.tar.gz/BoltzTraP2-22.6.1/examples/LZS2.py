...
#    Copyright (C) 2017-2022 Matthieu J. Verstraete <matthieu.vers1traete@ulg.ac.be>
...
data.bandana(emin=0, emax=.3)

data, equivalences, coeffs, metadata = serialization.load_calculation("LZS.bt2")
...
mur = epsilon[100:-100]
TEMP = np.array([500.])
N, L0, L1, L2, Lm11 = BL.fermiintegrals(epsilon, dos, vvdos, mur=mur, Tr=[TEMP])
#
