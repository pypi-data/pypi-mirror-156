...
from core.cli.ceph.orch.daemon import Daemon
from core.cli.ceph.orch.host import Host
from core.cli.ceph.orch.osd import Osd
from core.cli.ceph.orch.upgrade import Upgrade
...
class Orch:
    ...
    def apply(self, **kw):
        ...
        placement = kw_copy.pop("placement", {})
        if placement:
            if "label" in placement:
                cmd = cmd + f" --placement='label:{placement['label']}'"
