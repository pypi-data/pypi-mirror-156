...
from packagedfd import resolution_network
from packagedfd import solver
from easydict import EasyDict as edict
import cv2, yaml, os, dlib
from packagedfd.py_utils.vis import vis_im
import numpy as np
from packagedfd.py_utils.face_utils import lib
from packagedfd.py_utils.vid_utils import proc_vid as pv
import logging
...
print('***********')
# Parse config
cfg_file = 'packagedfd/cfgs/res50.yml'
...
# Build network
reso_net = resolution_network.ResoNet(cfg=cfg, is_train=False)
reso_net.build()
# Build solver
solver = solver.Solver(sess=sess, cfg=cfg, net=reso_net)
solver.init()
