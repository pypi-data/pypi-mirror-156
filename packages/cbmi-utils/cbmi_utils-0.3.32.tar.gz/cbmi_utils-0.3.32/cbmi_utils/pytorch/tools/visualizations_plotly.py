...
def plot_TSNE_with_images(feature_vec: np.array, label_vec: np.array, imgs: np.array, point_class_belonging: list = None, title: Optional[str] = None, reducer_seed: int = 42, marker_size: float = 3, marker_opacity: float = 0.8):
    """
    ...
    _2dplot_scatter_with_images(embedding, label_vec, imgs, point_class_belonging, title, marker_size, marker_opacity)


def plot_PCA_with_images(feature_vec: np.array, label_vec: np.array, imgs: np.array, point_class_belonging: list = None, title: Optional[str] = None, reducer_seed: int = 42, marker_size: float = 3, marker_opacity: float = 0.8):
    """
    This function creates an interactive chart (plotly) by reducing the
