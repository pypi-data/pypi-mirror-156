...
def plot_TSNE_with_images(feature_vec: np.array, label_vec: np.array, imgs: np.array, point_class_belonging: list = None, title: Optional[str] = None, reducer_seed: int = 42, marker_size: int = 3):
    """
    ...
    """
    embedding = TSNE(n_components=2, random_state=reducer_seed, init='pca', learning_rate='auto').fit_transform(feature_vec)
    _2dplot_scatter_with_images(embedding, label_vec, imgs, point_class_belonging, title, marker_size)


def plot_PCA_with_images(feature_vec: np.array, label_vec: np.array, imgs: np.array, point_class_belonging: list = None, title: Optional[str] = None, reducer_seed: int = 42, marker_size: int = 3):
    """
    This function creates an interactive chart (plotly) by reducing the
    ...
    params:
        ...
        marker_size (optional):
            The size of the marker.
    """
    embedding = PCA(n_components=2, random_state=reducer_seed).fit_transform(feature_vec)
    _2dplot_scatter_with_images(embedding, label_vec, imgs, point_class_belonging, title, marker_size)


def _2dplot_scatter_with_images(data: np.array, labels: np.array, imgs: np.array, point_class_belonging: list = None, title: Optional[str] = None, marker_size: int = 3):
