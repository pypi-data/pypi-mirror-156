...
class FlowAndPortStatsMonitor(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        wsgi = kwargs['wsgi']
        wsgi.register(NorthBoundRestAPIController, {constants.RYU.NORTHBOUND_API_APP_NAME: self})
...
class NorthBoundRestAPIController(ControllerBase):
    ...
    def __init__(self, req, link, data, **config):
        ...
        self.learning_switch_app = data[constants.RYU.NORTHBOUND_API_APP_NAME]

    @route('cslenorthboundapiapp', "/cslenorthboundapi/test", methods=['GET'], requirements={})
