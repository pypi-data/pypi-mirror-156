...
class BaseListener(object):
    ...
    def __init__(self,
        ...
        """
        self._browser = None
        self._tab: Union[None, Tab] = None  # Tab对象
        self._tmp: Union[None, Queue] = None  # 临存捕捉到的数据
        self._request_ids: Union[None, dict] = None  # 暂存须要拦截的请求id
    ...
    def get_results(self, target: str = None):
        """获取结果列表                                        \n
