...
def datastore_invalid_fsx_option(source: str) -> str:
    return (
        f"The --high-performance option was passed when creating a datastore from {source}. "
        "This option is only valid for s3 buckets. Please consider removing the "
        "flag or ensuring that your path starts with `s3://`"
    )
...
def datastore_invalid_fsx_throughput(throughput: int) -> str:
    return (
        f"The --high-performance-throughput option was passed when creating a high-performance datastore "
...
def datastore_invalid_fsx_capacity(capacity: int) -> str:
    return (
        f"The --high-performance-capacity option was passed when creating a high-performance backed datastore "
