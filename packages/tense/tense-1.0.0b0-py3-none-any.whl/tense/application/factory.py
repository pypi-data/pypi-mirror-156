...
from typing import TYPE_CHECKING, Any, Callable, Iterator, Optional, Union, Type, overload
...
class TenseParser:
    ...
    def __new__(
        ...
        *,
        tenses: Optional[Union[abc_repository.AbstractTenseRepository, dict[str, Any]]] = None,
