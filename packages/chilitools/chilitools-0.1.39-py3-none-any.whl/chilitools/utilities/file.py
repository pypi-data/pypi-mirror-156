...
from chilitools.utilities.xml import getTaskResultURL, removeTimelineTags
...
def readFile(fileName: str, isJSON: bool = False, encoding: str = None) -> dict:
...
def removeTimelineFromDoc(fileName: str, verbose: bool = False) -> bool:
  # try:
  with open(file=fileName, mode='r') as file:
    docXML = file.read()
  docXML = removeTimelineTags(docXML=docXML, verbose=verbose)
  newFile = fileName.split('.xml')
  with open(file=newFile[0]+'_fixed.xml', mode='w', encoding='utf-8') as file:
    file.write(docXML)
  return True
  # except Exception as e:
  #   print(f'There was an issue removing the timeline docs: {e}')
  #   return False
