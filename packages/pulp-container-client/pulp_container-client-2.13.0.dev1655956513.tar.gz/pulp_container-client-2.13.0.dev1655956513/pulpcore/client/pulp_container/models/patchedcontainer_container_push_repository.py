...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, pulp_labels=None, retain_repo_versions=None, description=None, manifest_signing_service=None, name=None, local_vars_configuration=None):  # noqa: E501
