...
class LocalArtifactClient(BaseArtifactsClient):
    ...
    def __init__(self, service_context, origin, container, path):
        self._client = RestArtifactsClient(credential=service_context.auth, base_url=service_context.host_url)
    ...
    def upload_artifact(self, local_file, remote_path):
        ...
        with open(local_file, "rb") as file:
            return self._upload_artifact_from_stream(file, remote_path, self._origin, self._container)
    ...
    def _create_empty_artifacts(self, paths, origin, container):
