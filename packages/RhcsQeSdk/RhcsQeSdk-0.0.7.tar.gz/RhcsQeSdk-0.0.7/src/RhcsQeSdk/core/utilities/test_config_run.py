...
from src.RhcsQeSdk.core.cli.cli import CLI
from src.RhcsQeSdk.core.runner.runner import Runner
from src.RhcsQeSdk.core.utilities.execute_command import ExecuteCommandMixin
from src.RhcsQeSdk.core.utilities.parallel_executor import ParallelExecutor
from src.RhcsQeSdk.core.utilities.redefine_args import RedefineArgs
from src.RhcsQeSdk.core.utilities.workflow import get_module
...
class ConfigRun:
    def __init__(
        self, cluster_name, ceph_cluster_dict, osp_cred, is_redefine_args=True
    ):
        self.cli_obj = CLI()
