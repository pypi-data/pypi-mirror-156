def negation(lang):
    if(lang == 'en'):
        return ['could not even', 'can not even', 'suppose to be', 'suppose to', 'cannot even', 'can not', 
                'could not', 'did not', 'does not', 'do not', 'had not', 'has not', 'have not',
                'shall not', 'should not', 'be not', 'was not', 'were not', 'will not', 'would not', 
                'might not', 'may not', 'must not', 'need not', 'no longer', 'no one', 
                'no more', 'no', 'not', 'none', 'nobody', 'nothing', 'neither', 'never', 'cannot']
    elif(lang == 'zsm'):
...
def intensifier(lang):
    if(lang == 'en'):
        return {
                ...
                'low':['little', 'less', 'a bit', 'a little bit']
        }
    elif(lang == 'zsm'):
        return {
...
def conjunction(lang):
    if(lang == 'en'):
        return {
                'contrasting':['but', 'however', 'in contrast', 'instead', 'whereas', 'except that', 'on the contrary', 'conversely', 'nevertheless', 'although', 'alternatively', 'on the other hand', 'even though']
        }
    elif(lang == 'zsm'):
        return {
                'contrasting':['tetapi', 'kecuali', 'sebaliknya', 'walaupun begitu', 'walaupun demikian', 'walaupun', 'walau bagaimanapun', 'walhal itu']
        }
    elif(lang == 'zh'):
        return {'contrasting':
                    {
