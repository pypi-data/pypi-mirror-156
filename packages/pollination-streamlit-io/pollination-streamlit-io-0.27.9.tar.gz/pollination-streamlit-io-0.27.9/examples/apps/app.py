...
from pollination_streamlit_io import (get_geometry, get_hbjson, send_geometry, send_hbjson)
...
geometry_file = open(os.getcwd() + '/examples/files/geometry.json')
...
hbjson_file = open(os.getcwd() + '/examples/files/single-family-home.hbjson')
