...
import { SendHbjson as SendHbjsonComponent } from 'pollination-react-io'
 ...
 const SendHbjson: React.VFC = () => {
  ...
  return (
    <div style={{
      ...
      <SendHbjsonComponent hbjson={renderData && renderData.args && renderData.args['hbjson'] ? renderData.args['hbjson'] : undefined} />
    </div>
  )
}
