...
Ywatt2 = Unit.create((Ywatt**2).dim, name="Ywatt2", dispname=f"{str(Ywatt)}^2", scale=Ywatt.scale*2)
Ywatt3 = Unit.create((Ywatt**3).dim, name="Ywatt3", dispname=f"{str(Ywatt)}^3", scale=Ywatt.scale*3)
acoulomb2 = Unit.create((acoulomb**2).dim, name="acoulomb2", dispname=f"{str(acoulomb)}^2", scale=acoulomb.scale*2)
acoulomb3 = Unit.create((acoulomb**3).dim, name="acoulomb3", dispname=f"{str(acoulomb)}^3", scale=acoulomb.scale*3)
ccoulomb2 = Unit.create((ccoulomb**2).dim, name="ccoulomb2", dispname=f"{str(ccoulomb)}^2", scale=ccoulomb.scale*2)
ccoulomb3 = Unit.create((ccoulomb**3).dim, name="ccoulomb3", dispname=f"{str(ccoulomb)}^3", scale=ccoulomb.scale*3)
Zcoulomb2 = Unit.create((Zcoulomb**2).dim, name="Zcoulomb2", dispname=f"{str(Zcoulomb)}^2", scale=Zcoulomb.scale*2)
Zcoulomb3 = Unit.create((Zcoulomb**3).dim, name="Zcoulomb3", dispname=f"{str(Zcoulomb)}^3", scale=Zcoulomb.scale*3)
Pcoulomb2 = Unit.create((Pcoulomb**2).dim, name="Pcoulomb2", dispname=f"{str(Pcoulomb)}^2", scale=Pcoulomb.scale*2)
Pcoulomb3 = Unit.create((Pcoulomb**3).dim, name="Pcoulomb3", dispname=f"{str(Pcoulomb)}^3", scale=Pcoulomb.scale*3)
dcoulomb2 = Unit.create((dcoulomb**2).dim, name="dcoulomb2", dispname=f"{str(dcoulomb)}^2", scale=dcoulomb.scale*2)
dcoulomb3 = Unit.create((dcoulomb**3).dim, name="dcoulomb3", dispname=f"{str(dcoulomb)}^3", scale=dcoulomb.scale*3)
Gcoulomb2 = Unit.create((Gcoulomb**2).dim, name="Gcoulomb2", dispname=f"{str(Gcoulomb)}^2", scale=Gcoulomb.scale*2)
Gcoulomb3 = Unit.create((Gcoulomb**3).dim, name="Gcoulomb3", dispname=f"{str(Gcoulomb)}^3", scale=Gcoulomb.scale*3)
fcoulomb2 = Unit.create((fcoulomb**2).dim, name="fcoulomb2", dispname=f"{str(fcoulomb)}^2", scale=fcoulomb.scale*2)
fcoulomb3 = Unit.create((fcoulomb**3).dim, name="fcoulomb3", dispname=f"{str(fcoulomb)}^3", scale=fcoulomb.scale*3)
hcoulomb2 = Unit.create((hcoulomb**2).dim, name="hcoulomb2", dispname=f"{str(hcoulomb)}^2", scale=hcoulomb.scale*2)
hcoulomb3 = Unit.create((hcoulomb**3).dim, name="hcoulomb3", dispname=f"{str(hcoulomb)}^3", scale=hcoulomb.scale*3)
dacoulomb2 = Unit.create((dacoulomb**2).dim, name="dacoulomb2", dispname=f"{str(dacoulomb)}^2", scale=dacoulomb.scale*2)
dacoulomb3 = Unit.create((dacoulomb**3).dim, name="dacoulomb3", dispname=f"{str(dacoulomb)}^3", scale=dacoulomb.scale*3)
mcoulomb2 = Unit.create((mcoulomb**2).dim, name="mcoulomb2", dispname=f"{str(mcoulomb)}^2", scale=mcoulomb.scale*2)
mcoulomb3 = Unit.create((mcoulomb**3).dim, name="mcoulomb3", dispname=f"{str(mcoulomb)}^3", scale=mcoulomb.scale*3)
ncoulomb2 = Unit.create((ncoulomb**2).dim, name="ncoulomb2", dispname=f"{str(ncoulomb)}^2", scale=ncoulomb.scale*2)
ncoulomb3 = Unit.create((ncoulomb**3).dim, name="ncoulomb3", dispname=f"{str(ncoulomb)}^3", scale=ncoulomb.scale*3)
pcoulomb2 = Unit.create((pcoulomb**2).dim, name="pcoulomb2", dispname=f"{str(pcoulomb)}^2", scale=pcoulomb.scale*2)
pcoulomb3 = Unit.create((pcoulomb**3).dim, name="pcoulomb3", dispname=f"{str(pcoulomb)}^3", scale=pcoulomb.scale*3)
ucoulomb2 = Unit.create((ucoulomb**2).dim, name="ucoulomb2", dispname=f"{str(ucoulomb)}^2", scale=ucoulomb.scale*2)
ucoulomb3 = Unit.create((ucoulomb**3).dim, name="ucoulomb3", dispname=f"{str(ucoulomb)}^3", scale=ucoulomb.scale*3)
Tcoulomb2 = Unit.create((Tcoulomb**2).dim, name="Tcoulomb2", dispname=f"{str(Tcoulomb)}^2", scale=Tcoulomb.scale*2)
Tcoulomb3 = Unit.create((Tcoulomb**3).dim, name="Tcoulomb3", dispname=f"{str(Tcoulomb)}^3", scale=Tcoulomb.scale*3)
ycoulomb2 = Unit.create((ycoulomb**2).dim, name="ycoulomb2", dispname=f"{str(ycoulomb)}^2", scale=ycoulomb.scale*2)
ycoulomb3 = Unit.create((ycoulomb**3).dim, name="ycoulomb3", dispname=f"{str(ycoulomb)}^3", scale=ycoulomb.scale*3)
Ecoulomb2 = Unit.create((Ecoulomb**2).dim, name="Ecoulomb2", dispname=f"{str(Ecoulomb)}^2", scale=Ecoulomb.scale*2)
Ecoulomb3 = Unit.create((Ecoulomb**3).dim, name="Ecoulomb3", dispname=f"{str(Ecoulomb)}^3", scale=Ecoulomb.scale*3)
zcoulomb2 = Unit.create((zcoulomb**2).dim, name="zcoulomb2", dispname=f"{str(zcoulomb)}^2", scale=zcoulomb.scale*2)
zcoulomb3 = Unit.create((zcoulomb**3).dim, name="zcoulomb3", dispname=f"{str(zcoulomb)}^3", scale=zcoulomb.scale*3)
Mcoulomb2 = Unit.create((Mcoulomb**2).dim, name="Mcoulomb2", dispname=f"{str(Mcoulomb)}^2", scale=Mcoulomb.scale*2)
Mcoulomb3 = Unit.create((Mcoulomb**3).dim, name="Mcoulomb3", dispname=f"{str(Mcoulomb)}^3", scale=Mcoulomb.scale*3)
kcoulomb2 = Unit.create((kcoulomb**2).dim, name="kcoulomb2", dispname=f"{str(kcoulomb)}^2", scale=kcoulomb.scale*2)
kcoulomb3 = Unit.create((kcoulomb**3).dim, name="kcoulomb3", dispname=f"{str(kcoulomb)}^3", scale=kcoulomb.scale*3)
Ycoulomb2 = Unit.create((Ycoulomb**2).dim, name="Ycoulomb2", dispname=f"{str(Ycoulomb)}^2", scale=Ycoulomb.scale*2)
Ycoulomb3 = Unit.create((Ycoulomb**3).dim, name="Ycoulomb3", dispname=f"{str(Ycoulomb)}^3", scale=Ycoulomb.scale*3)
...
Yohm2 = Unit.create((Yohm**2).dim, name="Yohm2", dispname=f"{str(Yohm)}^2", scale=Yohm.scale*2)
Yohm3 = Unit.create((Yohm**3).dim, name="Yohm3", dispname=f"{str(Yohm)}^3", scale=Yohm.scale*3)
asiemens2 = Unit.create((asiemens**2).dim, name="asiemens2", dispname=f"{str(asiemens)}^2", scale=asiemens.scale*2)
asiemens3 = Unit.create((asiemens**3).dim, name="asiemens3", dispname=f"{str(asiemens)}^3", scale=asiemens.scale*3)
csiemens2 = Unit.create((csiemens**2).dim, name="csiemens2", dispname=f"{str(csiemens)}^2", scale=csiemens.scale*2)
csiemens3 = Unit.create((csiemens**3).dim, name="csiemens3", dispname=f"{str(csiemens)}^3", scale=csiemens.scale*3)
Zsiemens2 = Unit.create((Zsiemens**2).dim, name="Zsiemens2", dispname=f"{str(Zsiemens)}^2", scale=Zsiemens.scale*2)
Zsiemens3 = Unit.create((Zsiemens**3).dim, name="Zsiemens3", dispname=f"{str(Zsiemens)}^3", scale=Zsiemens.scale*3)
Psiemens2 = Unit.create((Psiemens**2).dim, name="Psiemens2", dispname=f"{str(Psiemens)}^2", scale=Psiemens.scale*2)
Psiemens3 = Unit.create((Psiemens**3).dim, name="Psiemens3", dispname=f"{str(Psiemens)}^3", scale=Psiemens.scale*3)
dsiemens2 = Unit.create((dsiemens**2).dim, name="dsiemens2", dispname=f"{str(dsiemens)}^2", scale=dsiemens.scale*2)
dsiemens3 = Unit.create((dsiemens**3).dim, name="dsiemens3", dispname=f"{str(dsiemens)}^3", scale=dsiemens.scale*3)
Gsiemens2 = Unit.create((Gsiemens**2).dim, name="Gsiemens2", dispname=f"{str(Gsiemens)}^2", scale=Gsiemens.scale*2)
Gsiemens3 = Unit.create((Gsiemens**3).dim, name="Gsiemens3", dispname=f"{str(Gsiemens)}^3", scale=Gsiemens.scale*3)
fsiemens2 = Unit.create((fsiemens**2).dim, name="fsiemens2", dispname=f"{str(fsiemens)}^2", scale=fsiemens.scale*2)
fsiemens3 = Unit.create((fsiemens**3).dim, name="fsiemens3", dispname=f"{str(fsiemens)}^3", scale=fsiemens.scale*3)
hsiemens2 = Unit.create((hsiemens**2).dim, name="hsiemens2", dispname=f"{str(hsiemens)}^2", scale=hsiemens.scale*2)
hsiemens3 = Unit.create((hsiemens**3).dim, name="hsiemens3", dispname=f"{str(hsiemens)}^3", scale=hsiemens.scale*3)
dasiemens2 = Unit.create((dasiemens**2).dim, name="dasiemens2", dispname=f"{str(dasiemens)}^2", scale=dasiemens.scale*2)
dasiemens3 = Unit.create((dasiemens**3).dim, name="dasiemens3", dispname=f"{str(dasiemens)}^3", scale=dasiemens.scale*3)
msiemens2 = Unit.create((msiemens**2).dim, name="msiemens2", dispname=f"{str(msiemens)}^2", scale=msiemens.scale*2)
msiemens3 = Unit.create((msiemens**3).dim, name="msiemens3", dispname=f"{str(msiemens)}^3", scale=msiemens.scale*3)
nsiemens2 = Unit.create((nsiemens**2).dim, name="nsiemens2", dispname=f"{str(nsiemens)}^2", scale=nsiemens.scale*2)
nsiemens3 = Unit.create((nsiemens**3).dim, name="nsiemens3", dispname=f"{str(nsiemens)}^3", scale=nsiemens.scale*3)
psiemens2 = Unit.create((psiemens**2).dim, name="psiemens2", dispname=f"{str(psiemens)}^2", scale=psiemens.scale*2)
psiemens3 = Unit.create((psiemens**3).dim, name="psiemens3", dispname=f"{str(psiemens)}^3", scale=psiemens.scale*3)
usiemens2 = Unit.create((usiemens**2).dim, name="usiemens2", dispname=f"{str(usiemens)}^2", scale=usiemens.scale*2)
usiemens3 = Unit.create((usiemens**3).dim, name="usiemens3", dispname=f"{str(usiemens)}^3", scale=usiemens.scale*3)
Tsiemens2 = Unit.create((Tsiemens**2).dim, name="Tsiemens2", dispname=f"{str(Tsiemens)}^2", scale=Tsiemens.scale*2)
Tsiemens3 = Unit.create((Tsiemens**3).dim, name="Tsiemens3", dispname=f"{str(Tsiemens)}^3", scale=Tsiemens.scale*3)
ysiemens2 = Unit.create((ysiemens**2).dim, name="ysiemens2", dispname=f"{str(ysiemens)}^2", scale=ysiemens.scale*2)
ysiemens3 = Unit.create((ysiemens**3).dim, name="ysiemens3", dispname=f"{str(ysiemens)}^3", scale=ysiemens.scale*3)
Esiemens2 = Unit.create((Esiemens**2).dim, name="Esiemens2", dispname=f"{str(Esiemens)}^2", scale=Esiemens.scale*2)
Esiemens3 = Unit.create((Esiemens**3).dim, name="Esiemens3", dispname=f"{str(Esiemens)}^3", scale=Esiemens.scale*3)
zsiemens2 = Unit.create((zsiemens**2).dim, name="zsiemens2", dispname=f"{str(zsiemens)}^2", scale=zsiemens.scale*2)
zsiemens3 = Unit.create((zsiemens**3).dim, name="zsiemens3", dispname=f"{str(zsiemens)}^3", scale=zsiemens.scale*3)
Msiemens2 = Unit.create((Msiemens**2).dim, name="Msiemens2", dispname=f"{str(Msiemens)}^2", scale=Msiemens.scale*2)
Msiemens3 = Unit.create((Msiemens**3).dim, name="Msiemens3", dispname=f"{str(Msiemens)}^3", scale=Msiemens.scale*3)
ksiemens2 = Unit.create((ksiemens**2).dim, name="ksiemens2", dispname=f"{str(ksiemens)}^2", scale=ksiemens.scale*2)
ksiemens3 = Unit.create((ksiemens**3).dim, name="ksiemens3", dispname=f"{str(ksiemens)}^3", scale=ksiemens.scale*3)
Ysiemens2 = Unit.create((Ysiemens**2).dim, name="Ysiemens2", dispname=f"{str(Ysiemens)}^2", scale=Ysiemens.scale*2)
Ysiemens3 = Unit.create((Ysiemens**3).dim, name="Ysiemens3", dispname=f"{str(Ysiemens)}^3", scale=Ysiemens.scale*3)
...
Ylux2 = Unit.create((Ylux**2).dim, name="Ylux2", dispname=f"{str(Ylux)}^2", scale=Ylux.scale*2)
Ylux3 = Unit.create((Ylux**3).dim, name="Ylux3", dispname=f"{str(Ylux)}^3", scale=Ylux.scale*3)
abecquerel2 = Unit.create((abecquerel**2).dim, name="abecquerel2", dispname=f"{str(abecquerel)}^2", scale=abecquerel.scale*2)
abecquerel3 = Unit.create((abecquerel**3).dim, name="abecquerel3", dispname=f"{str(abecquerel)}^3", scale=abecquerel.scale*3)
cbecquerel2 = Unit.create((cbecquerel**2).dim, name="cbecquerel2", dispname=f"{str(cbecquerel)}^2", scale=cbecquerel.scale*2)
cbecquerel3 = Unit.create((cbecquerel**3).dim, name="cbecquerel3", dispname=f"{str(cbecquerel)}^3", scale=cbecquerel.scale*3)
Zbecquerel2 = Unit.create((Zbecquerel**2).dim, name="Zbecquerel2", dispname=f"{str(Zbecquerel)}^2", scale=Zbecquerel.scale*2)
Zbecquerel3 = Unit.create((Zbecquerel**3).dim, name="Zbecquerel3", dispname=f"{str(Zbecquerel)}^3", scale=Zbecquerel.scale*3)
Pbecquerel2 = Unit.create((Pbecquerel**2).dim, name="Pbecquerel2", dispname=f"{str(Pbecquerel)}^2", scale=Pbecquerel.scale*2)
Pbecquerel3 = Unit.create((Pbecquerel**3).dim, name="Pbecquerel3", dispname=f"{str(Pbecquerel)}^3", scale=Pbecquerel.scale*3)
dbecquerel2 = Unit.create((dbecquerel**2).dim, name="dbecquerel2", dispname=f"{str(dbecquerel)}^2", scale=dbecquerel.scale*2)
dbecquerel3 = Unit.create((dbecquerel**3).dim, name="dbecquerel3", dispname=f"{str(dbecquerel)}^3", scale=dbecquerel.scale*3)
Gbecquerel2 = Unit.create((Gbecquerel**2).dim, name="Gbecquerel2", dispname=f"{str(Gbecquerel)}^2", scale=Gbecquerel.scale*2)
Gbecquerel3 = Unit.create((Gbecquerel**3).dim, name="Gbecquerel3", dispname=f"{str(Gbecquerel)}^3", scale=Gbecquerel.scale*3)
fbecquerel2 = Unit.create((fbecquerel**2).dim, name="fbecquerel2", dispname=f"{str(fbecquerel)}^2", scale=fbecquerel.scale*2)
fbecquerel3 = Unit.create((fbecquerel**3).dim, name="fbecquerel3", dispname=f"{str(fbecquerel)}^3", scale=fbecquerel.scale*3)
hbecquerel2 = Unit.create((hbecquerel**2).dim, name="hbecquerel2", dispname=f"{str(hbecquerel)}^2", scale=hbecquerel.scale*2)
hbecquerel3 = Unit.create((hbecquerel**3).dim, name="hbecquerel3", dispname=f"{str(hbecquerel)}^3", scale=hbecquerel.scale*3)
dabecquerel2 = Unit.create((dabecquerel**2).dim, name="dabecquerel2", dispname=f"{str(dabecquerel)}^2", scale=dabecquerel.scale*2)
dabecquerel3 = Unit.create((dabecquerel**3).dim, name="dabecquerel3", dispname=f"{str(dabecquerel)}^3", scale=dabecquerel.scale*3)
mbecquerel2 = Unit.create((mbecquerel**2).dim, name="mbecquerel2", dispname=f"{str(mbecquerel)}^2", scale=mbecquerel.scale*2)
mbecquerel3 = Unit.create((mbecquerel**3).dim, name="mbecquerel3", dispname=f"{str(mbecquerel)}^3", scale=mbecquerel.scale*3)
nbecquerel2 = Unit.create((nbecquerel**2).dim, name="nbecquerel2", dispname=f"{str(nbecquerel)}^2", scale=nbecquerel.scale*2)
nbecquerel3 = Unit.create((nbecquerel**3).dim, name="nbecquerel3", dispname=f"{str(nbecquerel)}^3", scale=nbecquerel.scale*3)
pbecquerel2 = Unit.create((pbecquerel**2).dim, name="pbecquerel2", dispname=f"{str(pbecquerel)}^2", scale=pbecquerel.scale*2)
pbecquerel3 = Unit.create((pbecquerel**3).dim, name="pbecquerel3", dispname=f"{str(pbecquerel)}^3", scale=pbecquerel.scale*3)
ubecquerel2 = Unit.create((ubecquerel**2).dim, name="ubecquerel2", dispname=f"{str(ubecquerel)}^2", scale=ubecquerel.scale*2)
ubecquerel3 = Unit.create((ubecquerel**3).dim, name="ubecquerel3", dispname=f"{str(ubecquerel)}^3", scale=ubecquerel.scale*3)
Tbecquerel2 = Unit.create((Tbecquerel**2).dim, name="Tbecquerel2", dispname=f"{str(Tbecquerel)}^2", scale=Tbecquerel.scale*2)
Tbecquerel3 = Unit.create((Tbecquerel**3).dim, name="Tbecquerel3", dispname=f"{str(Tbecquerel)}^3", scale=Tbecquerel.scale*3)
ybecquerel2 = Unit.create((ybecquerel**2).dim, name="ybecquerel2", dispname=f"{str(ybecquerel)}^2", scale=ybecquerel.scale*2)
ybecquerel3 = Unit.create((ybecquerel**3).dim, name="ybecquerel3", dispname=f"{str(ybecquerel)}^3", scale=ybecquerel.scale*3)
Ebecquerel2 = Unit.create((Ebecquerel**2).dim, name="Ebecquerel2", dispname=f"{str(Ebecquerel)}^2", scale=Ebecquerel.scale*2)
Ebecquerel3 = Unit.create((Ebecquerel**3).dim, name="Ebecquerel3", dispname=f"{str(Ebecquerel)}^3", scale=Ebecquerel.scale*3)
zbecquerel2 = Unit.create((zbecquerel**2).dim, name="zbecquerel2", dispname=f"{str(zbecquerel)}^2", scale=zbecquerel.scale*2)
zbecquerel3 = Unit.create((zbecquerel**3).dim, name="zbecquerel3", dispname=f"{str(zbecquerel)}^3", scale=zbecquerel.scale*3)
Mbecquerel2 = Unit.create((Mbecquerel**2).dim, name="Mbecquerel2", dispname=f"{str(Mbecquerel)}^2", scale=Mbecquerel.scale*2)
Mbecquerel3 = Unit.create((Mbecquerel**3).dim, name="Mbecquerel3", dispname=f"{str(Mbecquerel)}^3", scale=Mbecquerel.scale*3)
kbecquerel2 = Unit.create((kbecquerel**2).dim, name="kbecquerel2", dispname=f"{str(kbecquerel)}^2", scale=kbecquerel.scale*2)
kbecquerel3 = Unit.create((kbecquerel**3).dim, name="kbecquerel3", dispname=f"{str(kbecquerel)}^3", scale=kbecquerel.scale*3)
Ybecquerel2 = Unit.create((Ybecquerel**2).dim, name="Ybecquerel2", dispname=f"{str(Ybecquerel)}^2", scale=Ybecquerel.scale*2)
Ybecquerel3 = Unit.create((Ybecquerel**3).dim, name="Ybecquerel3", dispname=f"{str(Ybecquerel)}^3", scale=Ybecquerel.scale*3)
...
Ygray2 = Unit.create((Ygray**2).dim, name="Ygray2", dispname=f"{str(Ygray)}^2", scale=Ygray.scale*2)
Ygray3 = Unit.create((Ygray**3).dim, name="Ygray3", dispname=f"{str(Ygray)}^3", scale=Ygray.scale*3)
asievert2 = Unit.create((asievert**2).dim, name="asievert2", dispname=f"{str(asievert)}^2", scale=asievert.scale*2)
asievert3 = Unit.create((asievert**3).dim, name="asievert3", dispname=f"{str(asievert)}^3", scale=asievert.scale*3)
csievert2 = Unit.create((csievert**2).dim, name="csievert2", dispname=f"{str(csievert)}^2", scale=csievert.scale*2)
csievert3 = Unit.create((csievert**3).dim, name="csievert3", dispname=f"{str(csievert)}^3", scale=csievert.scale*3)
Zsievert2 = Unit.create((Zsievert**2).dim, name="Zsievert2", dispname=f"{str(Zsievert)}^2", scale=Zsievert.scale*2)
Zsievert3 = Unit.create((Zsievert**3).dim, name="Zsievert3", dispname=f"{str(Zsievert)}^3", scale=Zsievert.scale*3)
Psievert2 = Unit.create((Psievert**2).dim, name="Psievert2", dispname=f"{str(Psievert)}^2", scale=Psievert.scale*2)
Psievert3 = Unit.create((Psievert**3).dim, name="Psievert3", dispname=f"{str(Psievert)}^3", scale=Psievert.scale*3)
dsievert2 = Unit.create((dsievert**2).dim, name="dsievert2", dispname=f"{str(dsievert)}^2", scale=dsievert.scale*2)
dsievert3 = Unit.create((dsievert**3).dim, name="dsievert3", dispname=f"{str(dsievert)}^3", scale=dsievert.scale*3)
Gsievert2 = Unit.create((Gsievert**2).dim, name="Gsievert2", dispname=f"{str(Gsievert)}^2", scale=Gsievert.scale*2)
Gsievert3 = Unit.create((Gsievert**3).dim, name="Gsievert3", dispname=f"{str(Gsievert)}^3", scale=Gsievert.scale*3)
fsievert2 = Unit.create((fsievert**2).dim, name="fsievert2", dispname=f"{str(fsievert)}^2", scale=fsievert.scale*2)
fsievert3 = Unit.create((fsievert**3).dim, name="fsievert3", dispname=f"{str(fsievert)}^3", scale=fsievert.scale*3)
hsievert2 = Unit.create((hsievert**2).dim, name="hsievert2", dispname=f"{str(hsievert)}^2", scale=hsievert.scale*2)
hsievert3 = Unit.create((hsievert**3).dim, name="hsievert3", dispname=f"{str(hsievert)}^3", scale=hsievert.scale*3)
dasievert2 = Unit.create((dasievert**2).dim, name="dasievert2", dispname=f"{str(dasievert)}^2", scale=dasievert.scale*2)
dasievert3 = Unit.create((dasievert**3).dim, name="dasievert3", dispname=f"{str(dasievert)}^3", scale=dasievert.scale*3)
msievert2 = Unit.create((msievert**2).dim, name="msievert2", dispname=f"{str(msievert)}^2", scale=msievert.scale*2)
msievert3 = Unit.create((msievert**3).dim, name="msievert3", dispname=f"{str(msievert)}^3", scale=msievert.scale*3)
nsievert2 = Unit.create((nsievert**2).dim, name="nsievert2", dispname=f"{str(nsievert)}^2", scale=nsievert.scale*2)
nsievert3 = Unit.create((nsievert**3).dim, name="nsievert3", dispname=f"{str(nsievert)}^3", scale=nsievert.scale*3)
psievert2 = Unit.create((psievert**2).dim, name="psievert2", dispname=f"{str(psievert)}^2", scale=psievert.scale*2)
psievert3 = Unit.create((psievert**3).dim, name="psievert3", dispname=f"{str(psievert)}^3", scale=psievert.scale*3)
usievert2 = Unit.create((usievert**2).dim, name="usievert2", dispname=f"{str(usievert)}^2", scale=usievert.scale*2)
usievert3 = Unit.create((usievert**3).dim, name="usievert3", dispname=f"{str(usievert)}^3", scale=usievert.scale*3)
Tsievert2 = Unit.create((Tsievert**2).dim, name="Tsievert2", dispname=f"{str(Tsievert)}^2", scale=Tsievert.scale*2)
Tsievert3 = Unit.create((Tsievert**3).dim, name="Tsievert3", dispname=f"{str(Tsievert)}^3", scale=Tsievert.scale*3)
ysievert2 = Unit.create((ysievert**2).dim, name="ysievert2", dispname=f"{str(ysievert)}^2", scale=ysievert.scale*2)
ysievert3 = Unit.create((ysievert**3).dim, name="ysievert3", dispname=f"{str(ysievert)}^3", scale=ysievert.scale*3)
Esievert2 = Unit.create((Esievert**2).dim, name="Esievert2", dispname=f"{str(Esievert)}^2", scale=Esievert.scale*2)
Esievert3 = Unit.create((Esievert**3).dim, name="Esievert3", dispname=f"{str(Esievert)}^3", scale=Esievert.scale*3)
zsievert2 = Unit.create((zsievert**2).dim, name="zsievert2", dispname=f"{str(zsievert)}^2", scale=zsievert.scale*2)
zsievert3 = Unit.create((zsievert**3).dim, name="zsievert3", dispname=f"{str(zsievert)}^3", scale=zsievert.scale*3)
Msievert2 = Unit.create((Msievert**2).dim, name="Msievert2", dispname=f"{str(Msievert)}^2", scale=Msievert.scale*2)
Msievert3 = Unit.create((Msievert**3).dim, name="Msievert3", dispname=f"{str(Msievert)}^3", scale=Msievert.scale*3)
ksievert2 = Unit.create((ksievert**2).dim, name="ksievert2", dispname=f"{str(ksievert)}^2", scale=ksievert.scale*2)
ksievert3 = Unit.create((ksievert**3).dim, name="ksievert3", dispname=f"{str(ksievert)}^3", scale=ksievert.scale*3)
Ysievert2 = Unit.create((Ysievert**2).dim, name="Ysievert2", dispname=f"{str(Ysievert)}^2", scale=Ysievert.scale*2)
Ysievert3 = Unit.create((Ysievert**3).dim, name="Ysievert3", dispname=f"{str(Ysievert)}^3", scale=Ysievert.scale*3)
