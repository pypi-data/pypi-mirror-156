...
class Auth(Base):
    ...
    #     self._auth = {}
    #     self._auth[Auth.AUTH_PROP_TYPE] = Auth.AUTH_TYPE_BASIC
    #     self._auth[Auth.AUTH_PROP_USER] = user
    #     self._auth[Auth.AUTH_PROP_PASS] = password

    #def get_password(self) -> str:
    #    return self._properties[Auth.AUTH_PROP_PASS]
