...
def _add_mounted_subparser(
    ...
    # Add a secret API as a mounted file
    mcli create secret mounted --name my-file --value super-secret-api-key-1234
    """)
    generic_mounted_parser = subparser.add_parser(
        'mounted',
        help='Create a secret that will be mounted as a text file',
        description='Add arbitrary confidential information to your workloads as a text file. File-mounted secrets are '
    ...
    generic_mounted_parser.add_argument('--value',
                                        metavar='SECRET',
                                        help='Secret data you\'d like to store at the chosen path')
