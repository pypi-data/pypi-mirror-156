...
class EnvironmentClient(WorkspaceClient):
    ...
    def _register_environment_definition(self, environment_dict):
        ...
        # Set version from definition to register
        # Instead of a new version conflict should happen
        if environment_version is not None:
            environment_url += "/versions/" + str(environment_version)
