...
class _MastodonCommonScraper(src.base.Scraper):
...
class MastodonProfileScraper(_MastodonCommonScraper):
	...
	def _cli_setup_parser(cls, subparser):
		subparser.add_argument('account', type = src.base.nonempty_string('account'), help ='A Mastodon account. This can be either a URL to the profile page or a string of the form @account@instance.example.org')
...
class MastodonTootScraper(_MastodonCommonScraper):
	...
	def _cli_setup_parser(cls, subparser):
		...
		subparser.add_argument('url', type = src.base.nonempty_string('url'), help ='A URL for a toot')
