...
class SceneEngineClient(object):
    ...
    def __init__(
        ...
        """
        FALLBACK_SCENE_ENGINE_URL = "https://scene-engine.demo.scenebox.ai/"
    ...
    def delete_set(
        ...
        resp = self.requests.delete("sets/{}".format(set_id), params=params)
        resp.raise_for_status()
        if wait_for_completion:
    ...
    def add_videos(
        ...
        return bulk_uploader.preprocess_and_upload_bulk(assets=videos,
