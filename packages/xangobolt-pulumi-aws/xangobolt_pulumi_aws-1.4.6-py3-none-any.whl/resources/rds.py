...
def Cluster(stem, props, username=None, password=None, engine=None, engine_version=None, clst_class=None, apply_immediately=None, snetgrp_name=None, optgrp_name=None, secgrp_ids=None, provider=None, parent=None, depends_on=None):
    db_cluster = rds.Cluster(
        ...
        db_cluster_instance_class=clst_class,
        storage_type='io1',
        iops=3000,
        allocated_storage=1500,
        skip_final_snapshot="True",
