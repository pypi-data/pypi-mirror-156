...
def obsidian_shell(
    ...
    if file == '0':
        all.obsidian_simple(configuration, delete_option,
                            git, 1, 0, vault_share)
...
def main():
    """Main function using in CLI Global options :
    ...
    if cmd == 'config':
        ...
        if cmd == 'file':
            ...
            if args.minimal:
                ...
                obsidian_shell(configuration, file_source,
                               meta_update, git=no_git)
                sys.exit()
                ...
                gitt.git_pull(configuration, no_git)
                one.convert_one(file_source, configuration,
                                no_git, meta_update)
            else:
                console.print(
