...
def ListFiles(searchDir: str, callback: _Callable[[str], None] = None, includeDirs=True, includeFilter=None, satisfiedCondition: _Callable[[str], bool] = None, exceptionCallback: _Callable[[Exception], None] = None, maxRecursionDepth: int=None) -> (list[str] | None):
    """
