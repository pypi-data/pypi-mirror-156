...
TASKS = {CLASSIFICATION, REGRESSION, FORECASTING,
         IMAGE_CLASSIFICATION, IMAGE_CLASSIFICATION_MULTILABEL, IMAGE_MULTI_LABEL_CLASSIFICATION,
         IMAGE_OBJECT_DETECTION, IMAGE_INSTANCE_SEGMENTATION,
         TEXT_CLASSIFICATION, TEXT_CLASSIFICATION_MULTILABEL, TEXT_NER}
...
CLASSIFICATION_SCALAR_SET = {
    ...
    AUC_BINARY, AUC_MACRO, AUC_MICRO, AUC_WEIGHTED,
    F1_BINARY, F1_MACRO, F1_MICRO, F1_WEIGHTED,
    PRECISION_BINARY, PRECISION_MACRO, PRECISION_MICRO, PRECISION_WEIGHTED,
    RECALL_BINARY, RECALL_MACRO, RECALL_MICRO, RECALL_WEIGHTED,
    AVERAGE_PRECISION_BINARY, AVERAGE_PRECISION_MACRO, AVERAGE_PRECISION_MICRO, AVERAGE_PRECISION_WEIGHTED,
    MATTHEWS_CORRELATION
}

CLASSIFICATION_BINARY_SET = {
    AUC_BINARY, F1_BINARY, PRECISION_BINARY, RECALL_BINARY, AVERAGE_PRECISION_BINARY
}

CLASSIFICATION_MULTILABEL_SET = {
    IOU, IOU_MICRO, IOU_MACRO, IOU_WEIGHTED
}

CLASSIFICATION_CLASSWISE_SET = {
    PRECISION_CLASSWISE, RECALL_CLASSWISE, F1_CLASSWISE, IOU_CLASSWISE,
    AVERAGE_PRECISION_CLASSWISE, AUC_CLASSWISE
}
...
CLASSIFICATION_SET = (CLASSIFICATION_SCALAR_SET |
                      CLASSIFICATION_NONSCALAR_SET |
                      CLASSIFICATION_CLASSWISE_SET |
                      CLASSIFICATION_MULTILABEL_SET)

UNSUPPORTED_CLASSIFICATION_TABULAR_SET = (CLASSIFICATION_CLASSWISE_SET |
                                          CLASSIFICATION_MULTILABEL_SET |
                                          {CLASSIFICATION_REPORT})
...
TEXT_CLASSIFICATION_SET = {
    ACCURACY, AUC_WEIGHTED, PRECISION_MICRO, PRECISION_WEIGHTED,
}
...
TEXT_NER_SET = {
    ACCURACY, F1_MACRO, F1_MICRO, F1_WEIGHTED, PRECISION_MACRO, PRECISION_MICRO, PRECISION_WEIGHTED,
...
FULL_SCALAR_SET = (CLASSIFICATION_SCALAR_SET |
                   REGRESSION_SCALAR_SET |
                   IMAGE_OBJECT_DETECTION_SCALAR_SET)
