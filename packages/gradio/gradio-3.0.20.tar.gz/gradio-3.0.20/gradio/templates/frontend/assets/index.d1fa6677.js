...
import { M as ModifyUpload } from './ModifyUpload.2a30efde.js';
...
/* home/runner/work/gradio/gradio/ui/packages/icons/src/Music.svelte generated by Svelte v3.47.0 */
...
/* home/runner/work/gradio/gradio/ui/node_modules/.pnpm/svelte-range-slider-pips@2.0.2/node_modules/svelte-range-slider-pips/src/RangePips.svelte generated by Svelte v3.47.0 */
...
/* home/runner/work/gradio/gradio/ui/node_modules/.pnpm/svelte-range-slider-pips@2.0.2/node_modules/svelte-range-slider-pips/src/RangeSlider.svelte generated by Svelte v3.47.0 */
...
/* home/runner/work/gradio/gradio/ui/packages/audio/src/Audio.svelte generated by Svelte v3.47.0 */
...
function create_if_block_4(ctx) {
	...
	function range_values_binding(value) {
		/*range_values_binding*/ ctx[28](value);
	}
...
function create_if_block_3(ctx) {
	...
	function upload_dragging_binding(value) {
		/*upload_dragging_binding*/ ctx[25](value);
	}
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('type' in $$props) $$invalidate(21, type = $$props.type);
...
/* home/runner/work/gradio/gradio/ui/packages/audio/src/StaticAudio.svelte generated by Svelte v3.47.0 */
...
function create_else_block(ctx) {
	...
	staticaudio = new StaticAudio({
			props: {
				...
				value: /*_value*/ ctx[13],
				name: /*_value*/ ctx[13]?.name || "audio_file",
				label: /*label*/ ctx[8]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*show_label*/ 512) staticaudio_changes.show_label = /*show_label*/ ctx[9];
			if (dirty & /*_value*/ 8192) staticaudio_changes.value = /*_value*/ ctx[13];
			if (dirty & /*_value*/ 8192) staticaudio_changes.name = /*_value*/ ctx[13]?.name || "audio_file";
			if (dirty & /*label*/ 256) staticaudio_changes.label = /*label*/ ctx[8];
...
function create_if_block(ctx) {
	...
	audio = new Audio({
			props: {
				...
				drop_text: /*$_*/ ctx[15]("interface.drop_audio"),
				or_text: /*$_*/ ctx[15]("or"),
				upload_text: /*$_*/ ctx[15]("interface.click_to_upload")
			}
		});

	audio.$on("change", /*change_handler*/ ctx[18]);
	audio.$on("stream", /*stream_handler*/ ctx[19]);
	audio.$on("drag", /*drag_handler*/ ctx[20]);
	audio.$on("edit", /*edit_handler*/ ctx[21]);
	audio.$on("play", /*play_handler*/ ctx[22]);
	audio.$on("pause", /*pause_handler*/ ctx[23]);
	audio.$on("ended", /*ended_handler*/ ctx[24]);
	...
	return {
		...
		p(ctx, dirty) {
			const audio_changes = {};
			if (dirty & /*label*/ 256) audio_changes.label = /*label*/ ctx[8];
			if (dirty & /*show_label*/ 512) audio_changes.show_label = /*show_label*/ ctx[9];
			if (dirty & /*_value*/ 8192) audio_changes.value = /*_value*/ ctx[13];
			if (dirty & /*name*/ 32) audio_changes.name = /*name*/ ctx[5];
			if (dirty & /*source*/ 64) audio_changes.source = /*source*/ ctx[6];
			if (dirty & /*type*/ 128) audio_changes.type = /*type*/ ctx[7];
			if (dirty & /*pending*/ 1024) audio_changes.pending = /*pending*/ ctx[10];
			if (dirty & /*streaming*/ 2048) audio_changes.streaming = /*streaming*/ ctx[11];
			if (dirty & /*$_*/ 32768) audio_changes.drop_text = /*$_*/ ctx[15]("interface.drop_audio");
			if (dirty & /*$_*/ 32768) audio_changes.or_text = /*$_*/ ctx[15]("or");
			if (dirty & /*$_*/ 32768) audio_changes.upload_text = /*$_*/ ctx[15]("interface.click_to_upload");
...
// (27:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  {visible}  style={{ rounded: style.rounded }} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				...
				? "dashed"
				: "solid",
				color: /*dragging*/ ctx[14] ? "green" : "grey",
				padding: false,
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*dragging*/ 16384) block_changes.color = /*dragging*/ ctx[14] ? "green" : "grey";
			...
			if (dirty & /*$$scope, label, show_label, _value, name, source, type, pending, streaming, $_, value, dragging, mode, loading_status*/ 33619953) {
...
function instance($$self, $$props, $$invalidate) {
	let $_;
	component_subscribe($$self, X, $$value => $$invalidate(15, $_ = $$value));
	let { style = {} } = $$props;
	const dispatch = createEventDispatcher();
	let { elem_id = "" } = $$props;
	...
	const drag_handler = ({ detail }) => $$invalidate(14, dragging = detail);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*value, root*/ 131073) {
			$$invalidate(13, _value = normalise_file(value, root));
		}
	};
