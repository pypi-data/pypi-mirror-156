...
/* home/runner/work/gradio/gradio/ui/packages/form/src/Checkbox.svelte generated by Svelte v3.47.0 */
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function handle_change(evt) {
		$$invalidate(0, value = evt.target?.checked);
...
function create_default_slot(ctx) {
	...
	checkbox.$on("change", /*change_handler*/ ctx[10]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*show_label*/ 64) checkbox_changes.show_label = /*show_label*/ ctx[6];
			if (dirty & /*style*/ 128) checkbox_changes.style = /*style*/ ctx[7];
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, label, show_label, style, mode, value, loading_status*/ 2521) {
