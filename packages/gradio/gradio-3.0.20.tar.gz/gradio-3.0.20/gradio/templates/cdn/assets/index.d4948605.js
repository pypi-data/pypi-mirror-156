import { S as SvelteComponent, i as init, s as safe_not_equal, f as element, b as attr, t as toggle_class, c as insert, d as append, P as update_slot_base, Q as get_all_dirty_from_scope, R as get_slot_changes, v as transition_in, w as transition_out, e as detach, k as empty, y as group_outros, z as check_outros, A as createEventDispatcher, T as getContext, K as component_subscribe, a6 as onMount, a3 as tick, U as create_slot, q as create_component, u as mount_component, x as destroy_component, F as bubble } from './index.baea847c.js';
import { a as TABS } from './Tabs.852f04b2.js';

/* home/runner/work/gradio/gradio/ui/packages/tabs/src/TabItem.svelte generated by Svelte v3.47.0 */
...
function create_fragment$1(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*$selected_tab*/ ctx[2] === /*id*/ ctx[3] && create_if_block(ctx);
	...
	return {
		...
		p(ctx, [dirty]) {
			if (/*$selected_tab*/ ctx[2] === /*id*/ ctx[3]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*$selected_tab*/ 4) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$selected_tab*/ 4) {
			$selected_tab === id && tick().then(() => dispatch("select"));
		}
	};

	return [elem_id, visible, $selected_tab, id, selected_tab, name, $$scope, slots];
}

class TabItem extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { elem_id: 0, visible: 1, name: 5 });
	}
}
...
function instance($$self, $$props, $$invalidate) {
	...
	return [elem_id, visible, label, slots, select_handler, $$scope];
}

class Tabs extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { elem_id: 0, visible: 1, label: 2 });
	}
}
