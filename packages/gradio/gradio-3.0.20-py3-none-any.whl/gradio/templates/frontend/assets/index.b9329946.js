import { S as SvelteComponent, i as init, s as safe_not_equal, f as element, b as attr, t as toggle_class, c as insert, a2 as set_input_value, l as listen, e as detach, r as run_all, m as space, h as text, d as append, j as set_data, n as noop, F as bubble, D as binding_callbacks, J as bind, q as create_component, u as mount_component, G as add_flush_callback, v as transition_in, w as transition_out, x as destroy_component, A as createEventDispatcher, a3 as tick, a as svg_element, y as group_outros, a4 as update_keyed_each, a5 as outro_and_destroy_block, z as check_outros, L as assign, M as StatusTracker, N as get_spread_update, O as get_spread_object } from './index.99799953.js';
import { g as get_styles } from './styles.db46e346.js';
import { U as Upload } from './Upload.5012c84f.js';
...
/* home/runner/work/gradio/gradio/ui/packages/table/src/EditableCell.svelte generated by Svelte v3.47.0 */
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(input, "keydown", /*keydown_handler*/ ctx[5]),
...
function create_fragment$2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(span, "dblclick", /*dblclick_handler*/ ctx[4]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
...
/* home/runner/work/gradio/gradio/ui/packages/table/src/Table.svelte generated by Svelte v3.47.0 */
...
// (411:6) {#each _headers as { value, id }
function create_each_block_2(key_1, ctx) {
	...
	function editablecell_el_binding(value) {
		/*editablecell_el_binding*/ ctx[31](value, /*id*/ ctx[56]);
	}

	function dblclick_handler() {
		return /*dblclick_handler*/ ctx[32](/*id*/ ctx[56]);
	}

	let editablecell_props = {
		value: /*value*/ ctx[55],
		edit: /*header_edit*/ ctx[12] === /*id*/ ctx[56],
		header: true
	};

	if (/*els*/ ctx[9][/*id*/ ctx[56]].input !== void 0) {
		editablecell_props.el = /*els*/ ctx[9][/*id*/ ctx[56]].input;
	}
	...
	editablecell.$on("keydown", /*end_header_edit*/ ctx[21]);
	editablecell.$on("dblclick", dblclick_handler);

	function click_handler() {
		return /*click_handler*/ ctx[33](/*i*/ ctx[54]);
	}

	const assign_th = () => /*th_binding*/ ctx[34](th, id);
	const unassign_th = () => /*th_binding*/ ctx[34](null, id);
	...
	return {
		...
		c() {
			...
			attr(div0, "class", div0_class_value = "flex flex-none items-center justify-center p-2 cursor-pointer leading-snug transform transition-all " + (/*sort_by*/ ctx[11] !== /*i*/ ctx[54]
			? 'text-gray-200 hover:text-gray-500'
			: 'text-orange-500') + " " + (/*sort_by*/ ctx[11] === /*i*/ ctx[54] && /*sort_direction*/ ctx[10] === 'des'
			? '-scale-y-[1]'
			: ''));

			toggle_class(div0, "text-gray-200", /*sort_by*/ ctx[11] !== /*i*/ ctx[54]);
			attr(div1, "class", "min-h-[2.3rem] flex outline-none");
			attr(th, "class", th_class_value = "p-0 relative focus-within:ring-1 ring-orange-500 ring-inset outline-none " + /*classes*/ ctx[14]);
			attr(th, "aria-sort", th_aria_sort_value = /*get_sort_status*/ ctx[15](/*value*/ ctx[55], /*sort_by*/ ctx[11], /*sort_direction*/ ctx[10]));
			toggle_class(th, "bg-orange-50", /*header_edit*/ ctx[12] === /*id*/ ctx[56]);
			toggle_class(th, "dark:bg-transparent", /*header_edit*/ ctx[12] === /*id*/ ctx[56]);
			toggle_class(th, "rounded-tl-lg", /*i*/ ctx[54] === 0);
			toggle_class(th, "rounded-tr-lg", /*i*/ ctx[54] === /*_headers*/ ctx[7].length - 1);
			this.first = th;
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*_headers*/ 128) editablecell_changes.value = /*value*/ ctx[55];
			if (dirty[0] & /*header_edit, _headers*/ 4224) editablecell_changes.edit = /*header_edit*/ ctx[12] === /*id*/ ctx[56];

			if (!updating_el && dirty[0] & /*els, _headers*/ 640) {
				updating_el = true;
				editablecell_changes.el = /*els*/ ctx[9][/*id*/ ctx[56]].input;
				add_flush_callback(() => updating_el = false);
			}

			editablecell.$set(editablecell_changes);

			if (!current || dirty[0] & /*sort_by, _headers, sort_direction*/ 3200 && div0_class_value !== (div0_class_value = "flex flex-none items-center justify-center p-2 cursor-pointer leading-snug transform transition-all " + (/*sort_by*/ ctx[11] !== /*i*/ ctx[54]
			? 'text-gray-200 hover:text-gray-500'
			: 'text-orange-500') + " " + (/*sort_by*/ ctx[11] === /*i*/ ctx[54] && /*sort_direction*/ ctx[10] === 'des'
			? '-scale-y-[1]'
			: ''))) {
			...
			if (dirty[0] & /*sort_by, _headers, sort_direction, sort_by, _headers*/ 3200) {
				toggle_class(div0, "text-gray-200", /*sort_by*/ ctx[11] !== /*i*/ ctx[54]);
			}

			if (!current || dirty[0] & /*classes*/ 16384 && th_class_value !== (th_class_value = "p-0 relative focus-within:ring-1 ring-orange-500 ring-inset outline-none " + /*classes*/ ctx[14])) {
				attr(th, "class", th_class_value);
			}

			if (!current || dirty[0] & /*_headers, sort_by, sort_direction*/ 3200 && th_aria_sort_value !== (th_aria_sort_value = /*get_sort_status*/ ctx[15](/*value*/ ctx[55], /*sort_by*/ ctx[11], /*sort_direction*/ ctx[10]))) {
			...
			if (dirty[0] & /*classes, header_edit, _headers*/ 20608) {
				toggle_class(th, "bg-orange-50", /*header_edit*/ ctx[12] === /*id*/ ctx[56]);
			}
			...
			if (dirty[0] & /*classes, _headers*/ 16512) {
				toggle_class(th, "rounded-tl-lg", /*i*/ ctx[54] === 0);
			}
...
function create_each_block_1(key_1, ctx) {
	...
	function editablecell_value_binding(value) {
		/*editablecell_value_binding*/ ctx[35](value, /*value*/ ctx[55], /*each_value_1*/ ctx[57], /*j*/ ctx[58]);
	}

	function editablecell_el_binding_1(value) {
		/*editablecell_el_binding_1*/ ctx[36](value, /*id*/ ctx[56]);
	}

	let editablecell_props = {
		edit: /*editing*/ ctx[5] === /*id*/ ctx[56]
	};

	if (/*value*/ ctx[55] !== void 0) {
		editablecell_props.value = /*value*/ ctx[55];
	}
	...
	const assign_td = () => /*td_binding*/ ctx[37](td, id);
	const unassign_td = () => /*td_binding*/ ctx[37](null, id);

	function touchstart_handler() {
		return /*touchstart_handler*/ ctx[38](/*id*/ ctx[56]);
	}

	function click_handler_1() {
		return /*click_handler_1*/ ctx[39](/*id*/ ctx[56]);
	}

	function dblclick_handler_1() {
		return /*dblclick_handler_1*/ ctx[40](/*id*/ ctx[56]);
	}

	function keydown_handler(...args) {
		return /*keydown_handler*/ ctx[41](/*i*/ ctx[54], /*j*/ ctx[58], /*id*/ ctx[56], ...args);
	}
	...
	return {
		...
		c() {
			...
			toggle_class(div, "border-transparent", /*selected*/ ctx[6] !== /*id*/ ctx[56]);
			attr(td, "tabindex", "0");
			attr(td, "class", td_class_value = "outline-none focus-within:ring-1 ring-orange-500 ring-inset focus-within:bg-orange-50 dark:focus-within:bg-gray-800 group-last:first:rounded-bl-lg group-last:last:rounded-br-lg relative " + /*classes*/ ctx[14]);
			this.first = td;
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const editablecell_changes = {};
			if (dirty[0] & /*editing, data*/ 288) editablecell_changes.edit = /*editing*/ ctx[5] === /*id*/ ctx[56];

			if (!updating_value && dirty[0] & /*data*/ 256) {
				updating_value = true;
				editablecell_changes.value = /*value*/ ctx[55];
				add_flush_callback(() => updating_value = false);
			}

			if (!updating_el && dirty[0] & /*els, data*/ 768) {
				updating_el = true;
				editablecell_changes.el = /*els*/ ctx[9][/*id*/ ctx[56]].input;
				add_flush_callback(() => updating_el = false);
			}
			...
			if (dirty[0] & /*selected, data*/ 320) {
				toggle_class(div, "border-transparent", /*selected*/ ctx[6] !== /*id*/ ctx[56]);
			}

			if (!current || dirty[0] & /*classes*/ 16384 && td_class_value !== (td_class_value = "outline-none focus-within:ring-1 ring-orange-500 ring-inset focus-within:bg-orange-50 dark:focus-within:bg-gray-800 group-last:first:rounded-bl-lg group-last:last:rounded-br-lg relative " + /*classes*/ ctx[14])) {
...
function create_each_block(key_1, ctx) {
	...
	let t;
	let current;
	let each_value_1 = /*row*/ ctx[52];
	const get_key = ctx => /*id*/ ctx[56];
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*classes, els, data, start_edit, handle_cell_click, handle_keydown, selected, editing*/ 476000) {
				each_value_1 = /*row*/ ctx[52];
				group_outros();
...
// (392:2) <Upload    flex={false}    center={false}    boundedheight={false}    click={false}    on:load={(e) => blob_to_string(data_uri_to_blob(e.detail.data))}    bind:dragging   >
function create_default_slot(ctx) {
	...
	let current;
	let if_block = /*label*/ ctx[0] && /*label*/ ctx[0].length !== 0 && create_if_block_3(ctx);
	let each_value_2 = /*_headers*/ ctx[7];
	const get_key = ctx => /*id*/ ctx[56];
	...
	const get_key_1 = ctx => /*row*/ ctx[52];
	...
	return {
		c() {
			...
			toggle_class(table, "opacity-40", /*dragging*/ ctx[13]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (/*label*/ ctx[0] && /*label*/ ctx[0].length !== 0) {
				if (if_block) {
					if_block.p(ctx, dirty);
				} else {
			...
			if (dirty[0] & /*classes, get_sort_status, _headers, sort_by, sort_direction, els, header_edit, handle_sort, end_header_edit, edit_header*/ 3726976) {
				each_value_2 = /*_headers*/ ctx[7];
				group_outros();
			...
			if (dirty[0] & /*data, classes, els, start_edit, handle_cell_click, handle_keydown, selected, editing*/ 476000) {
...
function create_if_block(ctx) {
	let div;
	let t;
	let if_block0 = /*row_count*/ ctx[2][1] === "dynamic" && create_if_block_2(ctx);
	let if_block1 = /*col_count*/ ctx[1][1] === "dynamic" && create_if_block_1(ctx);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*click_handler_2*/ ctx[44]);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*add_col*/ ctx[23]);
				mounted = true;
			}
		},
		p: noop,
...
function create_fragment$1(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*label*/ ctx[0] && /*label*/ ctx[0].length !== 0 && create_if_block_4(ctx);

	function upload_dragging_binding(value) {
		/*upload_dragging_binding*/ ctx[42](value);
	}
	...
	upload.$on("load", /*load_handler*/ ctx[43]);
	let if_block1 = /*editable*/ ctx[3] && create_if_block(ctx);
	...
	return {
		c() {
			...
			t1 = space();
			if (if_block1) if_block1.c();
			attr(div0, "class", div0_class_value = "scroll-hide overflow-hidden rounded-lg relative border transition-colors overflow-x-scroll " + /*classes*/ ctx[14]);
			toggle_class(div0, "border-green-400", /*dragging*/ ctx[13]);
			toggle_class(div0, "whitespace-nowrap", !/*wrap*/ ctx[4]);
			toggle_class(div1, "mt-6", /*label*/ ctx[0] && /*label*/ ctx[0].length !== 0);
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(window, "click", /*handle_click_outside*/ ctx[24]),
					listen(window, "touchstart", /*handle_click_outside*/ ctx[24])
				];
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*dragging, data, classes, els, selected, editing, _headers, sort_by, sort_direction, header_edit, label*/ 32737 | dirty[1] & /*$$scope*/ 536870912) {
				upload_changes.$$scope = { dirty, ctx };
			}

			if (!updating_dragging && dirty[0] & /*dragging*/ 8192) {
			...
			if (!current || dirty[0] & /*classes*/ 16384 && div0_class_value !== (div0_class_value = "scroll-hide overflow-hidden rounded-lg relative border transition-colors overflow-x-scroll " + /*classes*/ ctx[14])) {
				attr(div0, "class", div0_class_value);
			}

			if (dirty[0] & /*classes, dragging*/ 24576) {
				toggle_class(div0, "border-green-400", /*dragging*/ ctx[13]);
			}

			if (dirty[0] & /*classes, wrap*/ 16400) {
				toggle_class(div0, "whitespace-nowrap", !/*wrap*/ ctx[4]);
			}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function make_headers(_head) {
		...
		if (!_h || _h.length === 0) {
			return Array(col_count[0]).fill(0).map((_, i) => {
				const _id = `h-${i}`;
				$$invalidate(9, els[_id] = { cell: null, input: null }, els);
	...
	function process_data(_values) {
		...
		: _values[0].length).fill(0).map((n, j) => {
			const id = `${i}-${j}`;
			$$invalidate(9, els[id] = { input: null, cell: null }, els);
	...
	async function start_edit(id, clear) {
		...
		if (clear) {
			...
			$$invalidate(8, data[i][j].value = "", data);
		}

		$$invalidate(5, editing = id);
		await tick();
		const { input } = els[id];
		input?.focus();
	}
	...
	async function handle_keydown(event, i, j, id) {
		...
		switch (event.key) {
			case "ArrowRight":
				...
				is_data = data[i][j + 1];
				$$invalidate(6, selected = is_data ? is_data.id : selected);
				break;
			case "ArrowLeft":
				if (editing) break;
				event.preventDefault();
			...
			case "ArrowDown":
				...
				event.preventDefault();
				is_data = data[i + 1];
				$$invalidate(6, selected = is_data ? is_data[j].id : selected);
				break;
			case "ArrowUp":
				if (editing) break;
				event.preventDefault();
			...
			case "Enter":
				...
				if (event.shiftKey) {
					...
					$$invalidate(6, selected = data[pos + 1][j].id);
				} else {
					if (editing === id) {
						$$invalidate(5, editing = false);
					} else {
			...
			case "Tab":
				...
				if (_selected) {
					event.preventDefault();
					$$invalidate(6, selected = _selected ? _selected.id : selected);
				}
				$$invalidate(5, editing = false);
				break;
			default:
	...
	function sort(col, dir) {
		if (dir === "asc") {
			$$invalidate(8, data = data.sort((a, b) => a[col].value < b[col].value ? -1 : 1));
		} else if (dir === "des") {
			$$invalidate(8, data = data.sort((a, b) => a[col].value > b[col].value ? -1 : 1));
		}
	}
	...
	function handle_sort(col) {
		if (typeof sort_by !== "number" || sort_by !== col) {
			$$invalidate(10, sort_direction = "asc");
			$$invalidate(11, sort_by = col);
		} else {
			if (sort_direction === "asc") {
				$$invalidate(10, sort_direction = "des");
	...
	function end_header_edit(event) {
		...
		switch (event.key) {
			case "Escape":
				event.preventDefault();
				$$invalidate(6, selected = header_edit);
				$$invalidate(12, header_edit = false);
				break;
			case "Enter":
				event.preventDefault();
				$$invalidate(6, selected = header_edit);
	...
	function add_row(index) {
		...
		(($$invalidate(8, data), $$invalidate(26, values)), $$invalidate(30, old_val));
	}
	...
	async function add_col() {
		...
		(($$invalidate(8, data), $$invalidate(26, values)), $$invalidate(30, old_val));
		(($$invalidate(7, _headers), $$invalidate(27, headers)), $$invalidate(29, old_headers));
		await tick();
	...
	function blob_to_string(blob) {
		...
		function handle_read(e) {
			...
			$$invalidate(7, _headers = make_headers(col_count[1] === "fixed"
			? head.slice(0, col_count[0])
			: head));

			$$invalidate(26, values = rest);
	...
	$$self.$$set = $$props => {
		...
		if ('values' in $$props) $$invalidate(26, values = $$props.values);
		if ('col_count' in $$props) $$invalidate(1, col_count = $$props.col_count);
		if ('row_count' in $$props) $$invalidate(2, row_count = $$props.row_count);
		if ('editable' in $$props) $$invalidate(3, editable = $$props.editable);
		if ('style' in $$props) $$invalidate(28, style = $$props.style);
		if ('wrap' in $$props) $$invalidate(4, wrap = $$props.wrap);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*headers, old_headers*/ 671088640) {
			{
				if (!dequal(headers, old_headers)) {
					$$invalidate(7, _headers = make_headers(headers));
					$$invalidate(29, old_headers = headers);
					refresh_focus();
				}
			}
		}

		if ($$self.$$.dirty[0] & /*values, old_val*/ 1140850688) {
			if (!dequal(values, old_val)) {
				$$invalidate(8, data = process_data(values));
				$$invalidate(30, old_val = values);
				refresh_focus();
			}
		}

		if ($$self.$$.dirty[0] & /*_headers, data*/ 384) {
			_headers && dispatch("change", data.map(r => r.map(({ value }) => value)));
		}

		if ($$self.$$.dirty[0] & /*editing*/ 32) {
		...
		if ($$self.$$.dirty[0] & /*style*/ 268435456) {
			$$invalidate(14, { classes } = get_styles(style, ["rounded"]), classes);
		}
	};
...
function create_fragment(ctx) {
	...
	table.$on("change", /*handle_change*/ ctx[12]);
		...
		if ($$self.$$.dirty & /*value, headers*/ 3) {
			{
				if (value && !Array.isArray(value)) {
					...
					$$invalidate(1, value = [Array(headers.length).fill("")]);
				} else {
