import { S as SvelteComponent, i as init, s as safe_not_equal, f as element, h as text, b as attr, c as insert, d as append, j as set_data, n as noop, e as detach, k as empty, a6 as onMount, D as binding_callbacks, H as src_url_equal, l as listen, g as is_function, r as run_all, m as space, o as destroy_each, t as toggle_class, v as transition_in, w as transition_out, A as createEventDispatcher, y as group_outros, x as destroy_component, z as check_outros, q as create_component, u as mount_component } from './index.99799953.js';
import { E as ExampleImage } from './Image.0def2f87.js';
import { E as ExampleModel3D } from './Model3D.dde7367c.js';
...
function create_else_block_1(ctx) {
	...
	let each_value_2 = /*selected_samples*/ ctx[9];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*value, page, samples_per_page, dispatch, selected_samples, components, theme, samples_dir*/ 3811) {
				each_value_2 = /*selected_samples*/ ctx[9];
				let i;
...
function create_if_block_2(ctx) {
	let div;
	let current;
	let each_value_1 = /*selected_samples*/ ctx[9];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*value, page, samples_per_page, dispatch, components, theme, selected_samples, samples_dir*/ 3811) {
				each_value_1 = /*selected_samples*/ ctx[9];
				let i;
...
// (109:7) {#each sample_row as sample_cell, j}
function create_each_block_3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*theme*/ 64) switch_instance_changes.theme = /*theme*/ ctx[6];
			if (dirty[0] & /*selected_samples*/ 512) switch_instance_changes.value = /*sample_cell*/ ctx[27];
...
// (101:5) {#each selected_samples as sample_row, i}
function create_each_block_2(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*components, theme, selected_samples, samples_dir*/ 2626) {
...
// (69:3) {#each selected_samples as sample_row, i}
function create_each_block_1(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			const switch_instance_changes = {};
			if (dirty[0] & /*theme*/ 64) switch_instance_changes.theme = /*theme*/ ctx[6];
			if (dirty[0] & /*selected_samples*/ 512) switch_instance_changes.value = /*sample_row*/ ctx[23][0];
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*visible_pages, page*/ 384) {
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			t0 = text(t0_value);
			t1 = space();
			toggle_class(button, "font-bold", /*page*/ ctx[7] === /*visible_page*/ ctx[20]);
		},
		m(target, anchor) {
			insert(target, button, anchor);
			append(button, t0);
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*page, visible_pages*/ 384) {
				toggle_class(button, "font-bold", /*page*/ ctx[7] === /*visible_page*/ ctx[20]);
			}
		},
		d(detaching) {
...
// (129:2) {#each visible_pages as visible_page}
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*samples, page, samples_per_page, page_count, visible_pages*/ 82336) {
			{
				if (paginate) {
					$$invalidate(8, visible_pages = []);
					$$invalidate(9, selected_samples = samples.slice(page * samples_per_page, (page + 1) * samples_per_page));
					...
					$$invalidate(9, selected_samples = samples.slice());
				}
			}
		}
	};
