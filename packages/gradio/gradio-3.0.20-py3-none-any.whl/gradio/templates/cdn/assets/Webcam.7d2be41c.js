import { S as SvelteComponent, i as init, s as safe_not_equal, a as svg_element, b as attr, c as insert, d as append, n as noop, e as detach, f as element, l as listen, g as is_function, y as group_outros, w as transition_out, z as check_outros, v as transition_in, m as space, A as createEventDispatcher, a6 as onMount, q as create_component, u as mount_component, x as destroy_component, k as empty, D as binding_callbacks } from './index.baea847c.js';

/* home/runner/work/gradio/gradio/ui/packages/icons/src/Camera.svelte generated by Svelte v3.47.0 */
...
/* home/runner/work/gradio/gradio/ui/packages/icons/src/Circle.svelte generated by Svelte v3.47.0 */
...
/* home/runner/work/gradio/gradio/ui/packages/icons/src/Square.svelte generated by Svelte v3.47.0 */
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(svg, "stroke-linecap", "round");
			attr(svg, "stroke-linejoin", "round");
			attr(svg, "class", "feather feather-square");
		},
		m(target, anchor) {
			insert(target, svg, anchor);
			append(svg, rect);
...
/* home/runner/work/gradio/gradio/ui/packages/image/src/Webcam.svelte generated by Svelte v3.47.0 */
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			if_block.c();
			attr(button, "class", "rounded-xl w-10 h-10 flex justify-center items-center absolute inset-x-0 bottom-2 md:bottom-4 xl:bottom-8 m-auto drop-shadow-lg bg-black/90");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", function () {
					...
					? /*take_picture*/ ctx[4]
					: /*take_recording*/ ctx[5])) (/*mode*/ ctx[1] === "image"
					? /*take_picture*/ ctx[4]
					: /*take_recording*/ ctx[5]).apply(this, arguments);
				});
...
function create_else_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "w-2/4 h-2/4 text-white opacity-80");
		},
		m(target, anchor) {
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "w-2/4 h-2/4 dark:text-white opacity-80");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_fragment(ctx) {
	...
	let t;
	let current;
	let if_block = !/*streaming*/ ctx[0] && create_if_block(ctx);
	...
	return {
		c() {
			...
			attr(video, "class", "h-full w-full ");
			attr(div, "class", "h-full min-h-[15rem] w-full relative");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, video);
...
function instance($$self, $$props, $$invalidate) {
	...
	async function access_webcam() {
		try {
			...
			$$invalidate(2, video_source.srcObject = stream, video_source);
			video_source.play();
		} catch(error) {
			console.error(error);
		}
	...
	function take_recording() {
		...
		$$invalidate(3, recording = !recording);
	}
	...
	function video_binding($$value) {
		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
			video_source = $$value;
			$$invalidate(2, video_source);
		});
	}

	$$self.$$set = $$props => {
		if ('streaming' in $$props) $$invalidate(0, streaming = $$props.streaming);
		if ('pending' in $$props) $$invalidate(6, pending = $$props.pending);
...
class Webcam extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { streaming: 0, pending: 6, mode: 1 });
	}
}

export { Cropper as C, Webcam as W, index as i };
