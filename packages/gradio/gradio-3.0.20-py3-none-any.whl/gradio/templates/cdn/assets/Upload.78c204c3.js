import { S as SvelteComponent, i as init, s as safe_not_equal, U as create_slot, f as element, m as space, b as attr, t as toggle_class, c as insert, d as append, l as listen, V as stop_propagation, p as prevent_default, P as update_slot_base, Q as get_all_dirty_from_scope, R as get_slot_changes, v as transition_in, w as transition_out, e as detach, r as run_all, A as createEventDispatcher, F as bubble, D as binding_callbacks } from './index.baea847c.js';

/* home/runner/work/gradio/gradio/ui/packages/upload/src/Upload.svelte generated by Svelte v3.47.0 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", div_class_value = "w-full cursor-pointer h-full items-center justify-center text-gray-400 md:text-xl " + (/*boundedheight*/ ctx[2]
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(input, "change", /*loadFilesFromUpload*/ ctx[9]),
					listen(div, "drag", stop_propagation(prevent_default(/*drag_handler*/ ctx[16]))),
					listen(div, "dragstart", stop_propagation(prevent_default(/*dragstart_handler*/ ctx[17]))),
					listen(div, "dragend", stop_propagation(prevent_default(/*dragend_handler*/ ctx[18]))),
					listen(div, "dragover", stop_propagation(prevent_default(/*dragover_handler*/ ctx[19]))),
					listen(div, "dragenter", stop_propagation(prevent_default(/*dragenter_handler*/ ctx[20]))),
					listen(div, "dragleave", stop_propagation(prevent_default(/*dragleave_handler*/ ctx[21]))),
					listen(div, "drop", stop_propagation(prevent_default(/*drop_handler*/ ctx[22]))),
					listen(div, "click", /*openFileUpload*/ ctx[8]),
					listen(div, "drop", /*loadFilesFromDrop*/ ctx[10]),
					listen(div, "dragenter", /*updateDragging*/ ctx[7]),
					listen(div, "dragleave", /*updateDragging*/ ctx[7])
				];
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('include_file_metadata' in $$props) $$invalidate(12, include_file_metadata = $$props.include_file_metadata);
		...
		if ('click' in $$props) $$invalidate(13, click = $$props.click);
