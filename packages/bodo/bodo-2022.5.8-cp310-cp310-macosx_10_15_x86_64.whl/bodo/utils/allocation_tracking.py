...
def get_allocation_stats():
    lcdeb__mhyjt = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    zerjr__gfdb, slqjy__daun, rtd__icpkd, wtfp__kkk = 0, 0, 0, 0
    for rmz__evgi in lcdeb__mhyjt:
        zerjr__gfdb += rmz__evgi[0]
        slqjy__daun += rmz__evgi[1]
        rtd__icpkd += rmz__evgi[2]
        wtfp__kkk += rmz__evgi[3]
    return zerjr__gfdb, slqjy__daun, rtd__icpkd, wtfp__kkk
