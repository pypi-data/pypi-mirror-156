...
class TExecRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        _elem131 = TAccessEvent()
                        _elem131.read(iprot)
                        self.access_events.append(_elem131)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i136 in range(_size132):
                        ...
                        self.analysis_warnings.append(_elem137)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
    ...
    def write(self, oprot):
        ...
        if self.access_events is not None:
            ...
            for iter138 in self.access_events:
                iter138.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.analysis_warnings is not None:
            ...
            for iter139 in self.analysis_warnings:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i144 in range(_size140):
                        _elem145 = Types.ttypes.TColumnType()
                        _elem145.read(iprot)
                        self.arg_types.append(_elem145)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class TUpdateCatalogCacheRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i151 in range(_size147):
                        _elem152 = CatalogObjects.ttypes.TCatalogObject()
                        _elem152.read(iprot)
                        self.updated_objects_deprecated.append(_elem152)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i157 in range(_size153):
                        _elem158 = CatalogObjects.ttypes.TCatalogObject()
                        _elem158.read(iprot)
                        self.removed_objects_deprecated.append(_elem158)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.updated_objects_deprecated is not None:
            ...
            for iter159 in self.updated_objects_deprecated:
                iter159.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.removed_objects_deprecated is not None:
            ...
            for iter160 in self.removed_objects_deprecated:
                iter160.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TExecutorGroupSet(object):
    ...
    def __init__(self, curr_num_executors=0, expected_num_executors=0, exec_group_name_prefix=None, max_mem_limit=None,):
...
class TUpdateExecutorMembershipRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i171 in range(_size167):
                        ...
                        self.ip_addresses.add(_elem172)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i177 in range(_size173):
                        _elem178 = TExecutorGroupSet()
                        _elem178.read(iprot)
                        self.exec_group_sets.append(_elem178)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ip_addresses is not None:
            ...
            for iter180 in self.ip_addresses:
        ...
        if self.exec_group_sets is not None:
            ...
            for iter181 in self.exec_group_sets:
                iter181.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetJvmMemoryMetricsResponse(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i186 in range(_size182):
                        _elem187 = TJvmMemoryPool()
                        _elem187.read(iprot)
                        self.memory_pools.append(_elem187)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.memory_pools is not None:
            ...
            for iter188 in self.memory_pools:
                iter188.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i193 in range(_size189):
                        _elem194 = TJvmThreadInfo()
                        _elem194.read(iprot)
                        self.threads.append(_elem194)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetAllHadoopConfigsResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.configs is not None:
            ...
            for kiter203, viter204 in self.configs.items():
...
class TBuildTestDescriptorTableParams(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i216 in range(_size212):
                        ...
                        for _i222 in range(_size218):
                            _elem223 = Types.ttypes.TColumnType()
                            _elem223.read(iprot)
                            _elem217.append(_elem223)
                        iprot.readListEnd()
                        self.slot_types.append(_elem217)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.slot_types is not None:
            ...
            for iter224 in self.slot_types:
                oprot.writeListBegin(TType.STRUCT, len(iter224))
                for iter225 in iter224:
                    iter225.write(oprot)
                oprot.writeListEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TTestCaseData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i230 in range(_size226):
                        _elem231 = CatalogObjects.ttypes.TTable()
                        _elem231.read(iprot)
                        self.tables_and_views.append(_elem231)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i236 in range(_size232):
                        _elem237 = CatalogObjects.ttypes.TDatabase()
                        _elem237.read(iprot)
                        self.dbs.append(_elem237)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.tables_and_views is not None:
            ...
            for iter238 in self.tables_and_views:
                iter238.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dbs is not None:
...
class TWrappedHttpRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.params is not None:
            ...
            for kiter261, viter262 in self.params.items():
        ...
        if self.headers is not None:
            ...
            for kiter263, viter264 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            for kiter265, viter266 in self.cookies.items():
...
class TWrappedHttpResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.headers is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.headers))
            for kiter281, viter282 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.cookies))
            for kiter283, viter284 in self.cookies.items():
