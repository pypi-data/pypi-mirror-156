    ...
    **Autogenerated function**
    ...
    if before and before["result"]:
        ...
        if tags is not None and tags != result["old_state"].get("tags"):
            ...
            update_tags_result = await hub.exec.aws.dynamodb.tag.update_tags(
                ...
                old_tags=hub.tool.aws.tag_utils.convert_tag_list_to_dict(existing_tags)
                if existing_tags
                else {},
                new_tags=tags,
            )
        ...
        try:
            ...
            existing_tags = hub.tool.aws.tag_utils.convert_tag_dict_to_list(tags)
    ...
    if ctx.get("test", False):
        ...
        if are_tags_updated:
            ...
            if tags_ret.get("result") and tags_ret.get("ret"):
                final_updated_tags = tags_ret.get("ret").get("Tags")
        result[
            "new_state"
        ] = hub.tool.aws.dynamodb.conversion_utils.convert_raw_dynamodb_table_to_present(
