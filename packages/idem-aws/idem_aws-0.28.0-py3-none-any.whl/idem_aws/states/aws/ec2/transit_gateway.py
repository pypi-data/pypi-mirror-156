    ...
    **Autogenerated function**
    ...
    Args:
        ...
        options(dictionary, optional): Options about transit gateway
             ...
             *  AutoAcceptSharedAttachments (Text) -- 'Enable or disable automatic acceptance of attachment requests. Disabled by default.
             *  DefaultRouteTableAssociation (Text) -- Enable or disable automatic association with the default association route table. Enabled by default.,
             *  DefaultRouteTablePropagation (Text) -- Enable or disable automatic propagation of routes to the default propagation route table. Enabled by default.,
             *  VpnEcmpSupport (Text) -- Enable or disable Equal Cost Multipath Protocol support. Enabled by default.,
             *  DnsSupport (Text) -- Enable or disable DNS support. Enabled by default.,
             *  MulticastSupport (Text) -- Indicates whether multicast is enabled on the transit gateway,
        ...
        tags(List or Dict, optional): list of tags to assign to Transit gateway in the format of [{"Key": tag-key, "Value": tag-value}] or dict in the format of
    ...
    if resource_id:
        before = await hub.exec.aws.ec2.transit_gateway.get_transit_gateway_by_id(
            ctx, resource_id
        )
