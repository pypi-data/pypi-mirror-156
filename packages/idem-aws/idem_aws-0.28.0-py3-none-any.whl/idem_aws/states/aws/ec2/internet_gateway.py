...
async def present(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        tags(List or Dict, Optional): The tags to apply to the resource. List of tags in the format of [{"Key": tag-key, "Value": tag-value}] or dict in the format of
            {tag-key: tag-value}
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    **Autogenerated function**
    ...
    for internet_gateway in ret["ret"]["InternetGateways"]:
        ...
        result[resource_id] = {"aws.ec2.internet_gateway.present": [resource_converted]}
    return result
