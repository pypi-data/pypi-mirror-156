...
async def present(
    ...
    *,
    launch_specification: Dict[str, Any] = None,
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        launch_specification(Dict[str, Any]): The launch specification.
        ...
        tags(List or Dict, optional):
            The tags to assign to the VPC. Defaults to None.
            ...
            * Value (Text) -- The value of the tag. Tag values are case-sensitive
