...
async def present(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        tags(List or Dict, optional): The tags to assign to dhcp option resource. Defaults to None.
    ...
    if before:
        convert_ret = (
            await hub.tool.aws.ec2.conversion_utils.convert_raw_dhcp_to_present(
