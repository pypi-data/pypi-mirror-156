    ...
    **Autogenerated function**
    ...
    Args:
        ...
        tags(List or Dict, optional): list of tags in the format of [{"Key": tag-key, "Value": tag-value}] or dict in the format of
                                      {tag-key: tag-value} The tags to assign to the service_linked_role. Defaults to None.
    Request Syntax:
    ...
    if ctx.get("test", False):
        ...
        created_resource = hub.tool.boto3.resource.create(ctx, "iam", "Role", role_name)
...
async def absent(
    ...
    **Autogenerated function**
    ...
    result = dict(comment=(), old_state=None, new_state=None, name=name, result=True)
    resource_id = resource_id if resource_id else name
    resource = hub.tool.boto3.resource.create(ctx, "iam", "Role", resource_id)
    before = await hub.tool.boto3.resource.describe(resource)
    ...
    if not before:
        ...
        try:
            ...
            cluster_waiter = hub.tool.boto3.custom_waiter.waiter_wrapper(
                ...
                client=hub.tool.boto3.client.get_client(ctx, "iam"),
            )
