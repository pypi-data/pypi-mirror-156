    ...
    **Autogenerated function**
    ...
    Args:
        ...
        tags(List or Dict, optional): A List of tags in the format of [{"Key": tag-key, "Value": tag-value}] or Dict in the format of
            {tag-key: tag-value}. For more information about tagging, see Tagging IAM resources in the IAM User
    ...
    if before:
        ...
        update_ret = await hub.exec.aws.iam.user.update_user(
        ...
        if tags is not None and tags != before.get("Tags", None):
            # Update tags
            update_ret = await hub.exec.aws.iam.user.update_user_tags(
                ctx,
...
async def absent(hub, ctx, name: str, resource_id: str) -> Dict[str, Any]:
    ...
    **Autogenerated function**
    ...
    """
    result = dict(comment=(), old_state=None, new_state=None, name=name, result=True)
    resource = hub.tool.boto3.resource.create(ctx, SERVICE, RESOURCE, resource_id)
    before = await hub.tool.boto3.resource.describe(resource)
