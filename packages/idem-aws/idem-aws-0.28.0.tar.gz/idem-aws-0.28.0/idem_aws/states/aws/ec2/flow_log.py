...
async def present(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        tags(Dict, Optional): list of tags in the format of [{"Key": tag-key, "Value": tag-value}] or dict in the format of
            {tag-key: tag-value}
    ...
    if isinstance(tags, List):
        ...
        tags_dict = tags
    if before and before["result"] and before["ret"].get("FlowLogs"):
        result[
            "old_state"
        ] = hub.tool.aws.ec2.conversion_utils.convert_raw_flow_log_to_present(
            before["ret"]["FlowLogs"][0]
        )
