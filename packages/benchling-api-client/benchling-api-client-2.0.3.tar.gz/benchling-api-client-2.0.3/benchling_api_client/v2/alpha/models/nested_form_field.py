...
from ..models.form_definition_leaf import FormDefinitionLeaf
...
class NestedFormField:
    ...
    _definition: Union[Unset, FormDefinitionLeaf] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_definition() -> Union[Unset, FormDefinitionLeaf]:
            definition: Union[Unset, FormDefinitionLeaf] = UNSET
            _definition = d.pop("definition")
            if not isinstance(_definition, Unset):
                definition = FormDefinitionLeaf.from_dict(_definition)

            return definition

        definition = get_definition() if "definition" in d else cast(Union[Unset, FormDefinitionLeaf], UNSET)
                ...
                def _parse_instance_providers_item(
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        instance_providers_item = BarcodeScanFormInstanceProvider.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        instance_providers_item = EntitySearchFormInstanceProvider.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        instance_providers_item = NewBlankFormInstanceProvider.from_dict(data)
        ...
        instance_providers = (
            get_instance_providers()
            if "instanceProviders" in d
            else cast(
                Union[
                    Unset,
                    List[
        ...
        type = get_type() if "type" in d else cast(Union[Unset, NestedFormFieldType], UNSET)
    ...
    @property
    def definition(self) -> FormDefinitionLeaf:
        if isinstance(self._definition, Unset):
            raise NotPresentError(self, "definition")
        return self._definition

    @definition.setter
    def definition(self, value: FormDefinitionLeaf) -> None:
