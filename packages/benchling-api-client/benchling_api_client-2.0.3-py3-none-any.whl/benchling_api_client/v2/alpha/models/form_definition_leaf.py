...
T = TypeVar("T", bound="FormDefinitionLeaf")


@attr.s(auto_attribs=True, repr=False)
class FormDefinitionLeaf:
    """  """
    ...
    def __repr__(self):
        ...
        return "FormDefinitionLeaf({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        form_definition_leaf = cls(
            fields=fields,
        )

        return form_definition_leaf
