...
export declare type ResolutionType = "microseconds" | "milliseconds" | "seconds" | "minsec" | "minutes" | "hourmin" | "hours" | "days" | "months" | "years";
...
export declare function _compute_label(t: number, resolution: ResolutionType, model: DatetimeTickFormatter): string;
