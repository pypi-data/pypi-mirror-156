...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.actionZoomIn = QtGui.QAction(Dialog)
        self.actionZoomIn.setObjectName("actionZoomIn")
        self.actionZoomOut = QtGui.QAction(Dialog)
        self.actionZoomOut.setObjectName("actionZoomOut")
        self.actionResetZoom = QtGui.QAction(Dialog)
        self.actionResetZoom.setShortcut("Ctrl+0")
        self.actionResetZoom.setObjectName("actionResetZoom")
        self.actionbrowsing_toggle_showing_cards_notes = QtGui.QAction(Dialog)
