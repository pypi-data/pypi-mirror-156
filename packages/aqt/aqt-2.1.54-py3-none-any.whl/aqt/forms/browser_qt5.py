...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.menuqt_accel_view = QtWidgets.QMenu(self.menubar)
        ...
        self.actionCopy = QtWidgets.QAction(Dialog)
        self.actionCopy.setShortcut("Ctrl+Alt+E")
        self.actionCopy.setObjectName("actionCopy")
        self.actionFullScreen = QtWidgets.QAction(Dialog)
        self.actionFullScreen.setObjectName("actionFullScreen")
        self.actionZoomIn = QtWidgets.QAction(Dialog)
        self.actionZoomIn.setObjectName("actionZoomIn")
        self.actionZoomOut = QtWidgets.QAction(Dialog)
        self.actionZoomOut.setObjectName("actionZoomOut")
        self.actionResetZoom = QtWidgets.QAction(Dialog)
        self.actionResetZoom.setShortcut("Ctrl+0")
        self.actionResetZoom.setObjectName("actionResetZoom")
        self.actionbrowsing_toggle_showing_cards_notes = QtWidgets.QAction(Dialog)
