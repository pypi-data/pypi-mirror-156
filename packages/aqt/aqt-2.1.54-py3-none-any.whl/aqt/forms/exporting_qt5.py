...
class Ui_ExportDialog(object):
    def setupUi(self, ExportDialog):
        ...
        self.includeDeck = QtWidgets.QCheckBox(ExportDialog)
        self.includeDeck.setEnabled(True)
        self.includeDeck.setObjectName("includeDeck")
        self.vboxlayout1.addWidget(self.includeDeck)
        self.includeNotetype = QtWidgets.QCheckBox(ExportDialog)
        self.includeNotetype.setEnabled(True)
        self.includeNotetype.setObjectName("includeNotetype")
        self.vboxlayout1.addWidget(self.includeNotetype)
        self.includeGuid = QtWidgets.QCheckBox(ExportDialog)
        self.includeGuid.setObjectName("includeGuid")
        self.vboxlayout1.addWidget(self.includeGuid)
        self.legacy_support = QtWidgets.QCheckBox(ExportDialog)
        self.legacy_support.setChecked(True)
        self.legacy_support.setObjectName("legacy_support")
        self.vboxlayout1.addWidget(self.legacy_support)
