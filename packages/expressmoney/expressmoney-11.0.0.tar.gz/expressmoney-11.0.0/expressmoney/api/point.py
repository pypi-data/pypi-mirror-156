...
from expressmoney.api.client import ApiRequest, ApiTasks
...
class Point:
    ...
    def __init__(self,
        ...
        self._client = (ApiRequest(service=self._point_id.service,
                        ...
                        ApiTasks(service=self._point_id.service,
                                 path=self._path,
                                 user=self._user,
                                 )
                        )
...
class ObjectPoint(Point):
    ...
    def __init__(self,
        ...
        super().__init__(user=user, action=action, is_async=is_async, timeout=timeout)
