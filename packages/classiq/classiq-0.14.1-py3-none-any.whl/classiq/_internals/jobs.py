...
class JobPoller:
    ...
    INTERVAL_FACTOR = 2
    FINAL_INTERVAL_SEC = INITIAL_INTERVAL_SEC * INTERVAL_FACTOR**3  # ~1.5 min
    ...
    @classmethod
    def _interval_sec(cls) -> Iterable[int]:
        i = cls.INITIAL_INTERVAL_SEC
        while True:
            yield i
            i = min(i * cls.INTERVAL_FACTOR, cls.FINAL_INTERVAL_SEC)
