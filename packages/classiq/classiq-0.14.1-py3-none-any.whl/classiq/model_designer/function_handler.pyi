...
class FunctionHandler(abc.ABC, metaclass=abc.ABCMeta):
    ...
    def apply(self, function_name: str, in_wires: Optional[Union[Dict[str, QregOrWire], QuantumRegister]] = ..., out_wires: Optional[Union[Dict[str, QregOrWire], QuantumRegister]] = ..., is_inverse: bool = ..., control_state: Optional[ControlState] = ..., call_name: Optional[str] = ...) -> Dict[str, Wire]: ...
