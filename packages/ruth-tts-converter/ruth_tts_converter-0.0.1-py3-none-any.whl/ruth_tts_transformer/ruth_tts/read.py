...
import torch
import ruth_tts_transformer.ruth_tts
...
if __name__ == '__main__':
    ...
    parser.add_argument('--textfile', type=str, help='A file containing the text to read.', default="ruth_tts/data/riding_hood.txt")
