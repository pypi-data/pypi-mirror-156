...
class ROIAnalyzer(object):
    ...
    def analyze_ROIs(self):
        ...
        for file_path in self.files_found:
            ...
            video_shapes = list(itertools.chain(video_recs['Name'].unique(), video_circs['Name'].unique(), video_polys['Name'].unique()))
            ...
            if video_shapes == 0:
                ...
                data_df_sliced = data_df[self.bp_columns]
                ...
                if self.calculate_distances:
                    for animal, shape_dicts in self.entries_exit_dict.items():
                        for shape_name, shape_data in shape_dicts.items():
                            ...
                            for entry in d:
                                df = data_df[self.bp_dict[animal][0:2]][data_df.index.isin(list(range(entry[0], entry[1]+1)))]
