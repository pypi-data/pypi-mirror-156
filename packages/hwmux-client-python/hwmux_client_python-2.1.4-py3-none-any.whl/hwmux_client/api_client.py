...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/2.1.4/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = TokenAuthApi()
        api_instance.token_auth_create  # this is an instance of the class Endpoint
        api_instance.token_auth_create()  # this invokes api_instance.token_auth_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.token_auth_create.callable or self.callable in this class
