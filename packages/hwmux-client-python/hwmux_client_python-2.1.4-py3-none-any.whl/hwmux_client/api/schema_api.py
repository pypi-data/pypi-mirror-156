...
class SchemaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.schema_download_retrieve_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/schema/download',
                'operation_id': 'schema_download_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def schema_download_retrieve(
        self,
        **kwargs
    ):
        """schema_download_retrieve  # noqa: E501
        ...
        >>> thread = api.schema_download_retrieve(async_req=True)
        >>> result = thread.get()
        ...
        return self.schema_download_retrieve_endpoint.call_with_http_info(**kwargs)
