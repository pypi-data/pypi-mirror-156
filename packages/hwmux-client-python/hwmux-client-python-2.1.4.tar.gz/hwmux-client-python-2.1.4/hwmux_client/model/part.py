...
def lazy_import():
    ...
    globals()['PartPartFamily'] = PartPartFamily
...
class Part(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'part_family': (PartPartFamily,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, part_no, part_family, *args, **kwargs):  # noqa: E501
        """Part - a model defined in OpenAPI

        Args:
            part_no (str):
            part_family (PartPartFamily):
    ...
    @convert_js_args_to_python_args
    def __init__(self, part_no, part_family, *args, **kwargs):  # noqa: E501
        """Part - a model defined in OpenAPI
