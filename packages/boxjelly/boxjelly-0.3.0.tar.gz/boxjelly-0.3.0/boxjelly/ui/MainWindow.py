...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _create_menu_bar(self):
        ...
        edit_menu.addAction('Re&name', QtGui.QKeySequence('Ctrl+R'), self.rename_selected_tracks)
        edit_menu.addAction('&Split', QtGui.QKeySequence('Ctrl+N'), self.split_selected_track)
        edit_menu.addAction('&Merge', QtGui.QKeySequence('Ctrl+M'), self.merge_selected_tracks)
        edit_menu.addAction('&Delete', QtGui.QKeySequence('Del'), self.delete_selected_tracks)
        edit_menu.addSeparator()
        edit_menu.addAction('&Undo', QtGui.QKeySequence('Ctrl+Z'), self._undo_stack.undo)
        edit_menu.addAction('&Redo', QtGui.QKeySequence('Ctrl+Shift+Z'), self._undo_stack.redo)
        
        # Go menu
        go_menu = menu_bar.addMenu('&Go')
        go_menu.addAction('Seek &beginning', QtGui.QKeySequence('Ctrl+['), self.seek_beginning_selected_tracks)
        go_menu.addAction('Seek &end', QtGui.QKeySequence('Ctrl+]'), self.seek_end_selected_tracks)
