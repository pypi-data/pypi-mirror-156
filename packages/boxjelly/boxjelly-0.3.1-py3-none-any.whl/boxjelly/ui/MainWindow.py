...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _create_menu_bar(self):
        ...
        rename_action = edit_menu.addAction(QtGui.QIcon('icons:rename.png'), 'Re&name', QtGui.QKeySequence('Ctrl+R'), self.rename_selected_tracks)
        split_action = edit_menu.addAction(QtGui.QIcon('icons:split.png'), '&Split', QtGui.QKeySequence('Ctrl+N'), self.split_selected_track)
        merge_action = edit_menu.addAction(QtGui.QIcon('icons:merge.png'), '&Merge', QtGui.QKeySequence('Ctrl+M'), self.merge_selected_tracks)
        delete_action = edit_menu.addAction(QtGui.QIcon('icons:delete.png'), '&Delete', QtGui.QKeySequence('Del'), self.delete_selected_tracks)
        edit_menu.addSeparator()
        undo_action = edit_menu.addAction(QtGui.QIcon('icons:undo.png'), '&Undo', QtGui.QKeySequence('Ctrl+Z'), self._undo_stack.undo)
        redo_action = edit_menu.addAction(QtGui.QIcon('icons:redo.png'), '&Redo', QtGui.QKeySequence('Ctrl+Shift+Z'), self._undo_stack.redo)
        
        # Go menu
        go_menu = menu_bar.addMenu('&Go')
        seek_beginning_action = go_menu.addAction(QtGui.QIcon('icons:seek_beginning.png'), 'Seek &beginning', QtGui.QKeySequence('Ctrl+['), self.seek_beginning_selected_tracks)
        seek_end_action = go_menu.addAction(QtGui.QIcon('icons:seek_end.png'), 'Seek &end', QtGui.QKeySequence('Ctrl+]'), self.seek_end_selected_tracks)
