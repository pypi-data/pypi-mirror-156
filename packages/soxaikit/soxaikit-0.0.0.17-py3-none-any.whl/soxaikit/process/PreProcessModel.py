...
def pre_process_smooth(array_input, wear, window_num, output_mean: bool = True, output_max: bool = True,
...
def getSpo2(array_r, array_dc):
    return [spo2_r(k) for k in array_r]

def pre_process_get_wear(array_T):
