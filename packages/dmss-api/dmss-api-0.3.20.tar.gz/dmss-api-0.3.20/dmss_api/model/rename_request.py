...
class RenameRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, document_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, document_id, *args, **kwargs):  # noqa: E501
        """RenameRequest - a model defined in OpenAPI
