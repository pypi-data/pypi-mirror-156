...
class RemoveByPathRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, directory, *args, **kwargs):  # noqa: E501
        """RemoveByPathRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, directory, *args, **kwargs):  # noqa: E501
        """RemoveByPathRequest - a model defined in OpenAPI
