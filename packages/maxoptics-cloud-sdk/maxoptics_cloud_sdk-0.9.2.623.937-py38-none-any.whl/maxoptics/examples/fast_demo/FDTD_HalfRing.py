...
def simulation(
    ...
    if source_view:
        ...
        df = passive_source_fde_result_chart(
            ...
            dict(
                ...
                attribute="E",
                operation="ABS",
                taskPath=Path(result.workspace).parent
                / Path(result.workspace).name,
            ),
            dict(x=0, y="plotX", z="plotY", mode=0),
        )
    ...
    if extract:
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_Through009.json"), tf.raw_data
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_ME_Through.json"), tf.raw_data
        )  # save data as .json file
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_Cross009.json"), tf.raw_data
        )  # save data as .json file
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_ME_cross.json"), tf.raw_data
        )  # save data as .json file
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_Refl009.json"), tf.raw_data
        )  # save data as .json file
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_ME_Refl.json"), tf.raw_data
        )  # save data as .json file
