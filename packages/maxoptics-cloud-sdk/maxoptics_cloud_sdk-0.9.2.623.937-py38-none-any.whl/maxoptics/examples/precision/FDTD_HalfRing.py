...
from maxoptics.core import lineplot
...
def simulation(gds_file, gds_topcell, run=True, grids_per_lambda=15):
    ...
    if run:
        ...
        print(
            "\x1b[6;30;42m"
            + "[Finished in %(t)s mins for FDTD]"
            % {"t": round((stop - start) / 60, 2)}
            + "\x1b[0m"
        )

        monitorZNormalData = fdtdResult.passive_fdtd_fd_result_chart(
            "intensity",
            monitorZNormal,
            "E",
            "ABS",
        ...
        x, y, Z = (
            monitorZNormalData.raw_data["horizontal"],
            monitorZNormalData.raw_data["vertical"],
        ...
        monitorZNormalData2 = fdtdResult.passive_fdtd_fd_result_chart(
            "intensity",
            monitorZNormal,
            "E",
            "ABS",
        ...
        x, y, Z = (
            monitorZNormalData2.raw_data["horizontal"],
            monitorZNormalData2.raw_data["vertical"],
        ...
        monitorZNormalData3 = fdtdResult.passive_fdtd_fd_result_chart(
            "intensity",
            monitorZNormal,
            "E",
            "ABS",
        ...
        x, y, Z = (
            monitorZNormalData3.raw_data["horizontal"],
            monitorZNormalData3.raw_data["vertical"],
        ...
        monitorThroughData = fdtdResult.passive_fdtd_fd_result_chart(
            target="line",
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_Through.json"),
            monitorThroughData.raw_data,
        )

        monitorCrossData = fdtdResult.passive_fdtd_fd_result_chart(
            target="line",
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_Cross.json"),
            monitorCrossData.raw_data,
        )

        monitorReflectionData = fdtdResult.passive_fdtd_fd_result_chart(
            target="line",
        ...
        plt.clf()
        json_save(
            os.path.join(plot_path, "hfr_Refl.json"),
