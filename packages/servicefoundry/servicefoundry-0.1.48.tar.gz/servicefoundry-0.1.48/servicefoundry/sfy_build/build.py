...
def build(name, output_hook: OutputCallBack):
    ...
    build_pack.build(
        name=image_name, build_dir=BUILD_DIR, options=options, output_hook=output_hook
    )
    output_hook.print_line(f"Created docker image {image_name}.")
