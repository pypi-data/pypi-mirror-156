...
class BuildPack:
    ...
    def build(self, name, build_dir, options, output_hook: OutputCallBack):
        return self._build(
            name=name, build_dir=build_dir, options=options, output_hook=output_hook
        )
...
_build_pack_provider_chain = {
    "sfy_docker_build_pack": _get_build_pack("servicefoundry.sfy_build_pack_docker"),
    "sfy_python_build_pack": _get_build_pack("servicefoundry.sfy_build_pack_python"),
