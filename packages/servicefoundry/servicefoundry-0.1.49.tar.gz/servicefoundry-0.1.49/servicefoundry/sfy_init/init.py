...
def init(
    ...
    init_pack.ask_questions(input_hook, output_hook)
    ...
    _create_project(definition, directory, filename, init_pack, input_hook, output_hook)


def _create_project(
    definition, directory, filename, init_pack, input_hook, output_hook
):
    if not directory:
