...
class BoundaryApi(object):
    ...
    def list_all(self, tenant_type, x_api_key, **kwargs):  # noqa: E501
        """Get plots  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all(tenant_type, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :param object ids:
        :param object plot_id:
        :param object external_ids:
        :param object parent_ids:
        :param object min_created_date_time:
        :param object max_created_date_time:
        :param object page:
        :param object size:
        ...
        if kwargs.get('async_req'):
            return self.list_all_with_http_info(tenant_type, x_api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.list_all_with_http_info(tenant_type, x_api_key, **kwargs)  # noqa: E501
            return data

    def list_all_with_http_info(self, tenant_type, x_api_key, **kwargs):  # noqa: E501
        """Get plots  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_all_with_http_info(tenant_type, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['tenant_type', 'x_api_key', 'org_id', 'ids', 'plot_id', 'external_ids', 'parent_ids', 'min_created_date_time', 'max_created_date_time', 'page', 'size', 'sort_by', 'direction']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tenant_type' not in params or
            ...
            raise ValueError("Missing the required parameter `tenant_type` when calling `list_all`")  # noqa: E501
        # verify the required parameter 'x_api_key' is set
        if self.api_client.client_side_validation and ('x_api_key' not in params or
                                                       params['x_api_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `x_api_key` when calling `list_all`")  # noqa: E501
