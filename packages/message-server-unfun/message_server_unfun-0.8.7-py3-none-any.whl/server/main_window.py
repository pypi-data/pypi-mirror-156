...
from project.server_dist.server.stat_window import StatWindow
from project.server_dist.server.config_window import ConfigWindow
from project.server_dist.server.add_user import RegisterUser
from project.server_dist.server.remove_user import DelUserDialog


class MainWindow(QMainWindow):
    """Класс - основное окно сервера."""

    def __init__(self, base, server, config):
        super().__init__()
    ...
    def create_users_model(self):
        ...
        list_users = self.base.active_users_list()
    ...
    def show_statistics(self):
        ...
        global stat_window
        stat_window = StatWindow(self.base)
        stat_window.show()
    ...
    def reg_user(self):
        ...
        global reg_window
        reg_window = RegisterUser(self.base, self.server_thread)
        reg_window.show()
    ...
    def rem_user(self):
        ...
        global rem_window
        rem_window = DelUserDialog(self.base, self.server_thread)
        rem_window.show()
