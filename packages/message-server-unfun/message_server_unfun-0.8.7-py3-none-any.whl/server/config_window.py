...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.ip_label_note = QLabel(' leave this field empty to accept connections from any addresses.', self)
        ...
        try:
            ...
            if 1023 < port < 65536:
                ...
                with open(f"{dir_path}/{'server.ini'}", 'w') as conf:
                    ...
                    message.information(
                        self, 'OK', 'Settings saved successfully!')
            else:
                message.warning(
                    self, 'Error', 'Port must be from 1024 to 65536')
