...
from .asyncio.base import Utils
...
class ElasticsearchSink:
    ...
    def __init__(self, hosts, index, *, log_extra=None, buffer_maxsize=0xffff, **kwargs):
    ...
    def _get_extra(self, record):
        ...
        if self._log_extra and record[r'extra']:
            record[r'extra'].update(self._log_extra)
            return record[r'extra']
        elif self._log_extra:
