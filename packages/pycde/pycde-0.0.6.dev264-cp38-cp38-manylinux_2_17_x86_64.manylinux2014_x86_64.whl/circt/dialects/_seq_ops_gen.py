...
class CompRegOp(_ods_ir.OpView):
  ...
  def __init__(self, data, input, clk, name, *, reset=None, resetValue=None, sym_name=None, svAttributes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if svAttributes is not None: attributes["svAttributes"] = svAttributes
    results.append(data)
