...
class AssertConcurrentOp(_ods_ir.OpView):
  ...
  def __init__(self, event, clock, property, operands_, *, label=None, message=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class AssertOp(_ods_ir.OpView):
  ...
  def __init__(self, expression, defer, operands_, *, label=None, message=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CaseOp(_ods_ir.OpView):
  ...
  def __init__(self, cond, casePatterns, num_caseRegions, *, caseStyle=None, validationQualifier=None, loc=None, ip=None):
    ...
    attributes["caseStyle"] = caseStyle
    attributes["casePatterns"] = casePatterns
    attributes["validationQualifier"] = validationQualifier
    _ods_successors = None
...
class ErrorOp(_ods_ir.OpView):
  ...
  def __init__(self, operands_, *, message=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class FWriteOp(_ods_ir.OpView):
  ...
  def __init__(self, fd, string, operands_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def string(self):
    return _ods_ir.StringAttr(self.operation.attributes["string"])

  @string.setter
  def string(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["string"] = value
...
class FatalOp(_ods_ir.OpView):
  ...
  def __init__(self, operands_, *, verbosity=None, message=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(operands_))
    attributes["verbosity"] = verbosity
    if message is not None: attributes["message"] = message
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class VerbatimExprOp(_ods_ir.OpView):
  ...
  def __init__(self, result, string, operands_, *, symbols=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class VerbatimOp(_ods_ir.OpView):
  ...
  def __init__(self, string, operands_, *, symbols=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
