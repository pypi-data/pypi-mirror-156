...
class InstanceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, instanceName, moduleName, inputs, argNames, resultNames, parameters, *, inner_sym=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ProbeOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, operands_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
