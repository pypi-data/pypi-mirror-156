...
setup(
    ...
    package_data={  # Optional
            "dbr":['CommonServiceLocator.dll', 'ErrorHandler.dll','GalaSoft.MvvmLight.dll','GalaSoft.MvvmLight.Extras.dll','GalaSoft.MvvmLight.Platform.dll','Hsc.dll','imo.ico','log4net.dll',
                    'logo.png','Newtonsoft.Json.dll','PresentationFramework.Aero2.dll','StationNetCore.dll','System.Windows.Interactivity.dll','version.txt',
                    'WPFMessageBox.dll','Xceed.Wpf.DataGrid.dll','Xceed.Wpf.Toolkit.dll']
        },
    python_requires='>=3'
)
