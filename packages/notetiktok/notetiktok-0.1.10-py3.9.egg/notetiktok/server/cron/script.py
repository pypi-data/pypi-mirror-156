...
class CoinServer(BaseServer):
    def __init__(self):
        ...
        super(CoinServer, self).__init__('notetiktok_server', path)
    ...
    def init(self):
        ...
        manage.add_job(server_name='notetiktok_server',
                       directory=self.current_path,
                       command=f"python server.py",
                       user='bingtao',
                       stdout_logfile="/notechats/logs/notetiktok/strategy.log")
        manage.start()
