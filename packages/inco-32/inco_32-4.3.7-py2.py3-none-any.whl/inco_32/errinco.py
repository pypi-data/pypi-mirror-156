...
ER_INCO_VAR_WRITE_ONLY					= 0x00050219	# variable is write only
...
ER_INCO_DBGEX_ID_INVALID				= 0x00050901	# task id not valid
ER_INCO_DBGEX_NAME_INVALID				= 0x00050902	# task name not valid
ER_INCO_DBGEX_NO_FLOATING				= 0x00050903	# task has no floating point support
ER_INCO_DBGEX_BRK_PT_INVALID			= 0x00050904	# task breakpoint not valid
ER_INCO_DBGEX_BRK_PT_ALREADY			= 0x00050905	# task breakpoint already set
ER_INCO_DBGEX_WRONG_LENGTH				= 0x00050906	# task data wrong length for requested data
ER_INCO_DBGEX_UNKNOWN_DATA				= 0x00050907	# task data unknown data request
ER_INCO_DBGEX_PUT_FORBIDDEN				= 0x00050908	# task data put not allowed
ER_INCO_DBGEX_BRK_PT_MEMORY				= 0x00050909	# not enough memory to set breakpoint
ER_INCO_DBGEX_NO_HARD_RESET				= 0x0005090A	# hard reset not supported
ER_INCO_DBGEX_NO_DEVICE					= 0x0005090B	# no load device found to handle request
ER_INCO_DBGEX_NO_SOFT_RESET				= 0x0005090C	# soft reset not allowed
ER_INCO_DBGEX_BUFFER_TO_SMALL			= 0x0005090D	# The buffer is to small to store all data. Data has been truncated
ER_INCO_DBGEX_INVALID_ARG				= 0x0005090E	# Invalid argument passed (i.e. null pointer)
ER_INCO_DBGEX_NO_WATCHPOINTS_EXCEEDED	= 0x0005090F	# Number of watchpoints exceeded
ER_INCO_DBGEX_WATCHPOINT_CLR_ADDRESS	= 0x00050910	# Trying to clear a watchpoint which was not set before
ER_INCO_DBGEX_TASK_NOT_DEBUG_SUSPENDED	= 0x00050911	# Operation refused because task is not in 'debug suspended' state
ER_INCO_DBGEX_BUFFER_EXCEEDED			= 0x00050912	# The buffer is to small to store all data. No data has been returned
ER_INCO_DBGEX_EMPTY_CACHE				= 0x00050913	# No cached information available. E.g. the target doesn't support that feature or another call has been performed in the meantime
ER_INCO_DBGEX_INVALID_COOKIE			= 0x00050914	# No task register information in INCOFrame
ER_INCO_DBGEX_UNKNOWN					= 0x000509FF	# task unknown function call
