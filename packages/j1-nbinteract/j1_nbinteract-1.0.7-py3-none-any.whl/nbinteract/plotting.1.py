...
@use_options([
    'title', 'aspect_ratio', 'animation_duration', 'x_grid_color', 'y_grid_color', 'xlabel', 'ylabel', 'ylim'
])
...
def _create_fig(
    *,
    ...
    x_ax.grid_lines = 'dashed'
    y_ax.grid_lines = 'solid'

    x_ax.grid_color = options.x_grid_color                                      # 'gray'
    y_ax.grid_color = options.y_grid_color                                      # 'gray'
