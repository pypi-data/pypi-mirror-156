...
class PaymentInvocationRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, payment_method, payment_type, pay_message, *args, **kwargs):  # noqa: E501
        """PaymentInvocationRequest - a model defined in OpenAPI

        Args:
            payment_method (PaymentMethod):
            payment_type (PaymentType):
            pay_message (str): Pay message responsed from payment company
