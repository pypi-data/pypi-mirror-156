...
class RefundRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, order_ref, refund_order_ref, refund_amount, total_amount, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            total_amount (float): The total order amount of the original payment, unit is `fen`
        ...
        Keyword Args:
            ...
            currency (str): Amount currency, available options: CNY. [optional]  # noqa: E501
