...
class Bookmark(ModelNormal):
    ...
    def _from_openapi_data(cls, name, vdb_ids, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            vdb_ids ([str]): The list of VDB IDs associated with this bookmark.
        ...
        Keyword Args:
            ...
            retention (int): The retention policy for this bookmark, in days. A value of -1 indicates the bookmark should be kept forever.. [optional]  # noqa: E501
