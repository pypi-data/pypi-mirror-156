...
print(
    f"Signal subset is {duration:0.2f}s starts {start_ind/sample_rate:0.2f}s in")
...
Pxx, freqs, bins, im = plt.specgram(
    data, NFFT=1024, Fs=sample_rate, noverlap=900)
...
Pxx, freqs, bins, im = plt.specgram(
    data_full[:, 0], NFFT=1024, Fs=sampfreq, noverlap=900)
