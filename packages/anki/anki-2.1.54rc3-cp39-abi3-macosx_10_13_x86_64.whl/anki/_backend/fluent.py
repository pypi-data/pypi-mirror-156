...
class LegacyTranslationEnum:
    ...
    ERRORS_INVALID_INPUT_DETAILS = (15, 7)
    ERRORS_INVALID_INPUT_EMPTY = (15, 8)
    ERRORS_MULTIPLE_NOTETYPES_SELECTED = (15, 9)
    ERRORS_OPTION_NOT_SET = (15, 10)
    ERRORS_PARSE_NUMBER_FAIL = (15, 11)
    ERRORS_PLEASE_CHECK_DATABASE = (15, 12)
    ERRORS_PLEASE_CHECK_MEDIA = (15, 13)
    ERRORS_STANDARD_POPUP = (15, 14)
    ERRORS_UNABLE_OPEN_COLLECTION = (15, 15)
    ERRORS_WINDOWS_TTS_RUNTIME_ERROR = (15, 16)
...
Debug info: '''
    ...
    def errors_invalid_input_details(self, details: str) -> str:
        ...
        return self._translate(15, 7, {"details": details})
    ...
    def errors_option_not_set(self, option: str) -> str:
        r''' '{$option}' not set '''
        return self._translate(15, 10, {"option": option})
