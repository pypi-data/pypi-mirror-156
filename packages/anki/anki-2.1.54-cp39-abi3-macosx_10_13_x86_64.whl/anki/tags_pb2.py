...
_SETTAGCOLLAPSEDREQUEST = DESCRIPTOR.message_types_by_name['SetTagCollapsedRequest']
_TAGTREENODE = DESCRIPTOR.message_types_by_name['TagTreeNode']
_REPARENTTAGSREQUEST = DESCRIPTOR.message_types_by_name['ReparentTagsRequest']
_RENAMETAGSREQUEST = DESCRIPTOR.message_types_by_name['RenameTagsRequest']
_NOTEIDSANDTAGSREQUEST = DESCRIPTOR.message_types_by_name['NoteIdsAndTagsRequest']
_FINDANDREPLACETAGREQUEST = DESCRIPTOR.message_types_by_name['FindAndReplaceTagRequest']
_COMPLETETAGREQUEST = DESCRIPTOR.message_types_by_name['CompleteTagRequest']
_COMPLETETAGRESPONSE = DESCRIPTOR.message_types_by_name['CompleteTagResponse']
...
_TAGSSERVICE = DESCRIPTOR.services_by_name['TagsService']
