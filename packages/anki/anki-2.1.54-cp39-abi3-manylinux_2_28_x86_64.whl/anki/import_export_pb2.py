...
_IMPORTRESPONSE_NOTE = _IMPORTRESPONSE.nested_types_by_name['Note']
_IMPORTRESPONSE_LOG = _IMPORTRESPONSE.nested_types_by_name['Log']
...
_IMPORTCSVREQUEST = DESCRIPTOR.message_types_by_name['ImportCsvRequest']
_CSVMETADATAREQUEST = DESCRIPTOR.message_types_by_name['CsvMetadataRequest']
_CSVMETADATA = DESCRIPTOR.message_types_by_name['CsvMetadata']
_CSVMETADATA_MAPPEDNOTETYPE = _CSVMETADATA.nested_types_by_name['MappedNotetype']
_EXPORTCARDCSVREQUEST = DESCRIPTOR.message_types_by_name['ExportCardCsvRequest']
_EXPORTNOTECSVREQUEST = DESCRIPTOR.message_types_by_name['ExportNoteCsvRequest']
_EXPORTLIMIT = DESCRIPTOR.message_types_by_name['ExportLimit']
_PACKAGEMETADATA_VERSION = _PACKAGEMETADATA.enum_types_by_name['Version']
_IMPORTCSVREQUEST_DUPERESOLUTION = _IMPORTCSVREQUEST.enum_types_by_name['DupeResolution']
_CSVMETADATA_DELIMITER = _CSVMETADATA.enum_types_by_name['Delimiter']
...
ImportResponse = _reflection.GeneratedProtocolMessageType('ImportResponse', (_message.Message,), {
  ...
  'Note' : _reflection.GeneratedProtocolMessageType('Note', (_message.Message,), {
    'DESCRIPTOR' : _IMPORTRESPONSE_NOTE,
    '__module__' : 'anki.import_export_pb2'
    # @@protoc_insertion_point(class_scope:anki.import_export.ImportResponse.Note)
    })
  ,

  'Log' : _reflection.GeneratedProtocolMessageType('Log', (_message.Message,), {
    'DESCRIPTOR' : _IMPORTRESPONSE_LOG,
    '__module__' : 'anki.import_export_pb2'
    # @@protoc_insertion_point(class_scope:anki.import_export.ImportResponse.Log)
    })
  ,
  'DESCRIPTOR' : _IMPORTRESPONSE,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.ImportResponse)
  })
_sym_db.RegisterMessage(ImportResponse)
_sym_db.RegisterMessage(ImportResponse.Note)
_sym_db.RegisterMessage(ImportResponse.Log)
...
ImportCsvRequest = _reflection.GeneratedProtocolMessageType('ImportCsvRequest', (_message.Message,), {
  'DESCRIPTOR' : _IMPORTCSVREQUEST,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.ImportCsvRequest)
  })
_sym_db.RegisterMessage(ImportCsvRequest)

CsvMetadataRequest = _reflection.GeneratedProtocolMessageType('CsvMetadataRequest', (_message.Message,), {
  'DESCRIPTOR' : _CSVMETADATAREQUEST,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.CsvMetadataRequest)
  })
_sym_db.RegisterMessage(CsvMetadataRequest)

CsvMetadata = _reflection.GeneratedProtocolMessageType('CsvMetadata', (_message.Message,), {

  'MappedNotetype' : _reflection.GeneratedProtocolMessageType('MappedNotetype', (_message.Message,), {
    'DESCRIPTOR' : _CSVMETADATA_MAPPEDNOTETYPE,
    '__module__' : 'anki.import_export_pb2'
    # @@protoc_insertion_point(class_scope:anki.import_export.CsvMetadata.MappedNotetype)
    })
  ,
  'DESCRIPTOR' : _CSVMETADATA,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.CsvMetadata)
  })
_sym_db.RegisterMessage(CsvMetadata)
_sym_db.RegisterMessage(CsvMetadata.MappedNotetype)

ExportCardCsvRequest = _reflection.GeneratedProtocolMessageType('ExportCardCsvRequest', (_message.Message,), {
  'DESCRIPTOR' : _EXPORTCARDCSVREQUEST,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.ExportCardCsvRequest)
  })
_sym_db.RegisterMessage(ExportCardCsvRequest)

ExportNoteCsvRequest = _reflection.GeneratedProtocolMessageType('ExportNoteCsvRequest', (_message.Message,), {
  'DESCRIPTOR' : _EXPORTNOTECSVREQUEST,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.ExportNoteCsvRequest)
  })
_sym_db.RegisterMessage(ExportNoteCsvRequest)

ExportLimit = _reflection.GeneratedProtocolMessageType('ExportLimit', (_message.Message,), {
  'DESCRIPTOR' : _EXPORTLIMIT,
  '__module__' : 'anki.import_export_pb2'
  # @@protoc_insertion_point(class_scope:anki.import_export.ExportLimit)
  })
_sym_db.RegisterMessage(ExportLimit)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _IMPORTRESPONSE._serialized_end=1159
  ...
  _IMPORTRESPONSE_LOG._serialized_end=1159
  _EXPORTANKIPACKAGEREQUEST._serialized_start=1162
  _EXPORTANKIPACKAGEREQUEST._serialized_end=1315
  _PACKAGEMETADATA._serialized_start=1318
  _PACKAGEMETADATA._serialized_end=1493
  _PACKAGEMETADATA_VERSION._serialized_start=1399
  _PACKAGEMETADATA_VERSION._serialized_end=1493
  _MEDIAENTRIES._serialized_start=1496
  _MEDIAENTRIES._serialized_end=1687
  _MEDIAENTRIES_MEDIAENTRY._serialized_start=1574
  _MEDIAENTRIES_MEDIAENTRY._serialized_end=1687
  _IMPORTCSVREQUEST._serialized_start=1690
  _IMPORTCSVREQUEST._serialized_end=1902
  _IMPORTCSVREQUEST_DUPERESOLUTION._serialized_start=1853
  _IMPORTCSVREQUEST_DUPERESOLUTION._serialized_end=1902
  _CSVMETADATAREQUEST._serialized_start=1905
  _CSVMETADATAREQUEST._serialized_end=2096
  _CSVMETADATA._serialized_start=2099
  _CSVMETADATA._serialized_end=2765
  _CSVMETADATA_MAPPEDNOTETYPE._serialized_start=2614
  _CSVMETADATA_MAPPEDNOTETYPE._serialized_end=2665
  _CSVMETADATA_DELIMITER._serialized_start=2667
  _CSVMETADATA_DELIMITER._serialized_end=2745
  _EXPORTCARDCSVREQUEST._serialized_start=2767
  _EXPORTCARDCSVREQUEST._serialized_end=2874
  _EXPORTNOTECSVREQUEST._serialized_start=2877
  _EXPORTNOTECSVREQUEST._serialized_end=3064
  _EXPORTLIMIT._serialized_start=3067
  _EXPORTLIMIT._serialized_end=3239
  _IMPORTEXPORTSERVICE._serialized_start=3242
  _IMPORTEXPORTSERVICE._serialized_end=4149
