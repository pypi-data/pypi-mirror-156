...
class Progress(google.protobuf.message.Message):
    ...
    importing: typing.Text
    exporting: typing.Text
    def __init__(self,
        *,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value",b"value"]) -> typing.Optional[typing_extensions.Literal["none","media_sync","media_check","full_sync","normal_sync","database_check","importing","exporting"]]: ...
