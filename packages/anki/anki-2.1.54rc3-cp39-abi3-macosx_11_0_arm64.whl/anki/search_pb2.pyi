...
class SearchNode(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        note: typing.Text = ...,
        introduced_in_days: builtins.int = ...,
        field: typing.Optional[global___SearchNode.Field] = ...,
        literal_text: typing.Text = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["filter",b"filter"]) -> typing.Optional[typing_extensions.Literal["group","negated","parsable_text","template","nid","dupe","field_name","rated","added_in_days","due_in_days","flag","card_state","nids","edited_in_days","deck","due_on_day","tag","note","introduced_in_days","field","literal_text"]]: ...
