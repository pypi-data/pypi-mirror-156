...
class CardStatsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        deck: typing.Text = ...,
        added: builtins.int = ...,
        first_review: typing.Optional[builtins.int] = ...,
        latest_review: typing.Optional[builtins.int] = ...,
        due_date: typing.Optional[builtins.int] = ...,
        due_position: typing.Optional[builtins.int] = ...,
        interval: builtins.int = ...,
        ease: builtins.int = ...,
        reviews: builtins.int = ...,
        lapses: builtins.int = ...,
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_due_position",b"_due_position"]) -> typing.Optional[typing_extensions.Literal["due_position"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_first_review",b"_first_review"]) -> typing.Optional[typing_extensions.Literal["first_review"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_latest_review",b"_latest_review"]) -> typing.Optional[typing_extensions.Literal["latest_review"]]: ...
