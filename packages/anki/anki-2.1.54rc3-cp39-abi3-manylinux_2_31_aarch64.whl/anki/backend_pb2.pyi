...
class BackendError(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        localized: typing.Text = ...,
        kind: global___BackendError.Kind.ValueType = ...,
        help_page: typing.Optional[anki.links_pb2.HelpPageLinkRequest.HelpPage.ValueType] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_help_page",b"_help_page","help_page",b"help_page"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_help_page",b"_help_page","help_page",b"help_page","kind",b"kind","localized",b"localized"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_help_page",b"_help_page"]) -> typing.Optional[typing_extensions.Literal["help_page"]]: ...
