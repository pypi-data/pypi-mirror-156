...
_CARDSTATSRESPONSE = DESCRIPTOR.message_types_by_name['CardStatsResponse']
_CARDSTATSRESPONSE_STATSREVLOGENTRY = _CARDSTATSRESPONSE.nested_types_by_name['StatsRevlogEntry']
_GRAPHSREQUEST = DESCRIPTOR.message_types_by_name['GraphsRequest']
_GRAPHSRESPONSE = DESCRIPTOR.message_types_by_name['GraphsResponse']
_GRAPHPREFERENCES = DESCRIPTOR.message_types_by_name['GraphPreferences']
_REVLOGENTRY = DESCRIPTOR.message_types_by_name['RevlogEntry']
_GRAPHPREFERENCES_WEEKDAY = _GRAPHPREFERENCES.enum_types_by_name['Weekday']
_REVLOGENTRY_REVIEWKIND = _REVLOGENTRY.enum_types_by_name['ReviewKind']
CardStatsResponse = _reflection.GeneratedProtocolMessageType('CardStatsResponse', (_message.Message,), {

  'StatsRevlogEntry' : _reflection.GeneratedProtocolMessageType('StatsRevlogEntry', (_message.Message,), {
    'DESCRIPTOR' : _CARDSTATSRESPONSE_STATSREVLOGENTRY,
    '__module__' : 'anki.stats_pb2'
    # @@protoc_insertion_point(class_scope:anki.stats.CardStatsResponse.StatsRevlogEntry)
    })
  ,
  'DESCRIPTOR' : _CARDSTATSRESPONSE,
  '__module__' : 'anki.stats_pb2'
  # @@protoc_insertion_point(class_scope:anki.stats.CardStatsResponse)
  })
_sym_db.RegisterMessage(CardStatsResponse)
_sym_db.RegisterMessage(CardStatsResponse.StatsRevlogEntry)
