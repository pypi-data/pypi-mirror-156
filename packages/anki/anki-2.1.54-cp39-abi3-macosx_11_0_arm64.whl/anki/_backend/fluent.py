...
class LegacyTranslationEnum:
    ...
    ACTIONS_CURRENTLY_UNSUPPORTED = (1, 14)
    ACTIONS_CUSTOM_STUDY = (1, 15)
    ACTIONS_DECKS = (1, 16)
    ACTIONS_DELETE = (1, 17)
    ACTIONS_EXPORT = (1, 18)
    ACTIONS_FILTER = (1, 19)
    ...
    ACTIONS_PREVIOUS_CARD_INFO = (1, 38)
    ACTIONS_REBUILD = (1, 39)
    ACTIONS_REMOVE_NOTETYPE = (1, 40)
    ACTIONS_REMOVE_TAG = (1, 41)
    ACTIONS_RENAME = (1, 42)
    ACTIONS_RENAME_DECK = (1, 43)
    ACTIONS_RENAME_TAG = (1, 44)
    ACTIONS_RENAME_WITH_PARENTS = (1, 45)
    ACTIONS_REPLAY_AUDIO = (1, 46)
    ACTIONS_REPOSITION = (1, 47)
    ACTIONS_SAVE = (1, 48)
    ACTIONS_SEARCH = (1, 49)
    ACTIONS_SELECT = (1, 50)
    ACTIONS_SET_DUE_DATE = (1, 51)
    ACTIONS_SET_FLAG = (1, 52)
    ACTIONS_SHORTCUT_KEY = (1, 53)
    ACTIONS_SUSPEND_CARD = (1, 54)
    ACTIONS_UNBURY_UNSUSPEND = (1, 55)
    ACTIONS_UPDATE_CARD = (1, 56)
    ACTIONS_UPDATE_CONFIG = (1, 57)
    ACTIONS_UPDATE_DECK = (1, 58)
    ACTIONS_UPDATE_NOTE = (1, 59)
    ACTIONS_UPDATE_NOTETYPE = (1, 60)
    ACTIONS_UPDATE_TAG = (1, 61)
    ACTIONS_WITH_ELLIPSIS = (1, 62)
    ...
    BROWSING_CARDS_CANT_BE_MANUALLY_MOVED_INTO = (4, 17)
    BROWSING_CARDS_DELETED = (4, 18)
    BROWSING_CARDS_UPDATED = (4, 19)
    BROWSING_CHANGE_DECK = (4, 20)
    BROWSING_CHANGE_DECK2 = (4, 21)
    BROWSING_CHANGE_NOTE_TYPE = (4, 22)
    BROWSING_CHANGE_NOTE_TYPE2 = (4, 23)
    BROWSING_CHANGE_NOTETYPE = (4, 24)
    BROWSING_CHANGED_NEW_POSITION = (4, 25)
    BROWSING_CLEAR_UNUSED_TAGS = (4, 26)
    BROWSING_CONFIRM_SAVED_SEARCH_OVERWRITE = (4, 27)
    BROWSING_CREATED = (4, 28)
    BROWSING_CURRENT_DECK = (4, 29)
    BROWSING_CURRENT_NOTE_TYPE = (4, 30)
    BROWSING_DELETE_NOTES = (4, 31)
    BROWSING_DUPLICATE = (4, 32)
    BROWSING_EASE = (4, 33)
    BROWSING_EDITED_TODAY = (4, 34)
    BROWSING_ENTER_TAGS_TO_ADD = (4, 35)
    BROWSING_ENTER_TAGS_TO_DELETE = (4, 36)
    BROWSING_FILTERED = (4, 37)
    BROWSING_FIND = (4, 38)
    BROWSING_FIND_AND_REPLACE = (4, 39)
    BROWSING_FIND_DUPLICATES = (4, 40)
    BROWSING_FIRST_CARD = (4, 41)
    BROWSING_FLAG = (4, 42)
    BROWSING_FONT = (4, 43)
    BROWSING_FONT_SIZE = (4, 44)
    BROWSING_FOUND_AS_ACROSS_BS = (4, 45)
    BROWSING_GROUP = (4, 46)
    BROWSING_IGNORE_CASE = (4, 47)
    BROWSING_IN = (4, 48)
    BROWSING_INTERVAL = (4, 49)
    BROWSING_LAST_CARD = (4, 50)
    BROWSING_LEARNING = (4, 51)
    BROWSING_LINE_SIZE = (4, 52)
    BROWSING_MANAGE_NOTE_TYPES = (4, 53)
    BROWSING_MOVE_CARDS = (4, 54)
    BROWSING_MOVE_CARDS_TO_DECK = (4, 55)
    BROWSING_NEW = (4, 56)
    BROWSING_NEW_NOTE_TYPE = (4, 57)
    BROWSING_NO_FLAG = (4, 58)
    BROWSING_NO_SELECTION = (4, 59)
    BROWSING_NOTE = (4, 60)
    BROWSING_NOTE_COUNT = (4, 61)
    BROWSING_NOTE_INITIAL = (4, 62)
    BROWSING_NOTES_UPDATED = (4, 63)
    BROWSING_OPTIONAL_FILTER = (4, 64)
    BROWSING_OVERRIDE_BACK_TEMPLATE = (4, 65)
    BROWSING_OVERRIDE_FONT = (4, 66)
    BROWSING_OVERRIDE_FRONT_TEMPLATE = (4, 67)
    BROWSING_PLEASE_GIVE_YOUR_FILTER_A_NAME = (4, 68)
    BROWSING_PREVIEW_SELECTED_CARD = (4, 69)
    BROWSING_QUESTION = (4, 70)
    BROWSING_QUEUE_BOTTOM = (4, 71)
    BROWSING_QUEUE_TOP = (4, 72)
    BROWSING_RANDOMIZE_ORDER = (4, 73)
    BROWSING_REMOVE_FROM_SELECTED_NOTES = (4, 74)
    BROWSING_REMOVE_TAGS = (4, 75)
    BROWSING_REMOVED_UNUSED_TAGS_COUNT = (4, 76)
    BROWSING_REPARENTED_DECKS = (4, 77)
    BROWSING_REPLACE_WITH = (4, 78)
    BROWSING_REPOSITION = (4, 79)
    BROWSING_REPOSITION_NEW_CARDS = (4, 80)
    BROWSING_RESCHEDULE = (4, 81)
    BROWSING_ROW_DELETED = (4, 82)
    BROWSING_SEARCH_BAR_HINT = (4, 83)
    BROWSING_SEARCH_IN = (4, 84)
    BROWSING_SEARCH_WITHIN_FORMATTING_SLOW = (4, 85)
    BROWSING_SELECTED_NOTES_ONLY = (4, 86)
    BROWSING_SHIFT_POSITION_OF_EXISTING_CARDS = (4, 87)
    BROWSING_SIDEBAR = (4, 88)
    BROWSING_SIDEBAR_CARD_STATE = (4, 89)
    BROWSING_SIDEBAR_COLLAPSE = (4, 90)
    BROWSING_SIDEBAR_COLLAPSE_CHILDREN = (4, 91)
    BROWSING_SIDEBAR_DECKS = (4, 92)
    BROWSING_SIDEBAR_DUE_TODAY = (4, 93)
    BROWSING_SIDEBAR_EXPAND = (4, 94)
    BROWSING_SIDEBAR_EXPAND_CHILDREN = (4, 95)
    BROWSING_SIDEBAR_FILTER = (4, 96)
    BROWSING_SIDEBAR_FIRST_REVIEW = (4, 97)
    BROWSING_SIDEBAR_FLAGS = (4, 98)
    BROWSING_SIDEBAR_NOTETYPES = (4, 99)
    BROWSING_SIDEBAR_OVERDUE = (4, 100)
    BROWSING_SIDEBAR_RESCHEDULED = (4, 101)
    BROWSING_SIDEBAR_SAVE_CURRENT_SEARCH = (4, 102)
    BROWSING_SIDEBAR_SAVED_SEARCHES = (4, 103)
    BROWSING_SIDEBAR_TAGS = (4, 104)
    BROWSING_SIDEBAR_UNTAGGED = (4, 105)
    BROWSING_SORT_FIELD = (4, 106)
    BROWSING_SORTING_ON_THIS_COLUMN_IS_NOT = (4, 107)
    BROWSING_START_POSITION = (4, 108)
    BROWSING_STEP = (4, 109)
    BROWSING_STUDIED_TODAY = (4, 110)
    BROWSING_SUSPENDED = (4, 111)
    BROWSING_TAG_DUPLICATES = (4, 112)
    BROWSING_TAG_RENAME_WARNING_EMPTY = (4, 113)
    BROWSING_TARGET_FIELD = (4, 114)
    BROWSING_TODAY = (4, 115)
    BROWSING_TOGGLE_MARK = (4, 116)
    BROWSING_TOGGLE_SHOWING_CARDS_NOTES = (4, 117)
    BROWSING_TOGGLE_SUSPEND = (4, 118)
    BROWSING_TOOLTIP_ANSWER = (4, 119)
    BROWSING_TOOLTIP_CARD = (4, 120)
    BROWSING_TOOLTIP_CARD_MODIFIED = (4, 121)
    BROWSING_TOOLTIP_CARDS = (4, 122)
    BROWSING_TOOLTIP_NOTE_MODIFIED = (4, 123)
    BROWSING_TOOLTIP_NOTETYPE = (4, 124)
    BROWSING_TOOLTIP_QUESTION = (4, 125)
    BROWSING_TREAT_INPUT_AS_REGULAR_EXPRESSION = (4, 126)
    BROWSING_UPDATE_SAVED_SEARCH = (4, 127)
    BROWSING_WHOLE_COLLECTION = (4, 128)
    BROWSING_WINDOW_TITLE = (4, 129)
    BROWSING_WINDOW_TITLE_NOTES = (4, 130)
    BROWSING_YOU_MUST_HAVE_AT_LEAST_ONE = (4, 131)
    ...
    CARD_STATS_DECK_NAME = (5, 5)
    CARD_STATS_EASE = (5, 6)
    CARD_STATS_FIRST_REVIEW = (5, 7)
    CARD_STATS_INTERVAL = (5, 8)
    CARD_STATS_LAPSE_COUNT = (5, 9)
    CARD_STATS_LATEST_REVIEW = (5, 10)
    CARD_STATS_NEW_CARD_POSITION = (5, 11)
    CARD_STATS_NO_CARD = (5, 12)
    CARD_STATS_NOTE_ID = (5, 13)
    CARD_STATS_NOTE_TYPE = (5, 14)
    CARD_STATS_PREVIOUS_CARD = (5, 15)
    CARD_STATS_REVIEW_COUNT = (5, 16)
    CARD_STATS_REVIEW_LOG_DATE = (5, 17)
    CARD_STATS_REVIEW_LOG_RATING = (5, 18)
    CARD_STATS_REVIEW_LOG_TIME_TAKEN = (5, 19)
    CARD_STATS_REVIEW_LOG_TYPE = (5, 20)
    CARD_STATS_REVIEW_LOG_TYPE_FILTERED = (5, 21)
    CARD_STATS_REVIEW_LOG_TYPE_LEARN = (5, 22)
    CARD_STATS_REVIEW_LOG_TYPE_MANUAL = (5, 23)
    CARD_STATS_REVIEW_LOG_TYPE_RELEARN = (5, 24)
    CARD_STATS_REVIEW_LOG_TYPE_REVIEW = (5, 25)
    CARD_STATS_TOTAL_TIME = (5, 26)
    ...
    CARD_TEMPLATES_SAMPLE_CLOZE = (7, 38)
    CARD_TEMPLATES_SEE_PREVIEW = (7, 39)
    CARD_TEMPLATES_TEMPLATE_BOX = (7, 40)
    CARD_TEMPLATES_TEMPLATE_STYLING = (7, 41)
    CARD_TEMPLATES_THIS_WILL_CREATE_CARD_PROCEED = (7, 42)
    ...
    DECK_CONFIG_BURY_INTERDAY_LEARNING_SIBLINGS = (11, 4)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (11, 5)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (11, 6)
    DECK_CONFIG_BURY_TITLE = (11, 7)
    DECK_CONFIG_BURY_TOOLTIP = (11, 8)
    DECK_CONFIG_CLONE_GROUP = (11, 9)
    ...
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 34)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 35)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 36)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 37)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 38)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 39)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 40)
    DECK_CONFIG_NAME_PROMPT = (11, 41)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 42)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 43)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 44)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 45)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 46)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 47)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 48)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 49)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 50)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 51)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 52)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 53)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 54)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 55)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 56)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 57)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 58)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 59)
    DECK_CONFIG_ORDERING_TITLE = (11, 60)
    DECK_CONFIG_RELEARNING_STEPS = (11, 61)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 62)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 63)
    DECK_CONFIG_REMOVE_GROUP = (11, 64)
    DECK_CONFIG_RENAME_GROUP = (11, 65)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 66)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 67)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 68)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 69)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 70)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 71)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 72)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 73)
    DECK_CONFIG_SAVE_BUTTON = (11, 74)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 75)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 76)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 77)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 78)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 79)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 80)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 81)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 82)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 83)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 84)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 85)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 86)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 87)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 88)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 89)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 90)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 91)
    DECK_CONFIG_TIMER_TITLE = (11, 92)
    DECK_CONFIG_TITLE = (11, 93)
    DECK_CONFIG_USED_BY_DECKS = (11, 94)
    DECK_CONFIG_WHICH_DECK = (11, 95)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 96)
    ...
    EDITING_AN_ERROR_OCCURRED_WHILE_OPENING = (13, 4)
    EDITING_ATTACH_PICTURESAUDIOVIDEO = (13, 5)
    EDITING_BOLD_TEXT = (13, 6)
    EDITING_CARDS = (13, 7)
    EDITING_CENTER = (13, 8)
    EDITING_CHANGE_COLOR = (13, 9)
    EDITING_CLOZE_DELETION = (13, 10)
    EDITING_CLOZE_DELETION_REPEAT = (13, 11)
    EDITING_COULDNT_RECORD_AUDIO_HAVE_YOU_INSTALLED = (13, 12)
    EDITING_CUSTOMIZE_CARD_TEMPLATES = (13, 13)
    EDITING_CUSTOMIZE_FIELDS = (13, 14)
    EDITING_CUT = (13, 15)
    EDITING_DOUBLE_CLICK_IMAGE = (13, 16)
    EDITING_DOUBLE_CLICK_TO_EXPAND = (13, 17)
    EDITING_EDIT_CURRENT = (13, 18)
    EDITING_EDIT_HTML = (13, 19)
    EDITING_FIELDS = (13, 20)
    EDITING_FLOAT_LEFT = (13, 21)
    EDITING_FLOAT_NONE = (13, 22)
    EDITING_FLOAT_RIGHT = (13, 23)
    EDITING_HTML_EDITOR = (13, 24)
    EDITING_INDENT = (13, 25)
    EDITING_ITALIC_TEXT = (13, 26)
    EDITING_JUMP_TO_TAGS_WITH_CTRLANDSHIFTANDT = (13, 27)
    EDITING_JUSTIFY = (13, 28)
    EDITING_LATEX = (13, 29)
    EDITING_LATEX_EQUATION = (13, 30)
    EDITING_LATEX_MATH_ENV = (13, 31)
    EDITING_MATHJAX_BLOCK = (13, 32)
    EDITING_MATHJAX_CHEMISTRY = (13, 33)
    EDITING_MATHJAX_INLINE = (13, 34)
    EDITING_MATHJAX_PLACEHOLDER = (13, 35)
    EDITING_MEDIA = (13, 36)
    EDITING_ORDERED_LIST = (13, 37)
    EDITING_OUTDENT = (13, 38)
    EDITING_PASTE = (13, 39)
    EDITING_RECORD_AUDIO = (13, 40)
    EDITING_REMOVE_FORMATTING = (13, 41)
    EDITING_RESTORE_ORIGINAL_SIZE = (13, 42)
    EDITING_SELECT_REMOVE_FORMATTING = (13, 43)
    EDITING_SHOW_DUPLICATES = (13, 44)
    EDITING_SUBSCRIPT = (13, 45)
    EDITING_SUPERSCRIPT = (13, 46)
    EDITING_TAGS = (13, 47)
    EDITING_TAGS_ADD = (13, 48)
    EDITING_TAGS_COPY = (13, 49)
    EDITING_TAGS_REMOVE = (13, 50)
    EDITING_TAGS_SELECT_ALL = (13, 51)
    EDITING_TEXT_COLOR = (13, 52)
    EDITING_TEXT_HIGHLIGHT_COLOR = (13, 53)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (13, 54)
    EDITING_TOGGLE_HTML_EDITOR = (13, 55)
    EDITING_TOGGLE_STICKY = (13, 56)
    EDITING_TOGGLE_VISUAL_EDITOR = (13, 57)
    EDITING_UNDERLINE_TEXT = (13, 58)
    EDITING_UNORDERED_LIST = (13, 59)
    EDITING_WARNING_CLOZE_DELETIONS_WILL_NOT_WORK = (13, 60)
    ...
    ERRORS_INVALID_IDS = (15, 7)
    ERRORS_INVALID_INPUT_DETAILS = (15, 8)
    ERRORS_INVALID_INPUT_EMPTY = (15, 9)
    ERRORS_MULTIPLE_NOTETYPES_SELECTED = (15, 10)
    ERRORS_OPTION_NOT_SET = (15, 11)
    ERRORS_PARSE_NUMBER_FAIL = (15, 12)
    ERRORS_PLEASE_CHECK_DATABASE = (15, 13)
    ERRORS_PLEASE_CHECK_MEDIA = (15, 14)
    ERRORS_STANDARD_POPUP = (15, 15)
    ERRORS_UNABLE_OPEN_COLLECTION = (15, 16)
    ERRORS_WINDOWS_TTS_RUNTIME_ERROR = (15, 17)
    ...
    FIELDS_DESCRIPTION = (17, 2)
    FIELDS_DESCRIPTION_PLACEHOLDER = (17, 3)
    FIELDS_EDITING_FONT = (17, 4)
    FIELDS_FIELD = (17, 5)
    FIELDS_FIELD_NAME = (17, 6)
    FIELDS_FIELDS_FOR = (17, 7)
    FIELDS_FONT = (17, 8)
    FIELDS_NAME_FIRST_LETTER_NOT_VALID = (17, 9)
    FIELDS_NAME_INVALID_LETTER = (17, 10)
    FIELDS_NEW_POSITION_1 = (17, 11)
    FIELDS_NOTES_REQUIRE_AT_LEAST_ONE_FIELD = (17, 12)
    FIELDS_REVERSE_TEXT_DIRECTION_RTL = (17, 13)
    FIELDS_SIZE = (17, 14)
    FIELDS_SORT_BY_THIS_FIELD_IN_THE = (17, 15)
    FIELDS_THAT_FIELD_NAME_IS_ALREADY_USED = (17, 16)
    FINDREPLACE_NOTES_UPDATED = (18, 0)
    IMPORTING_ABORTED = (19, 0)
    IMPORTING_ADDED_DUPLICATE_WITH_FIRST_FIELD = (19, 1)
    IMPORTING_ALL_SUPPORTED_FORMATS = (19, 2)
    IMPORTING_ALLOW_HTML_IN_FIELDS = (19, 3)
    IMPORTING_ANKI_FILES_ARE_FROM_A_VERY = (19, 4)
    IMPORTING_ANKI2_FILES_ARE_NOT_DIRECTLY_IMPORTABLE = (19, 5)
    IMPORTING_APPEARED_TWICE_IN_FILE = (19, 6)
    IMPORTING_BY_DEFAULT_ANKI_WILL_DETECT_THE = (19, 7)
    IMPORTING_CHANGE = (19, 8)
    IMPORTING_COLON = (19, 9)
    IMPORTING_COMMA = (19, 10)
    IMPORTING_DUPLICATE = (19, 11)
    IMPORTING_EMPTY_FIRST_FIELD = (19, 12)
    IMPORTING_EXISTING_NOTES = (19, 13)
    IMPORTING_EXTRACTING = (19, 14)
    IMPORTING_FAILED_DEBUG_INFO = (19, 15)
    IMPORTING_FAILED_TO_IMPORT_MEDIA_FILE = (19, 16)
    IMPORTING_FIELD_MAPPING = (19, 17)
    IMPORTING_FIELD_OF_FILE_IS = (19, 18)
    IMPORTING_FIELD_SEPARATOR = (19, 19)
    IMPORTING_FIELDS_SEPARATED_BY = (19, 20)
    IMPORTING_FILE = (19, 21)
    IMPORTING_FILE_MUST_CONTAIN_FIELD_COLUMN = (19, 22)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (19, 23)
    IMPORTING_FIRST_FIELD_MATCHED = (19, 24)
    IMPORTING_GATHERING = (19, 25)
    IMPORTING_IDENTICAL = (19, 26)
    IMPORTING_IGNORE_FIELD = (19, 27)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (19, 28)
    IMPORTING_IGNORED = (19, 29)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (19, 30)
    IMPORTING_IMPORT_OPTIONS = (19, 31)
    IMPORTING_IMPORTING_COLLECTION = (19, 32)
    IMPORTING_IMPORTING_COMPLETE = (19, 33)
    IMPORTING_IMPORTING_FILE = (19, 34)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (19, 35)
    IMPORTING_MAP_TO = (19, 36)
    IMPORTING_MAP_TO_TAGS = (19, 37)
    IMPORTING_MAPPED_TO = (19, 38)
    IMPORTING_MAPPED_TO_TAGS = (19, 39)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (19, 40)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (19, 41)
    IMPORTING_NOTE_ADDED = (19, 42)
    IMPORTING_NOTE_IMPORTED = (19, 43)
    IMPORTING_NOTE_UNCHANGED = (19, 44)
    IMPORTING_NOTE_UPDATED = (19, 45)
    IMPORTING_NOTES_ADDED_FROM_FILE = (19, 46)
    IMPORTING_NOTES_FOUND_IN_FILE = (19, 47)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (19, 48)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (19, 49)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (19, 50)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (19, 51)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (19, 52)
    IMPORTING_PIPE = (19, 53)
    IMPORTING_PRESERVE = (19, 54)
    IMPORTING_PROCESSED_CARDS = (19, 55)
    IMPORTING_PROCESSED_MEDIA_FILE = (19, 56)
    IMPORTING_PROCESSED_NOTES = (19, 57)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (19, 58)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (19, 59)
    IMPORTING_SEMICOLON = (19, 60)
    IMPORTING_SKIPPED = (19, 61)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (19, 62)
    IMPORTING_TAB = (19, 63)
    IMPORTING_TAG_ALL_NOTES = (19, 64)
    IMPORTING_TAG_MODIFIED_NOTES = (19, 65)
    IMPORTING_TAG_UPDATED_NOTES = (19, 66)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (19, 67)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (19, 68)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (19, 69)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (19, 70)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (19, 71)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (19, 72)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (19, 73)
    IMPORTING_UNKNOWN_FILE_FORMAT = (19, 74)
    IMPORTING_UPDATE = (19, 75)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (19, 76)
    IMPORTING_UPDATED = (19, 77)
    KEYBOARD_CTRL = (20, 0)
    KEYBOARD_SHIFT = (20, 1)
    ...
    NOTETYPES_NOTETYPE = (24, 23)
    NOTETYPES_OPTIONS = (24, 24)
    NOTETYPES_PLEASE_ADD_ANOTHER_NOTE_TYPE_FIRST = (24, 25)
    NOTETYPES_TEXT_FIELD = (24, 26)
    NOTETYPES_TYPE = (24, 27)
    PREFERENCES_AUTOMATICALLY_SYNC_ON_PROFILE_OPENCLOSE = (25, 0)
    PREFERENCES_BACKUP_EXPLANATION = (25, 1)
    PREFERENCES_BACKUPS = (25, 2)
    PREFERENCES_BASIC = (25, 3)
    PREFERENCES_CHANGE_DECK_DEPENDING_ON_NOTE_TYPE = (25, 4)
    PREFERENCES_CHANGES_WILL_TAKE_EFFECT_WHEN_YOU = (25, 5)
    PREFERENCES_DAILY_BACKUPS = (25, 6)
    PREFERENCES_DEFAULT_SEARCH_TEXT = (25, 7)
    PREFERENCES_DEFAULT_SEARCH_TEXT_EXAMPLE = (25, 8)
    PREFERENCES_HOURS_PAST_MIDNIGHT = (25, 9)
    PREFERENCES_IGNORE_ACCENTS_IN_SEARCH = (25, 10)
    PREFERENCES_INTERFACE_LANGUAGE = (25, 11)
    PREFERENCES_INTERRUPT_CURRENT_AUDIO_WHEN_ANSWERING = (25, 12)
    PREFERENCES_LEARN_AHEAD_LIMIT = (25, 13)
    PREFERENCES_LEGACY_TIMEZONE_HANDLING = (25, 14)
    PREFERENCES_MINS = (25, 15)
    PREFERENCES_MINUTES_BETWEEN_BACKUPS = (25, 16)
    PREFERENCES_MONTHLY_BACKUPS = (25, 17)
    PREFERENCES_NETWORK = (25, 18)
    PREFERENCES_NEXT_DAY_STARTS_AT = (25, 19)
    PREFERENCES_NOTE_MEDIA_IS_NOT_BACKED_UP = (25, 20)
    PREFERENCES_ON_NEXT_SYNC_FORCE_CHANGES_IN = (25, 21)
    PREFERENCES_PASTE_CLIPBOARD_IMAGES_AS_PNG = (25, 22)
    PREFERENCES_PASTE_WITHOUT_SHIFT_KEY_STRIPS_FORMATTING = (25, 23)
    PREFERENCES_PERIODICALLY_SYNC_MEDIA = (25, 24)
    PREFERENCES_PLEASE_RESTART_ANKI_TO_COMPLETE_LANGUAGE = (25, 25)
    PREFERENCES_PREFERENCES = (25, 26)
    PREFERENCES_SCHEDULING = (25, 27)
    PREFERENCES_SHOW_LEARNING_CARDS_WITH_LARGER_STEPS = (25, 28)
    PREFERENCES_SHOW_NEXT_REVIEW_TIME_ABOVE_ANSWER = (25, 29)
    PREFERENCES_SHOW_PLAY_BUTTONS_ON_CARDS_WITH = (25, 30)
    PREFERENCES_SHOW_REMAINING_CARD_COUNT_DURING_REVIEW = (25, 31)
    PREFERENCES_SOME_SETTINGS_WILL_TAKE_EFFECT_AFTER = (25, 32)
    PREFERENCES_SYNCHRONISATION = (25, 33)
    PREFERENCES_SYNCHRONIZATIONNOT_CURRENTLY_ENABLED_CLICK_THE_SYNC = (25, 34)
    PREFERENCES_SYNCHRONIZE_AUDIO_AND_IMAGES_TOO = (25, 35)
    PREFERENCES_THEME_DARK = (25, 36)
    PREFERENCES_THEME_FOLLOW_SYSTEM = (25, 37)
    PREFERENCES_THEME_LABEL = (25, 38)
    PREFERENCES_THEME_LIGHT = (25, 39)
    PREFERENCES_TIMEBOX_TIME_LIMIT = (25, 40)
    PREFERENCES_USER_INTERFACE_SIZE = (25, 41)
    PREFERENCES_V3_SCHEDULER = (25, 42)
    PREFERENCES_VIDEO_DRIVER = (25, 43)
    PREFERENCES_VIDEO_DRIVER_ANGLE = (25, 44)
    PREFERENCES_VIDEO_DRIVER_OPENGL_MAC = (25, 45)
    PREFERENCES_VIDEO_DRIVER_OPENGL_OTHER = (25, 46)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_MAC = (25, 47)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_OTHER = (25, 48)
    PREFERENCES_WEEKLY_BACKUPS = (25, 49)
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (25, 50)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (25, 51)
    PROFILES_ANKI_COULD_NOT_READ_YOUR_PROFILE = (26, 0)
    PROFILES_ANKI_COULD_NOT_RENAME_YOUR_PROFILE = (26, 1)
    PROFILES_BACKUP_CREATED = (26, 2)
    PROFILES_BACKUP_CREATION_FAILED = (26, 3)
    PROFILES_BACKUP_UNCHANGED = (26, 4)
    PROFILES_CONFIRM_LANG_CHOICE = (26, 5)
    PROFILES_COULD_NOT_CREATE_DATA_FOLDER = (26, 6)
    PROFILES_CREATING_BACKUP = (26, 7)
    PROFILES_DOWNGRADE_AND_QUIT = (26, 8)
    PROFILES_FOLDER_ALREADY_EXISTS = (26, 9)
    PROFILES_FOLDER_README = (26, 10)
    PROFILES_OPEN = (26, 11)
    PROFILES_OPEN_BACKUP = (26, 12)
    PROFILES_PLEASE_REMOVE_THE_FOLDER_AND = (26, 13)
    PROFILES_PREFS_CORRUPT_TITLE = (26, 14)
    PROFILES_PREFS_FILE_IS_CORRUPT = (26, 15)
    PROFILES_PROFILE_CORRUPT = (26, 16)
    PROFILES_PROFILE_DOES_NOT_EXIST = (26, 17)
    PROFILES_PROFILES = (26, 18)
    PROFILES_QUIT = (26, 19)
    PROFILES_USER_1 = (26, 20)
    QT_ACCEL_ABOUT = (27, 0)
    QT_ACCEL_CARDS = (27, 1)
    QT_ACCEL_CHECK_DATABASE = (27, 2)
    QT_ACCEL_CHECK_MEDIA = (27, 3)
    QT_ACCEL_CREATE_BACKUP = (27, 4)
    QT_ACCEL_EDIT = (27, 5)
    QT_ACCEL_EXIT = (27, 6)
    ...
    QT_ACCEL_FULL_SCREEN = (27, 15)
    QT_ACCEL_GO = (27, 16)
    QT_ACCEL_GUIDE = (27, 17)
    QT_ACCEL_HELP = (27, 18)
    QT_ACCEL_IMPORT = (27, 19)
    QT_ACCEL_INFO = (27, 20)
    QT_ACCEL_INVERT_SELECTION = (27, 21)
    QT_ACCEL_NEXT_CARD = (27, 22)
    QT_ACCEL_NOTE = (27, 23)
    QT_ACCEL_NOTES = (27, 24)
    QT_ACCEL_PREFERENCES = (27, 25)
    QT_ACCEL_PREVIOUS_CARD = (27, 26)
    QT_ACCEL_REDO = (27, 27)
    QT_ACCEL_RESET_ZOOM = (27, 28)
    QT_ACCEL_SELECT_ALL = (27, 29)
    QT_ACCEL_SELECT_NOTES = (27, 30)
    QT_ACCEL_SET_DUE_DATE = (27, 31)
    QT_ACCEL_SUPPORT_ANKI = (27, 32)
    QT_ACCEL_SWITCH_PROFILE = (27, 33)
    QT_ACCEL_TOOLS = (27, 34)
    QT_ACCEL_UNDO = (27, 35)
    QT_ACCEL_VIEW = (27, 36)
    QT_ACCEL_ZOOM_EDITOR_IN = (27, 37)
    QT_ACCEL_ZOOM_EDITOR_OUT = (27, 38)
    QT_ACCEL_ZOOM_IN = (27, 39)
    QT_ACCEL_ZOOM_OUT = (27, 40)
    ...
    QT_MISC_EMPTY_CARDS = (28, 19)
    QT_MISC_ERROR = (28, 20)
    QT_MISC_ERROR_DURING_STARTUP = (28, 21)
    QT_MISC_ERROR_LOADING_GRAPHICS_DRIVER = (28, 22)
    QT_MISC_IF_INSTANCE_IS_NOT_RESPONDING = (28, 23)
    QT_MISC_IGNORE_THIS_UPDATE = (28, 24)
    QT_MISC_IN_ORDER_TO_ENSURE_YOUR_COLLECTION = (28, 25)
    QT_MISC_INCOMPATIBLE_VIDEO_DRIVER = (28, 26)
    QT_MISC_INVALID_PROPERTY_FOUND_ON_CARD_PLEASE = (28, 27)
    QT_MISC_LOADING = (28, 28)
    QT_MISC_MANAGE = (28, 29)
    QT_MISC_MANAGE_NOTE_TYPES = (28, 30)
    QT_MISC_NAME_EXISTS = (28, 31)
    QT_MISC_NO_TEMP_FOLDER = (28, 32)
    QT_MISC_NON_UNICODE_TEXT = (28, 33)
    QT_MISC_OPTIMIZING = (28, 34)
    QT_MISC_PLEASE_ENSURE_A_PROFILE_IS_OPEN = (28, 35)
    QT_MISC_PLEASE_SELECT_1_CARD = (28, 36)
    QT_MISC_PLEASE_SELECT_A_DECK = (28, 37)
    QT_MISC_PLEASE_USE_FILEIMPORT_TO_IMPORT_THIS = (28, 38)
    QT_MISC_PROCESSING = (28, 39)
    QT_MISC_REPLACE_YOUR_COLLECTION_WITH_AN_EARLIER = (28, 40)
    QT_MISC_REVERT_TO_BACKUP = (28, 41)
    QT_MISC_SECOND = (28, 42)
    QT_MISC_SEGOE_UI = (28, 43)
    QT_MISC_SHIFT_KEY_WAS_HELD_DOWN_SKIPPING = (28, 44)
    QT_MISC_SHORTCUT_KEY_LEFT_ARROW = (28, 45)
    QT_MISC_SHORTCUT_KEY_RIGHT_ARROW_OR_ENTER = (28, 46)
    QT_MISC_STATS = (28, 47)
    QT_MISC_STUDY_DECK = (28, 48)
    QT_MISC_SYNC = (28, 49)
    QT_MISC_TARGET_DECK_CTRLANDD = (28, 50)
    QT_MISC_THE_FOLLOWING_CHARACTER_CAN_NOT_BE = (28, 51)
    QT_MISC_THE_REQUESTED_CHANGE_WILL_REQUIRE_A = (28, 52)
    QT_MISC_THERE_MUST_BE_AT_LEAST_ONE = (28, 53)
    QT_MISC_THIS_FILE_EXISTS_ARE_YOU_SURE = (28, 54)
    QT_MISC_UNABLE_TO_ACCESS_ANKI_MEDIA_FOLDER = (28, 55)
    QT_MISC_UNABLE_TO_RECORD = (28, 56)
    QT_MISC_UNEXPECTED_RESPONSE_CODE = (28, 57)
    QT_MISC_WOULD_YOU_LIKE_TO_DOWNLOAD_IT = (28, 58)
    QT_MISC_YOUR_COLLECTION_FILE_APPEARS_TO_BE = (28, 59)
    QT_MISC_YOUR_COMPUTERS_STORAGE_MAY_BE_FULL = (28, 60)
    QT_MISC_YOUR_FIREWALL_OR_ANTIVIRUS_PROGRAM_IS = (28, 61)
    ...
    SCHEDULING_EASY_BONUS = (29, 17)
    SCHEDULING_EASY_INTERVAL = (29, 18)
    SCHEDULING_END = (29, 19)
    SCHEDULING_FORGOT_CARDS = (29, 20)
    SCHEDULING_GENERAL = (29, 21)
    SCHEDULING_GRADUATING_INTERVAL = (29, 22)
    SCHEDULING_HARD_INTERVAL = (29, 23)
    SCHEDULING_HOW_TO_CUSTOM_STUDY = (29, 24)
    SCHEDULING_IGNORE_ANSWER_TIMES_LONGER_THAN = (29, 25)
    SCHEDULING_INTERVAL_MODIFIER = (29, 26)
    SCHEDULING_LAPSES = (29, 27)
    SCHEDULING_LAPSES2 = (29, 28)
    SCHEDULING_LEARN_REMAINING = (29, 29)
    SCHEDULING_LEARNING = (29, 30)
    SCHEDULING_LEECH_ACTION = (29, 31)
    SCHEDULING_LEECH_THRESHOLD = (29, 32)
    SCHEDULING_MAXIMUM_INTERVAL = (29, 33)
    SCHEDULING_MAXIMUM_REVIEWSDAY = (29, 34)
    SCHEDULING_MINIMUM_INTERVAL = (29, 35)
    SCHEDULING_MIX_NEW_CARDS_AND_REVIEWS = (29, 36)
    SCHEDULING_NEW_CARDS = (29, 37)
    SCHEDULING_NEW_CARDSDAY = (29, 38)
    SCHEDULING_NEW_INTERVAL = (29, 39)
    SCHEDULING_NEW_OPTIONS_GROUP_NAME = (29, 40)
    SCHEDULING_NEXT_LEARN_DUE = (29, 41)
    SCHEDULING_OPTIONS_GROUP = (29, 42)
    SCHEDULING_ORDER = (29, 43)
    SCHEDULING_PARENT_LIMIT = (29, 44)
    SCHEDULING_RESET_COUNTS = (29, 45)
    SCHEDULING_RESTORE_POSITION = (29, 46)
    SCHEDULING_REVIEW = (29, 47)
    SCHEDULING_REVIEWS = (29, 48)
    SCHEDULING_SECONDS = (29, 49)
    SCHEDULING_SET_ALL_DECKS_BELOW_TO = (29, 50)
    SCHEDULING_SET_DUE_DATE_DONE = (29, 51)
    SCHEDULING_SET_DUE_DATE_PROMPT = (29, 52)
    SCHEDULING_SET_DUE_DATE_PROMPT_HINT = (29, 53)
    SCHEDULING_SET_FOR_ALL_SUBDECKS = (29, 54)
    SCHEDULING_SHOW_ANSWER_TIMER = (29, 55)
    SCHEDULING_SHOW_NEW_CARDS_AFTER_REVIEWS = (29, 56)
    SCHEDULING_SHOW_NEW_CARDS_BEFORE_REVIEWS = (29, 57)
    SCHEDULING_SHOW_NEW_CARDS_IN_ORDER_ADDED = (29, 58)
    SCHEDULING_SHOW_NEW_CARDS_IN_RANDOM_ORDER = (29, 59)
    SCHEDULING_STARTING_EASE = (29, 60)
    SCHEDULING_STEPS_IN_MINUTES = (29, 61)
    SCHEDULING_STEPS_MUST_BE_NUMBERS = (29, 62)
    SCHEDULING_TAG_ONLY = (29, 63)
    SCHEDULING_THE_DEFAULT_CONFIGURATION_CANT_BE_REMOVED = (29, 64)
    SCHEDULING_TIME_SPAN_DAYS = (29, 65)
    SCHEDULING_TIME_SPAN_HOURS = (29, 66)
    SCHEDULING_TIME_SPAN_MINUTES = (29, 67)
    SCHEDULING_TIME_SPAN_MONTHS = (29, 68)
    SCHEDULING_TIME_SPAN_SECONDS = (29, 69)
    SCHEDULING_TIME_SPAN_YEARS = (29, 70)
    SCHEDULING_TODAY_NEW_LIMIT_REACHED = (29, 71)
    SCHEDULING_TODAY_REVIEW_LIMIT_REACHED = (29, 72)
    SCHEDULING_UNBURY_THEM = (29, 73)
    SCHEDULING_UPDATE_BUTTON = (29, 74)
    SCHEDULING_UPDATE_DONE = (29, 75)
    SCHEDULING_UPDATE_LATER_BUTTON = (29, 76)
    SCHEDULING_UPDATE_MORE_INFO_BUTTON = (29, 77)
    SCHEDULING_UPDATE_REQUIRED = (29, 78)
    SCHEDULING_UPDATE_SOON = (29, 79)
    SCHEDULING_YOUR_CHANGES_WILL_AFFECT_MULTIPLE_DECKS = (29, 80)
    ...
    STATISTICS_COUNTS_FILTERED_CARDS = (31, 24)
    ...
    STATISTICS_MINUTES_PER_DAY = (31, 65)
    STATISTICS_NO_DATA = (31, 66)
    STATISTICS_RANGE_1_YEAR_HISTORY = (31, 67)
    STATISTICS_RANGE_ALL_HISTORY = (31, 68)
    STATISTICS_RANGE_ALL_TIME = (31, 69)
    STATISTICS_RANGE_COLLECTION = (31, 70)
    STATISTICS_RANGE_DECK = (31, 71)
    STATISTICS_RANGE_SEARCH = (31, 72)
    STATISTICS_REVIEWS = (31, 73)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (31, 74)
    STATISTICS_REVIEWS_PER_DAY = (31, 75)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (31, 76)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (31, 77)
    STATISTICS_REVIEWS_TITLE = (31, 78)
    STATISTICS_RUNNING_TOTAL = (31, 79)
    STATISTICS_SAVE_PDF = (31, 80)
    STATISTICS_SAVED = (31, 81)
    STATISTICS_STATS = (31, 82)
    STATISTICS_STUDIED_TODAY = (31, 83)
    STATISTICS_TODAY_AGAIN_COUNT = (31, 84)
    STATISTICS_TODAY_CORRECT_MATURE = (31, 85)
    STATISTICS_TODAY_NO_CARDS = (31, 86)
    STATISTICS_TODAY_NO_MATURE_CARDS = (31, 87)
    STATISTICS_TODAY_TITLE = (31, 88)
    STATISTICS_TODAY_TYPE_COUNTS = (31, 89)
    STATISTICS_TOTAL = (31, 90)
    STUDYING_AGAIN = (32, 0)
    ...
    STUDYING_CARD_STUDIED_IN = (32, 8)
    STUDYING_CARD_SUSPENDED = (32, 9)
    STUDYING_CARD_WAS_A_LEECH = (32, 10)
    STUDYING_CARDS_BURIED = (32, 11)
    STUDYING_CARDS_WILL_BE_AUTOMATICALLY_RETURNED_TO = (32, 12)
    STUDYING_CONTINUE = (32, 13)
    STUDYING_COUNTS_DIFFER = (32, 14)
    STUDYING_DELETE_NOTE = (32, 15)
    STUDYING_DELETING_THIS_DECK_FROM_THE_DECK = (32, 16)
    STUDYING_EASY = (32, 17)
    STUDYING_EDIT = (32, 18)
    STUDYING_EMPTY = (32, 19)
    STUDYING_FINISH = (32, 20)
    STUDYING_FLAG_CARD = (32, 21)
    STUDYING_GOOD = (32, 22)
    STUDYING_HARD = (32, 23)
    STUDYING_IT_HAS_BEEN_SUSPENDED = (32, 24)
    STUDYING_MANUALLY_BURIED_CARDS = (32, 25)
    STUDYING_MARK_NOTE = (32, 26)
    STUDYING_MINUTE = (32, 27)
    STUDYING_MORE = (32, 28)
    STUDYING_NO_CARDS_ARE_DUE_YET = (32, 29)
    STUDYING_NOTE_SUSPENDED = (32, 30)
    STUDYING_PAUSE_AUDIO = (32, 31)
    STUDYING_PLEASE_RUN_TOOLSEMPTY_CARDS = (32, 32)
    STUDYING_RECORD_OWN_VOICE = (32, 33)
    STUDYING_REPLAY_OWN_VOICE = (32, 34)
    STUDYING_SHOW_ANSWER = (32, 35)
    STUDYING_SPACE = (32, 36)
    STUDYING_STUDY_NOW = (32, 37)
    STUDYING_SUSPEND = (32, 38)
    STUDYING_SUSPEND_NOTE = (32, 39)
    STUDYING_THIS_IS_A_SPECIAL_DECK_FOR = (32, 40)
    STUDYING_TO_REVIEW = (32, 41)
    STUDYING_TYPE_ANSWER_UNKNOWN_FIELD = (32, 42)
    STUDYING_UNBURY = (32, 43)
    STUDYING_WHAT_WOULD_YOU_LIKE_TO_UNBURY = (32, 44)
    STUDYING_YOU_HAVENT_RECORDED_YOUR_VOICE_YET = (32, 45)
...
class GeneratedTranslations:
    ...
    def actions_currently_unsupported(self, ) -> str:
        r''' This action is currently not supported on your system. '''
    ...
    def actions_shortcut_key(self, val: FluentVariable) -> str:
        r''' Shortcut key: {$val} '''
        return self._translate(1, 53, {"val": val})
    ...
    def actions_with_ellipsis(self, action: str) -> str:
        r''' {$action}... '''
        return self._translate(1, 62, {"action": action})
...
{$traceback} '''
    ...
    def browsing_cards_deleted(self, count: int) -> str:
        ...
        return self._translate(4, 18, {"count": count})
    ...
    def browsing_changed_new_position(self, count: int) -> str:
        ...
        return self._translate(4, 25, {"count": count})
    ...
    def browsing_confirm_saved_search_overwrite(self, name: str) -> str:
        ...
        return self._translate(4, 27, {"name": name})
    ...
    def browsing_found_as_across_bs(self, part: FluentVariable, whole: str) -> str:
        ...
        return self._translate(4, 45, {"part": part, "whole": whole})


    def browsing_group(self, count: int) -> str:
        r''' {$count} groups '''
        return self._translate(4, 46, {"count": count})
    ...
    def browsing_note_count(self, count: int) -> str:
        r''' {$count} notes '''
        return self._translate(4, 61, {"count": count})
    ...
    def browsing_preview_selected_card(self, val: FluentVariable) -> str:
        ...
        return self._translate(4, 69, {"val": val})
    ...
    def browsing_removed_unused_tags_count(self, count: int) -> str:
        ...
        return self._translate(4, 76, {"count": count})


    def browsing_reparented_decks(self, count: int) -> str:
        r''' Renamed {$count} decks. '''
        return self._translate(4, 77, {"count": count})
    ...
    def browsing_window_title(self, selected: int, total: int) -> str:
        ...
        return self._translate(4, 129, {"selected": selected, "total": total})


    def browsing_window_title_notes(self, selected: int, total: int) -> str:
        r''' Browse ({$selected} of {$total} notes selected) '''
        return self._translate(4, 130, {"selected": selected, "total": total})
    ...
    def card_stats_previous_card(self, context: str) -> str:
        ...
        return self._translate(5, 15, {"context": context})
...
Please either add a cloze deletion, or use the Empty Cards tool. '''
    ...
    def card_templates_this_will_create_card_proceed(self, count: int) -> str:
        ...
        return self._translate(7, 42, {"count": count})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 73, {"cards": cards, "expected": expected})
...
newly-learned card will delay the next review by 2.5x the previous delay. '''
    ...
    def deck_config_used_by_decks(self, decks: int) -> str:
        ...
        return self._translate(11, 94, {"decks": decks})
...
you proceed. '''
    ...
    def editing_an_error_occurred_while_opening(self, val: FluentVariable) -> str:
        ...
        return self._translate(13, 4, {"val": val})
    ...
    def editing_mathjax_placeholder(self, accept: str, newline: str) -> str:
        ...
        return self._translate(13, 35, {"accept": accept, "newline": newline})
...
Debug info: '''
    ...
    def errors_invalid_input_details(self, details: str) -> str:
        ...
        return self._translate(15, 8, {"details": details})
    ...
    def errors_option_not_set(self, option: str) -> str:
        r''' '{$option}' not set '''
        return self._translate(15, 11, {"option": option})
...
Debug info: '''
    ...
    def fields_fields_for(self, val: FluentVariable) -> str:
        r''' Fields for {$val} '''
        return self._translate(17, 7, {"val": val})
    ...
    def fields_new_position_1(self, val: FluentVariable) -> str:
        ...
        return self._translate(17, 11, {"val": val})
    ...
    def importing_all_supported_formats(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 2, {"val": val})
    ...
    def importing_empty_first_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 12, {"val": val})


    def importing_existing_notes(self, ) -> str:
        r''' Existing notes '''
        return self._translate(19, 13, {})


    def importing_extracting(self, ) -> str:
        r''' Extracting data... '''
        return self._translate(19, 14, {})
    ...
    def importing_failed_to_import_media_file(self, debug_info: str) -> str:
        ...
        return self._translate(19, 16, {"debugInfo": debug_info})
    ...
    def importing_field_of_file_is(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 18, {"val": val})
    ...
    def importing_fields_separated_by(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 20, {"val": val})
    ...
    def importing_first_field_matched(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 24, {"val": val})


    def importing_gathering(self, ) -> str:
        r''' Gathering data... '''
        return self._translate(19, 25, {})
    ...
    def importing_notes_skipped_as_theyre_already_in(self, val: FluentVariable) -> str:
        ...
        return self._translate(19, 48, {"val": val})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(19, 58, {"row": row, "found": found, "expected": expected})
...
Anki will start removing some of them to free up disk space. '''
    ...
    def preferences_theme_label(self, theme: str) -> str:
        r''' Theme: {$theme} '''
        return self._translate(25, 38, {"theme": theme})
    ...
    def preferences_video_driver(self, driver: str) -> str:
        ...
        return self._translate(25, 43, {"driver": driver})
    ...
    def profiles_backup_creation_failed(self, reason: str) -> str:
        ...
        return self._translate(26, 3, {"reason": reason})
    ...
    def profiles_confirm_lang_choice(self, lang: str) -> str:
        ...
        return self._translate(26, 5, {"lang": lang})
...
{$link} '''
        return self._translate(26, 10, {"link": link})
    ...
    def profiles_please_remove_the_folder_and(self, val: FluentVariable) -> str:
        ...
        return self._translate(26, 13, {"val": val})
    ...
    def qt_accel_undo(self, ) -> str:
        r''' &Undo '''
        return self._translate(27, 35, {})


    def qt_accel_view(self, ) -> str:
        r''' &View '''
        return self._translate(27, 36, {})


    def qt_accel_zoom_editor_in(self, ) -> str:
        r''' Zoom Editor &In '''
        return self._translate(27, 37, {})


    def qt_accel_zoom_editor_out(self, ) -> str:
        r''' Zoom Editor &Out '''
        return self._translate(27, 38, {})


    def qt_accel_zoom_in(self, ) -> str:
        r''' Zoom &In '''
        return self._translate(27, 39, {})


    def qt_accel_zoom_out(self, ) -> str:
        r''' Zoom &Out '''
        return self._translate(27, 40, {})
    ...
    def qt_misc_error_during_startup(self, val: FluentVariable) -> str:
        ...
        return self._translate(28, 21, {"val": val})
    ...
    def qt_misc_error_loading_graphics_driver(self, mode: str, context: str) -> str:
        ...
        return self._translate(28, 22, {"mode": mode, "context": context})
    ...
    def qt_misc_in_order_to_ensure_your_collection(self, val: FluentVariable) -> str:
        ...
        return self._translate(28, 25, {"val": val})
    ...
    def qt_misc_second(self, count: int) -> str:
        r''' {$count} seconds '''
        return self._translate(28, 42, {"count": count})
    ...
    def qt_misc_the_following_character_can_not_be(self, val: FluentVariable) -> str:
        ...
        return self._translate(28, 51, {"val": val})
...
Original error: {$error} '''
    ...
    def scheduling_forgot_cards(self, cards: int) -> str:
        ...
        return self._translate(29, 20, {"cards": cards})
    ...
    def scheduling_how_to_custom_study(self, custom_study: str) -> str:
        ...
        return self._translate(29, 24, {"customStudy": custom_study})
    ...
    def scheduling_learn_remaining(self, remaining: int) -> str:
        ...
        return self._translate(29, 29, {"remaining": remaining})
    ...
    def scheduling_next_learn_due(self, unit: str, amount: int) -> str:
        ...
        return self._translate(29, 41, {"unit": unit, "amount": amount})
    ...
    def scheduling_parent_limit(self, val: FluentVariable) -> str:
        r''' (parent limit: {$val}) '''
        return self._translate(29, 44, {"val": val})
    ...
    def scheduling_set_all_decks_below_to(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 50, {"val": val})
    ...
    def scheduling_set_due_date_prompt(self, cards: int) -> str:
        ...
        return self._translate(29, 52, {"cards": cards})
...
3-7 = random choice of 3-7 days '''
    ...
    def scheduling_time_span_years(self, amount: int) -> str:
        r''' {$amount} years '''
        return self._translate(29, 70, {"amount": amount})
...
Please select  before proceeding. '''
    ...
    def statistics_minutes_per_day(self, count: int) -> str:
        r''' {$count} minutes/day '''
        return self._translate(31, 65, {"count": count})


    def statistics_no_data(self, ) -> str:
        r''' NO DATA '''
        return self._translate(31, 66, {})
...
({$secs-per-card}s/card) '''
        return self._translate(31, 83, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(31, 85, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(31, 89, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
    ...
    def studying_card_studied_in(self, count: int) -> str:
        ...
        return self._translate(32, 8, {"count": count})
    ...
    def studying_cards_buried(self, count: int) -> str:
        ...
        return self._translate(32, 11, {"count": count})
    ...
    def studying_minute(self, count: int) -> str:
        r''' {$count} minutes. '''
        return self._translate(32, 27, {"count": count})
    ...
    def studying_type_answer_unknown_field(self, val: FluentVariable) -> str:
        ...
        return self._translate(32, 42, {"val": val})
