...
class RustBackendGenerated:
    ...
    def get_queued_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 0, message)
    ...
    def get_queued_cards(self, *, fetch_limit: int, intraday_learning_only: bool) -> anki.scheduler_pb2.QueuedCards:
        ...
        raw_bytes = self._run_command(0, 0, message.SerializeToString())
    ...
    def answer_card_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 1, message)

    def answer_card(self, message: anki.scheduler_pb2.CardAnswer) -> anki.collection_pb2.OpChanges:
        
        raw_bytes = self._run_command(0, 1, message.SerializeToString())
    ...
    def studied_today_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 3, message)

    def studied_today(self) -> str:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(0, 3, message.SerializeToString())
    ...
    def studied_today_message_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 4, message)
    ...
    def studied_today_message(self, *, cards: int, seconds: float) -> str:
        ...
        raw_bytes = self._run_command(0, 4, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def update_stats_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 5, message)
    ...
    def update_stats(self, *, deck_id: int, new_delta: int, review_delta: int, millisecond_delta: int) -> anki.generic_pb2.Empty:
        ...
        raw_bytes = self._run_command(0, 5, message.SerializeToString())
    ...
    def extend_limits_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 6, message)
    ...
    def extend_limits(self, *, deck_id: int, new_delta: int, review_delta: int) -> anki.generic_pb2.Empty:
        ...
        raw_bytes = self._run_command(0, 6, message.SerializeToString())
        output = anki.generic_pb2.Empty()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def counts_for_deck_today_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 7, message)
    ...
    def counts_for_deck_today(self, did: int) -> anki.scheduler_pb2.CountsForDeckTodayResponse:
        ...
        raw_bytes = self._run_command(0, 7, message.SerializeToString())
    ...
    def congrats_info_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 8, message)

    def congrats_info(self) -> anki.scheduler_pb2.CongratsInfoResponse:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(0, 8, message.SerializeToString())
    ...
    def restore_buried_and_suspended_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 9, message)
    ...
    def restore_buried_and_suspended_cards(self, cids: Sequence[int]) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(0, 9, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def unbury_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 10, message)
    ...
    def unbury_deck(self, *, deck_id: int, mode: anki.scheduler_pb2.UnburyDeckRequest.Mode.V) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(0, 10, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def bury_or_suspend_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 11, message)
    ...
    def bury_or_suspend_cards(self, *, card_ids: Sequence[int], note_ids: Sequence[int], mode: anki.scheduler_pb2.BuryOrSuspendCardsRequest.Mode.V) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(0, 11, message.SerializeToString())
    ...
    def empty_filtered_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 12, message)

    def empty_filtered_deck(self, did: int) -> anki.collection_pb2.OpChanges:
        message = anki.decks_pb2.DeckId(did=did)
        raw_bytes = self._run_command(0, 12, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def rebuild_filtered_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 13, message)

    def rebuild_filtered_deck(self, did: int) -> anki.collection_pb2.OpChangesWithCount:
        message = anki.decks_pb2.DeckId(did=did)
        raw_bytes = self._run_command(0, 13, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def schedule_cards_as_new_defaults_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 15, message)
    ...
    def schedule_cards_as_new_defaults(self, context: anki.scheduler_pb2.ScheduleCardsAsNewRequest.Context.V) -> anki.scheduler_pb2.ScheduleCardsAsNewDefaultsResponse:
        ...
        raw_bytes = self._run_command(0, 15, message.SerializeToString())
    ...
    def set_due_date_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 16, message)
    ...
    def set_due_date(self, *, card_ids: Sequence[int], days: str, config_key: anki.config_pb2.OptionalStringConfigKey) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(0, 16, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def sort_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 17, message)
    ...
    def sort_cards(self, *, card_ids: Sequence[int], starting_from: int, step_size: int, randomize: bool, shift_existing: bool) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(0, 17, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def sort_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 18, message)
    ...
    def sort_deck(self, *, deck_id: int, randomize: bool) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(0, 18, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output


    def get_next_card_states_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 19, message)

    def get_next_card_states(self, cid: int) -> anki.scheduler_pb2.NextCardStates:
        message = anki.cards_pb2.CardId(cid=cid)
        raw_bytes = self._run_command(0, 19, message.SerializeToString())
    ...
    def describe_next_states_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 20, message)

    def describe_next_states(self, message: anki.scheduler_pb2.NextCardStates) -> Sequence[str]:
        
        raw_bytes = self._run_command(0, 20, message.SerializeToString())
    ...
    def state_is_leech_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 21, message)

    def state_is_leech(self, message: anki.scheduler_pb2.SchedulingState) -> bool:
        
        raw_bytes = self._run_command(0, 21, message.SerializeToString())
    ...
    def upgrade_scheduler_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 22, message)

    def upgrade_scheduler(self) -> anki.generic_pb2.Empty:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(0, 22, message.SerializeToString())
        output = anki.generic_pb2.Empty()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def custom_study_defaults_raw(self, message: bytes) -> bytes:
        return self._run_command(0, 24, message)
    ...
    def custom_study_defaults(self, deck_id: int) -> anki.scheduler_pb2.CustomStudyDefaultsResponse:
        ...
        raw_bytes = self._run_command(0, 24, message.SerializeToString())
    ...
    def set_deck_collapsed_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 9, message)
    ...
    def set_deck_collapsed(self, *, deck_id: int, collapsed: bool, scope: anki.decks_pb2.SetDeckCollapsedRequest.Scope.V) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(1, 9, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_deck_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 10, message)

    def get_deck_legacy(self, did: int) -> bytes:
        message = anki.decks_pb2.DeckId(did=did)
        raw_bytes = self._run_command(1, 10, message.SerializeToString())
        output = anki.generic_pb2.Json()
        output.ParseFromString(raw_bytes)
        return output.json
    ...
    def get_deck_names_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 11, message)
    ...
    def get_deck_names(self, *, skip_empty_default: bool, include_filtered: bool) -> Sequence[anki.decks_pb2.DeckNameId]:
        ...
        raw_bytes = self._run_command(1, 11, message.SerializeToString())
    ...
    def get_deck_and_child_names_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 12, message)

    def get_deck_and_child_names(self, did: int) -> Sequence[anki.decks_pb2.DeckNameId]:
        message = anki.decks_pb2.DeckId(did=did)
        raw_bytes = self._run_command(1, 12, message.SerializeToString())
        output = anki.decks_pb2.DeckNames()
        output.ParseFromString(raw_bytes)
        return output.entries
    ...
    def new_deck_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 13, message)

    def new_deck_legacy(self, val: bool) -> bytes:
        message = anki.generic_pb2.Bool(val=val)
        raw_bytes = self._run_command(1, 13, message.SerializeToString())
        output = anki.generic_pb2.Json()
        output.ParseFromString(raw_bytes)
        return output.json
    ...
    def reparent_decks_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 15, message)
    ...
    def reparent_decks(self, *, deck_ids: Sequence[int], new_parent: int) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(1, 15, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def rename_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 16, message)
    ...
    def rename_deck(self, *, deck_id: int, new_name: str) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(1, 16, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_or_create_filtered_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 17, message)

    def get_or_create_filtered_deck(self, did: int) -> anki.decks_pb2.FilteredDeckForUpdate:
        message = anki.decks_pb2.DeckId(did=did)
        raw_bytes = self._run_command(1, 17, message.SerializeToString())
    ...
    def filtered_deck_order_labels_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 19, message)

    def filtered_deck_order_labels(self) -> Sequence[str]:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(1, 19, message.SerializeToString())
        output = anki.generic_pb2.StringList()
        output.ParseFromString(raw_bytes)
        return output.vals
    ...
    def set_current_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 20, message)

    def set_current_deck(self, did: int) -> anki.collection_pb2.OpChanges:
        message = anki.decks_pb2.DeckId(did=did)
        raw_bytes = self._run_command(1, 20, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_current_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(1, 21, message)

    def get_current_deck(self) -> anki.decks_pb2.Deck:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(1, 21, message.SerializeToString())
        output = anki.decks_pb2.Deck()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def new_note_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 0, message)

    def new_note(self, ntid: int) -> anki.notes_pb2.Note:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(2, 0, message.SerializeToString())
    ...
    def add_note_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 1, message)
    ...
    def defaults_for_adding_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 2, message)
    ...
    def defaults_for_adding(self, home_deck_of_current_review_card: int) -> anki.notes_pb2.DeckAndNotetype:
        ...
        raw_bytes = self._run_command(2, 2, message.SerializeToString())
    ...
    def default_deck_for_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 3, message)

    def default_deck_for_notetype(self, ntid: int) -> int:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(2, 3, message.SerializeToString())
        output = anki.decks_pb2.DeckId()
        output.ParseFromString(raw_bytes)
        return output.did
    ...
    def update_notes_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 4, message)
    ...
    def update_notes(self, *, notes: Sequence[anki.notes_pb2.Note], skip_undo_entry: bool) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(2, 4, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_note_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 5, message)
    ...
    def remove_notes_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 6, message)
    ...
    def remove_notes(self, *, note_ids: Sequence[int], card_ids: Sequence[int]) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(2, 6, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def cloze_numbers_in_note_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 7, message)

    def cloze_numbers_in_note(self, message: anki.notes_pb2.Note) -> Sequence[int]:
        
        raw_bytes = self._run_command(2, 7, message.SerializeToString())
    ...
    def after_note_updates_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 8, message)
    ...
    def after_note_updates(self, *, nids: Sequence[int], mark_notes_modified: bool, generate_cards: bool) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(2, 8, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def note_fields_check_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 10, message)

    def note_fields_check(self, message: anki.notes_pb2.Note) -> anki.notes_pb2.NoteFieldsCheckResponse:
        
        raw_bytes = self._run_command(2, 10, message.SerializeToString())
    ...
    def cards_of_note_raw(self, message: bytes) -> bytes:
        return self._run_command(2, 11, message)

    def cards_of_note(self, nid: int) -> Sequence[int]:
        message = anki.notes_pb2.NoteId(nid=nid)
        raw_bytes = self._run_command(2, 11, message.SerializeToString())
    ...
    def before_upload_raw(self, message: bytes) -> bytes:
    ...
    def sync_login(self, *, username: str, password: str) -> anki.sync_pb2.SyncAuth:
        message = anki.sync_pb2.SyncLoginRequest(username=username, password=password)
    ...
    def sync_collection(self, message: anki.sync_pb2.SyncAuth) -> anki.sync_pb2.SyncCollectionResponse:
    ...
    def full_upload_raw(self, message: bytes) -> bytes:
        return self._run_command(3, 7, message)

    def full_upload(self, message: anki.sync_pb2.SyncAuth) -> anki.generic_pb2.Empty:
    ...
    def full_download_raw(self, message: bytes) -> bytes:
        return self._run_command(3, 8, message)

    def full_download(self, message: anki.sync_pb2.SyncAuth) -> anki.generic_pb2.Empty:
    ...
    def sync_server_method_raw(self, message: bytes) -> bytes:
    ...
    def sync_server_method(self, *, method: anki.sync_pb2.SyncServerMethodRequest.Method.V, data: bytes) -> bytes:
        message = anki.sync_pb2.SyncServerMethodRequest(method=method, data=data)
    ...
    def add_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 0, message)

    def add_notetype(self, message: anki.notetypes_pb2.Notetype) -> anki.collection_pb2.OpChangesWithId:
        
        raw_bytes = self._run_command(4, 0, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithId()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def update_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 1, message)

    def update_notetype(self, message: anki.notetypes_pb2.Notetype) -> anki.collection_pb2.OpChanges:
        
        raw_bytes = self._run_command(4, 1, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def add_notetype_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 2, message)

    def add_notetype_legacy(self, json: bytes) -> anki.collection_pb2.OpChangesWithId:
        message = anki.generic_pb2.Json(json=json)
        raw_bytes = self._run_command(4, 2, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithId()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def update_notetype_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 3, message)

    def update_notetype_legacy(self, json: bytes) -> anki.collection_pb2.OpChanges:
        message = anki.generic_pb2.Json(json=json)
        raw_bytes = self._run_command(4, 3, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def add_or_update_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 4, message)
    ...
    def get_stock_notetype_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 5, message)
    ...
    def get_stock_notetype_legacy(self, kind: anki.notetypes_pb2.StockNotetype.Kind.V) -> bytes:
        ...
        raw_bytes = self._run_command(4, 5, message.SerializeToString())
        output = anki.generic_pb2.Json()
        output.ParseFromString(raw_bytes)
        return output.json
    ...
    def get_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 6, message)

    def get_notetype(self, ntid: int) -> anki.notetypes_pb2.Notetype:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(4, 6, message.SerializeToString())
    ...
    def get_notetype_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 7, message)

    def get_notetype_legacy(self, ntid: int) -> bytes:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(4, 7, message.SerializeToString())
        output = anki.generic_pb2.Json()
        output.ParseFromString(raw_bytes)
        return output.json
    ...
    def get_notetype_names_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 8, message)

    def get_notetype_names(self) -> Sequence[anki.notetypes_pb2.NotetypeNameId]:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(4, 8, message.SerializeToString())
    ...
    def get_notetype_names_and_counts_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 9, message)

    def get_notetype_names_and_counts(self) -> Sequence[anki.notetypes_pb2.NotetypeNameIdUseCount]:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(4, 9, message.SerializeToString())
    ...
    def get_notetype_id_by_name_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 10, message)

    def get_notetype_id_by_name(self, val: str) -> int:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(4, 10, message.SerializeToString())
        output = anki.notetypes_pb2.NotetypeId()
        output.ParseFromString(raw_bytes)
        return output.ntid
    ...
    def remove_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 11, message)

    def remove_notetype(self, ntid: int) -> anki.collection_pb2.OpChanges:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(4, 11, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_aux_template_config_key_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 13, message)
    ...
    def get_aux_template_config_key(self, *, notetype_id: int, card_ordinal: int, key: str) -> str:
        ...
        raw_bytes = self._run_command(4, 13, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def get_change_notetype_info_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 14, message)
    ...
    def get_change_notetype_info(self, *, old_notetype_id: int, new_notetype_id: int) -> anki.notetypes_pb2.ChangeNotetypeInfo:
        ...
        raw_bytes = self._run_command(4, 14, message.SerializeToString())
    ...
    def change_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 15, message)

    def change_notetype(self, *, note_ids: Sequence[int], new_fields: Sequence[int], new_templates: Sequence[int], old_notetype_id: int, new_notetype_id: int, current_schema: int, old_notetype_name: str) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(4, 15, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_field_names_raw(self, message: bytes) -> bytes:
        return self._run_command(4, 16, message)

    def get_field_names(self, ntid: int) -> Sequence[str]:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(4, 16, message.SerializeToString())
        output = anki.generic_pb2.StringList()
        output.ParseFromString(raw_bytes)
        return output.vals
    ...
    def set_config_bool_raw(self, message: bytes) -> bytes:
        return self._run_command(5, 6, message)
    ...
    def set_config_bool(self, *, key: anki.config_pb2.ConfigKey.Bool.V, value: bool, undoable: bool) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(5, 6, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_config_string_raw(self, message: bytes) -> bytes:
        return self._run_command(5, 7, message)
    ...
    def get_config_string(self, key: anki.config_pb2.ConfigKey.String.V) -> str:
        ...
        raw_bytes = self._run_command(5, 7, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def set_config_string_raw(self, message: bytes) -> bytes:
        return self._run_command(5, 8, message)
    ...
    def set_config_string(self, *, key: anki.config_pb2.ConfigKey.String.V, value: str, undoable: bool) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(5, 8, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def get_preferences_raw(self, message: bytes) -> bytes:
        return self._run_command(5, 9, message)

    def get_preferences(self) -> anki.config_pb2.Preferences:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(5, 9, message.SerializeToString())
    ...
    def set_preferences_raw(self, message: bytes) -> bytes:
        return self._run_command(5, 10, message)

    def set_preferences(self, message: anki.config_pb2.Preferences) -> anki.collection_pb2.OpChanges:
        
        raw_bytes = self._run_command(5, 10, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def extract_av_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 0, message)
    ...
    def extract_av_tags(self, *, text: str, question_side: bool) -> anki.card_rendering_pb2.ExtractAVTagsResponse:
        ...
        raw_bytes = self._run_command(6, 0, message.SerializeToString())
    ...
    def extract_latex_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 1, message)
    ...
    def extract_latex(self, *, text: str, svg: bool, expand_clozes: bool) -> anki.card_rendering_pb2.ExtractLatexResponse:
        ...
        raw_bytes = self._run_command(6, 1, message.SerializeToString())
    ...
    def get_empty_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 2, message)

    def get_empty_cards(self) -> anki.card_rendering_pb2.EmptyCardsReport:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(6, 2, message.SerializeToString())
    ...
    def render_existing_card_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 3, message)

    def render_existing_card(self, *, card_id: int, browser: bool) -> anki.card_rendering_pb2.RenderCardResponse:
        message = anki.card_rendering_pb2.RenderExistingCardRequest(card_id=card_id, browser=browser)
        raw_bytes = self._run_command(6, 3, message.SerializeToString())
    ...
    def render_uncommitted_card_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 4, message)
    ...
    def render_uncommitted_card(self, *, note: anki.notes_pb2.Note, card_ord: int, template: anki.notetypes_pb2.Notetype.Template, fill_empty: bool) -> anki.card_rendering_pb2.RenderCardResponse:
        message = anki.card_rendering_pb2.RenderUncommittedCardRequest(note=note, card_ord=card_ord, template=template, fill_empty=fill_empty)
        raw_bytes = self._run_command(6, 4, message.SerializeToString())
        output = anki.card_rendering_pb2.RenderCardResponse()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def render_uncommitted_card_legacy_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 5, message)
    ...
    def render_uncommitted_card_legacy(self, *, note: anki.notes_pb2.Note, card_ord: int, template: bytes, fill_empty: bool) -> anki.card_rendering_pb2.RenderCardResponse:
        message = anki.card_rendering_pb2.RenderUncommittedCardLegacyRequest(note=note, card_ord=card_ord, template=template, fill_empty=fill_empty)
        raw_bytes = self._run_command(6, 5, message.SerializeToString())
        output = anki.card_rendering_pb2.RenderCardResponse()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def strip_av_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 6, message)

    def strip_av_tags(self, val: str) -> str:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(6, 6, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def render_markdown_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 7, message)
    ...
    def render_markdown(self, *, markdown: str, sanitize: bool) -> str:
        ...
        raw_bytes = self._run_command(6, 7, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def encode_iri_paths_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 8, message)

    def encode_iri_paths(self, val: str) -> str:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(6, 8, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def decode_iri_paths_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 9, message)

    def decode_iri_paths(self, val: str) -> str:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(6, 9, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def strip_html_raw(self, message: bytes) -> bytes:
        return self._run_command(6, 10, message)
    ...
    def strip_html(self, *, text: str, mode: anki.card_rendering_pb2.StripHtmlRequest.Mode.V) -> str:
        ...
        raw_bytes = self._run_command(6, 10, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def get_deck_config(self, dcid: int) -> anki.deckconfig_pb2.DeckConfig:
        message = anki.deckconfig_pb2.DeckConfigId(dcid=dcid)
    ...
    def update_deck_configs(self, *, target_deck_id: int, configs: Sequence[anki.deckconfig_pb2.DeckConfig], removed_config_ids: Sequence[int], apply_to_children: bool, card_state_customizer: str) -> anki.collection_pb2.OpChanges:
        message = anki.deckconfig_pb2.UpdateDeckConfigsRequest(target_deck_id=target_deck_id, configs=configs, removed_config_ids=removed_config_ids, apply_to_children=apply_to_children, card_state_customizer=card_state_customizer)
    ...
    def clear_unused_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 0, message)

    def clear_unused_tags(self) -> anki.collection_pb2.OpChangesWithCount:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(8, 0, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def all_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 1, message)

    def all_tags(self) -> Sequence[str]:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(8, 1, message.SerializeToString())
        output = anki.generic_pb2.StringList()
        output.ParseFromString(raw_bytes)
        return output.vals
    ...
    def remove_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 2, message)

    def remove_tags(self, val: str) -> anki.collection_pb2.OpChangesWithCount:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(8, 2, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def set_tag_collapsed_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 3, message)
    ...
    def set_tag_collapsed(self, *, name: str, collapsed: bool) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(8, 3, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def tag_tree_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 4, message)

    def tag_tree(self) -> anki.tags_pb2.TagTreeNode:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(8, 4, message.SerializeToString())
    ...
    def reparent_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 5, message)
    ...
    def reparent_tags(self, *, tags: Sequence[str], new_parent: str) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(8, 5, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def rename_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 6, message)
    ...
    def rename_tags(self, *, current_prefix: str, new_prefix: str) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(8, 6, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def add_note_tags_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 7, message)
    ...
    def add_note_tags(self, *, note_ids: Sequence[int], tags: str) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(8, 7, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def find_and_replace_tag_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 9, message)
    ...
    def find_and_replace_tag(self, *, note_ids: Sequence[int], search: str, replacement: str, regex: bool, match_case: bool) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(8, 9, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def complete_tag_raw(self, message: bytes) -> bytes:
        return self._run_command(8, 10, message)
    ...
    def complete_tag(self, *, input: str, match_limit: int) -> Sequence[str]:
        ...
        raw_bytes = self._run_command(8, 10, message.SerializeToString())
    ...
    def card_stats_raw(self, message: bytes) -> bytes:
        return self._run_command(10, 0, message)

    def card_stats(self, cid: int) -> anki.stats_pb2.CardStatsResponse:
        message = anki.cards_pb2.CardId(cid=cid)
        raw_bytes = self._run_command(10, 0, message.SerializeToString())
    ...
    def graphs_raw(self, message: bytes) -> bytes:
        return self._run_command(10, 1, message)
    ...
    def graphs(self, *, search: str, days: int) -> anki.stats_pb2.GraphsResponse:
        ...
        raw_bytes = self._run_command(10, 1, message.SerializeToString())
    ...
    def get_graph_preferences_raw(self, message: bytes) -> bytes:
        return self._run_command(10, 2, message)

    def get_graph_preferences(self) -> anki.stats_pb2.GraphPreferences:
        message = anki.generic_pb2.Empty()
        raw_bytes = self._run_command(10, 2, message.SerializeToString())
    ...
    def set_graph_preferences_raw(self, message: bytes) -> bytes:
        return self._run_command(10, 3, message)

    def set_graph_preferences(self, message: anki.stats_pb2.GraphPreferences) -> anki.generic_pb2.Empty:
        
        raw_bytes = self._run_command(10, 3, message.SerializeToString())
        output = anki.generic_pb2.Empty()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def translate_string_raw(self, message: bytes) -> bytes:
        return self._run_command(12, 0, message)


    def format_timespan_raw(self, message: bytes) -> bytes:
        return self._run_command(12, 1, message)
    ...
    def format_timespan(self, *, seconds: float, context: anki.i18n_pb2.FormatTimespanRequest.Context.V) -> str:
        ...
        raw_bytes = self._run_command(12, 1, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def open_collection(self, *, collection_path: str, media_folder_path: str, media_db_path: str, log_path: str) -> anki.generic_pb2.Empty:
        message = anki.collection_pb2.OpenCollectionRequest(collection_path=collection_path, media_folder_path=media_folder_path, media_db_path=media_db_path, log_path=log_path)
    ...
    def get_card_raw(self, message: bytes) -> bytes:
        return self._run_command(14, 0, message)
    ...
    def update_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(14, 1, message)
    ...
    def update_cards(self, *, cards: Sequence[anki.cards_pb2.Card], skip_undo_entry: bool) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(14, 1, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def remove_cards_raw(self, message: bytes) -> bytes:
        return self._run_command(14, 2, message)
    ...
    def remove_cards(self, card_ids: Sequence[int]) -> anki.generic_pb2.Empty:
        ...
        raw_bytes = self._run_command(14, 2, message.SerializeToString())
        output = anki.generic_pb2.Empty()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def set_deck_raw(self, message: bytes) -> bytes:
        return self._run_command(14, 3, message)
    ...
    def set_deck(self, *, card_ids: Sequence[int], deck_id: int) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(14, 3, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def set_flag_raw(self, message: bytes) -> bytes:
        return self._run_command(14, 4, message)
    ...
    def set_flag(self, *, card_ids: Sequence[int], flag: int) -> anki.collection_pb2.OpChangesWithCount:
        ...
        raw_bytes = self._run_command(14, 4, message.SerializeToString())
        output = anki.collection_pb2.OpChangesWithCount()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def import_collection_package_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 0, message)
    ...
    def import_collection_package(self, *, col_path: str, backup_path: str, media_folder: str, media_db: str) -> anki.generic_pb2.Empty:
        ...
        raw_bytes = self._run_command(16, 0, message.SerializeToString())
        output = anki.generic_pb2.Empty()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def export_collection_package_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 1, message)
    ...
    def export_collection_package(self, *, out_path: str, include_media: bool, legacy: bool) -> anki.generic_pb2.Empty:
        ...
        raw_bytes = self._run_command(16, 1, message.SerializeToString())
        output = anki.generic_pb2.Empty()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def import_anki_package_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 2, message)

    def import_anki_package(self, package_path: str) -> anki.import_export_pb2.ImportResponse:
        message = anki.import_export_pb2.ImportAnkiPackageRequest(package_path=package_path)
        raw_bytes = self._run_command(16, 2, message.SerializeToString())
    ...
    def export_anki_package_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 3, message)
    ...
    def export_anki_package(self, *, out_path: str, with_scheduling: bool, with_media: bool, legacy: bool, limit: anki.import_export_pb2.ExportLimit) -> int:
        ...
        raw_bytes = self._run_command(16, 3, message.SerializeToString())
        output = anki.generic_pb2.UInt32()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def import_csv_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 5, message)

    def import_csv(self, *, path: str, metadata: anki.import_export_pb2.CsvMetadata, dupe_resolution: anki.import_export_pb2.ImportCsvRequest.DupeResolution.V) -> anki.import_export_pb2.ImportResponse:
        message = anki.import_export_pb2.ImportCsvRequest(path=path, metadata=metadata, dupe_resolution=dupe_resolution)
        raw_bytes = self._run_command(16, 5, message.SerializeToString())
        output = anki.import_export_pb2.ImportResponse()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def export_note_csv_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 6, message)
    ...
    def export_note_csv(self, *, out_path: str, with_html: bool, with_tags: bool, with_deck: bool, with_notetype: bool, with_guid: bool, limit: anki.import_export_pb2.ExportLimit) -> int:
        ...
        raw_bytes = self._run_command(16, 6, message.SerializeToString())
        output = anki.generic_pb2.UInt32()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def export_card_csv_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 7, message)
    ...
    def export_card_csv(self, *, out_path: str, with_html: bool, limit: anki.import_export_pb2.ExportLimit) -> int:
        ...
        raw_bytes = self._run_command(16, 7, message.SerializeToString())
        output = anki.generic_pb2.UInt32()
        output.ParseFromString(raw_bytes)
        return output.val
    ...
    def import_json_file_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 8, message)

    def import_json_file(self, val: str) -> anki.import_export_pb2.ImportResponse:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(16, 8, message.SerializeToString())
        output = anki.import_export_pb2.ImportResponse()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def import_json_string_raw(self, message: bytes) -> bytes:
        return self._run_command(16, 9, message)

    def import_json_string(self, val: str) -> anki.import_export_pb2.ImportResponse:
        message = anki.generic_pb2.String(val=val)
        raw_bytes = self._run_command(16, 9, message.SerializeToString())
        output = anki.import_export_pb2.ImportResponse()
        output.ParseFromString(raw_bytes)
        return output
