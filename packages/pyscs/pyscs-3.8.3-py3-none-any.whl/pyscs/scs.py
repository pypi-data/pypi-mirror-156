...
class SCS:
    ...
    def can_not_stop(self, name: str="", atom: AtomSignal = AtomSignal(**{}))-> Union[Dict|str, bool]:
        if name == "":
            name = self._name
        if name == "":
            return "name is empty", 0
    ...
    def set_parameter(self, name: str="", atom: AtomSignal = AtomSignal(**{}))-> Union[Dict|str, bool]:
        if name == "":
            name = self._name
        if name == "":
            return "name is empty", 0
