...
from .linq_exceptions import NoSuchElementError
...
class LinqQuery(Iterable[T]):
    ...
    def select(self, transform: Callable[[T], S]) -> LinqQuery[S]:
        """Transforms each object in the sequence.
        Arguments:
            transform (Callable[[T], S]): Function describing the transformation
        Returns:
            LinqQuery: Returns a new query builder based on the transformed object.
        """
        return LinqQuery(transform(x) for x in self)

    def selectMany(self, transform: Callable[[T], S] = lambda x: x) -> LinqQuery[S]:
        ...
        return LinqQuery(transform(x) for y in self for x in y)

    def where(self, condition: Callable[[T], bool]) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: Returns a new query builder based on the filtered objects.
        """

        return LinqQuery(x for x in self if condition(x))
    ...
    def concat(self, iterable: Iterable[T]) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: Query builder with the extension concatenated.
        """
    ...
    def distinct(self, key: Callable[[T], Any] = lambda x: x) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: Query builder with only distinct elements.
        """
    ...
    def intersect(self, iterable: Iterable[T], key: Callable[[T], Any] = lambda x: x) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: Query builder on the intersection of self and the given iterable.
        """
        ...
        def sequence():
            for x in self:
                kx = key(x)
                if LinqQuery(iterable).any(lambda y: kx == key(y)):
                    yield x
    ...
    def groupBy(self, key: Callable[[T], KT], transform: Callable[[T], VT] = lambda x: x) -> LinqQuery[
        Grouping[KT, VT]]:
        ...
        Returns:
            LinqQuery[Grouping[KT, VT]]: Query builder object wrapping a sequence of `Grouping` objects.
    ...
    def groupJoin(self, extension: Iterable[S], innerKey: Callable[[T], Any], outerKey: Callable[[S], Any],
                  innerTransform: Callable[[T], U], outerTransform: Callable[[S], V]) -> LinqQuery[Joining[U, V]]:
        ...
        Returns:
            LinqQuery[Joining[U, V]]: Query builder object wrapping a sequence of `Joining` objects. Each `Joining` object contains
    ...
    def join(self, extension: Iterable[S], innerKey: Callable[[T], Any], outerKey: Callable[[S], Any],
             transform: Callable[[T, S], U]) -> LinqQuery[U]:
        ...
        Returns:
            LinqQuery: Query build object wrapping the new sequence of objects.
        """
        ...
        def sequence():
            for x in self:
                outerObjs = LinqQuery(extension).where(
    ...
    def take(self, count: int) -> LinqQuery[T]:
        """Selects the amount of elements specified
        Arguments:
            count: The number of elements to select
        Returns:
            LinqQuery: Query builder object wrapping the selected elements
        """
    ...
    def takeWhile(self, condition: Callable[[T], bool]) -> LinqQuery[T]:
    ...
    def order(self, key: Callable[[T], Any] = lambda x: x, descending=False) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: Query builder object wrapping the sorted sequence
        """
    ...
    def skip(self, count: int) -> LinqQuery[T]:
        """Skips the first elements in the sequence
        Arguments:
            count (int): The number of elements to skip
        Returns:
            LinqQuery: Query builder wrapping the remaining elements.
        """
    ...
    def skipWhile(self, condition: Callable[[T], bool]) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: The remaining elements wrapped in a query builder object.
        """
    ...
    def union(self, outer: Iterable[T], key: Callable[[T], Any] = lambda x: x) -> LinqQuery[T]:
        ...
        Returns:
            LinqQuery: Query builder object wrapping the new elements
        """
