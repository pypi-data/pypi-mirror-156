...
class DeliveryOrderClient(EntityClientBase):
    ...
    def upload_file(self, user_name, sender_code, base64_content, file_format="txt", file_name=None, family=1):
        params = {
            'user_name': user_name,
